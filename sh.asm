     ...
     287:	eb 1f                	jmp    2a8 <main+0x3f>
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     2a8:	c7 44 24 04 43 15 00 	movl   $0x1543,0x4(%esp)
     2af:	00 
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     30f:	00 
     310:	c7 44 24 04 5e 15 00 	movl   $0x155e,0x4(%esp)
     317:	00 
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
     ...
     378:	c7 44 24 04 6c 15 00 	movl   $0x156c,0x4(%esp)
     37f:	00 
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    panic("fork");
     3a5:	c7 04 24 70 15 00 00 	movl   $0x1570,(%esp)
     ...
     556:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     56f:	c7 04 24 88 1a 00 00 	movl   $0x1a88,(%esp)
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     619:	c7 04 24 88 1a 00 00 	movl   $0x1a88,(%esp)
     ...
     636:	c7 04 24 8e 1a 00 00 	movl   $0x1a8e,(%esp)
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     674:	c7 04 24 88 1a 00 00 	movl   $0x1a88,(%esp)
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     6ba:	c7 04 24 88 1a 00 00 	movl   $0x1a88,(%esp)
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     735:	c7 44 24 08 75 15 00 	movl   $0x1575,0x8(%esp)
     73c:	00 
  ...
  if(s != es){
    ...
    printf(2, "leftovers: %s\n", s);
     ...
     75e:	c7 44 24 04 76 15 00 	movl   $0x1576,0x4(%esp)
     765:	00 
     766:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     76d:	e8 b3 09 00 00       	call   1125 <printf>
    panic("syntax");
     772:	c7 04 24 85 15 00 00 	movl   $0x1585,(%esp)
...
parseline(char **ps, char *es)
{
  ...
  cmd = parsepipe(ps, es);
  while(peek(ps, es, "&")){
     7df:	c7 44 24 08 8c 15 00 	movl   $0x158c,0x8(%esp)
     7e6:	00 
  ...
  if(peek(ps, es, ";")){
     7fd:	c7 44 24 08 8e 15 00 	movl   $0x158e,0x8(%esp)
     804:	00 
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     881:	c7 44 24 08 90 15 00 	movl   $0x1590,0x8(%esp)
     888:	00 
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     93f:	c7 04 24 92 15 00 00 	movl   $0x1592,(%esp)
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     9eb:	c7 44 24 08 af 15 00 	movl   $0x15af,0x8(%esp)
     9f2:	00 
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     a18:	c7 44 24 08 b2 15 00 	movl   $0x15b2,0x8(%esp)
     a1f:	00 
    ...
    panic("parseblock");
     a36:	c7 04 24 b4 15 00 00 	movl   $0x15b4,(%esp)
  ...
  if(!peek(ps, es, ")"))
     a79:	c7 44 24 08 bf 15 00 	movl   $0x15bf,0x8(%esp)
     a80:	00 
    ...
    panic("syntax - missing )");
     a97:	c7 04 24 c1 15 00 00 	movl   $0x15c1,(%esp)
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     aec:	c7 44 24 08 b2 15 00 	movl   $0x15b2,0x8(%esp)
     af3:	00 
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     b89:	74 0c                	je     b97 <parseexec+0xb1>
      panic("syntax");
     b8b:	c7 04 24 85 15 00 00 	movl   $0x1585,(%esp)
    ...
    if(argc >= MAXARGS)
     ...
     bbc:	7e 0c                	jle    bca <parseexec+0xe4>
      panic("too many args");
     bbe:	c7 04 24 d4 15 00 00 	movl   $0x15d4,(%esp)
  ...
  ret = parseredirs(ret, ps, es);
  while(!peek(ps, es, "|)&;")){
     be6:	c7 44 24 08 e2 15 00 	movl   $0x15e2,0x8(%esp)
     bed:	00 
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     c50:	8b 04 85 e8 15 00 00 	mov    0x15e8(,%eax,4),%eax
     c57:	ff e0                	jmp    *%eax
  case EXEC:
    ecmd = (struct execcmd*)cmd;
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    10be:	0f b6 80 96 1a 00 00 	movzbl 0x1a96(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    121b:	75 09                	jne    1226 <printf+0x101>
          s = "(null)";
    121d:	c7 45 f4 00 16 00 00 	movl   $0x1600,-0xc(%ebp)
        while(*s != 0){
