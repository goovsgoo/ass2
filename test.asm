...
test(int num)
{
  ...
  16:	c7 44 24 04 73 08 00 	movl   $0x873,0x4(%esp)
  1d:	00 
  1e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  25:	e8 7d 04 00 00       	call   4a7 <printf>
  //sigreturn();
}
  2a:	c9                   	leave  
  2b:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 440:	0f b6 80 fc 0a 00 00 	movzbl 0xafc(%eax),%eax
...
malloc(uint nbytes)
{
 ...
 7a5:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 7a8:	a1 18 0b 00 00       	mov    0xb18,%eax
 7ad:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7b0:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7b4:	75 23                	jne    7d9 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 7b6:	c7 45 f0 10 0b 00 00 	movl   $0xb10,-0x10(%ebp)
 7bd:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7c0:	a3 18 0b 00 00       	mov    %eax,0xb18
 7c5:	a1 18 0b 00 00       	mov    0xb18,%eax
 7ca:	a3 10 0b 00 00       	mov    %eax,0xb10
    base.s.size = 0;
 7cf:	c7 05 14 0b 00 00 00 	movl   $0x0,0xb14
 7d6:	00 00 00 
  }
 ...
 82c:	a3 18 0b 00 00       	mov    %eax,0xb18
      return (void*)(p + 1);
 ...
 837:	eb 38                	jmp    871 <malloc+0xde>
    ...
    if(p == freep)
 839:	a1 18 0b 00 00       	mov    0xb18,%eax
