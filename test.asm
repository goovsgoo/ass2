...
test(int num)
{
  ...
  printf(1, "recieved from %d signal %d\n", getpid(), num);
   6:	e8 6c 03 00 00       	call   377 <getpid>
   b:	8b 55 08             	mov    0x8(%ebp),%edx
   e:	89 54 24 0c          	mov    %edx,0xc(%esp)
  12:	89 44 24 08          	mov    %eax,0x8(%esp)
  16:	c7 44 24 04 6b 08 00 	movl   $0x86b,0x4(%esp)
  1d:	00 
  1e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  25:	e8 75 04 00 00       	call   49f <printf>
  //sigreturn();
}
  2a:	c9                   	leave  
  2b:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  58:	83 7c 24 1c 1f       	cmpl   $0x1f,0x1c(%esp)
  5d:	7e e0                	jle    3f <main+0x13>
      signal(i, test);
  }
  
  for (j=0; j < 32; j++) {
  5f:	c7 44 24 18 00 00 00 	movl   $0x0,0x18(%esp)
  66:	00 
  67:	eb 1a                	jmp    83 <main+0x57>
      sigsend(getpid(), j);
  69:	e8 09 03 00 00       	call   377 <getpid>
  6e:	8b 54 24 18          	mov    0x18(%esp),%edx
  72:	89 54 24 04          	mov    %edx,0x4(%esp)
  76:	89 04 24             	mov    %eax,(%esp)
  79:	e8 21 03 00 00       	call   39f <sigsend>
  int i,j;
  for (i=0; i < 32; i++) {
      signal(i, test);
  }
  ...
  for (j=0; j < 32; j++) {
  7e:	83 44 24 18 01       	addl   $0x1,0x18(%esp)
  83:	83 7c 24 18 1f       	cmpl   $0x1f,0x18(%esp)
  88:	7e df                	jle    69 <main+0x3d>
      sigsend(getpid(), j);
  }
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 438:	0f b6 80 f4 0a 00 00 	movzbl 0xaf4(%eax),%eax
...
free(void *ap)
{
 ...
 72c:	a3 10 0b 00 00       	mov    %eax,0xb10
}
 731:	c9                   	leave  
 732:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 79d:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 7a0:	a1 10 0b 00 00       	mov    0xb10,%eax
 7a5:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7a8:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7ac:	75 23                	jne    7d1 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 7ae:	c7 45 f0 08 0b 00 00 	movl   $0xb08,-0x10(%ebp)
 7b5:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7b8:	a3 10 0b 00 00       	mov    %eax,0xb10
 7bd:	a1 10 0b 00 00       	mov    0xb10,%eax
 7c2:	a3 08 0b 00 00       	mov    %eax,0xb08
    base.s.size = 0;
 7c7:	c7 05 0c 0b 00 00 00 	movl   $0x0,0xb0c
 7ce:	00 00 00 
  }
 ...
 824:	a3 10 0b 00 00       	mov    %eax,0xb10
      return (void*)(p + 1);
 ...
 82f:	eb 38                	jmp    869 <malloc+0xde>
    ...
    if(p == freep)
 831:	a1 10 0b 00 00       	mov    0xb10,%eax
