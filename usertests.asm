...
iputtest(void)
{
  ...
  printf(stdout, "iput test\n");
       ...
       b:	c7 44 24 04 4a 44 00 	movl   $0x444a,0x4(%esp)
      12:	00 
      13:	89 04 24             	mov    %eax,(%esp)
      16:	e8 4a 40 00 00       	call   4065 <printf>

  if(mkdir("iputdir") < 0){
      1b:	c7 04 24 55 44 00 00 	movl   $0x4455,(%esp)
      22:	e8 f6 3e 00 00       	call   3f1d <mkdir>
      27:	85 c0                	test   %eax,%eax
      29:	79 1a                	jns    45 <iputtest+0x45>
    printf(stdout, "mkdir failed\n");
      2b:	a1 f4 62 00 00       	mov    0x62f4,%eax
      30:	c7 44 24 04 5d 44 00 	movl   $0x445d,0x4(%esp)
      37:	00 
      38:	89 04 24             	mov    %eax,(%esp)
      3b:	e8 25 40 00 00       	call   4065 <printf>
    exit();
      40:	e8 70 3e 00 00       	call   3eb5 <exit>
  }
  if(chdir("iputdir") < 0){
      45:	c7 04 24 55 44 00 00 	movl   $0x4455,(%esp)
      4c:	e8 d4 3e 00 00       	call   3f25 <chdir>
      51:	85 c0                	test   %eax,%eax
      53:	79 1a                	jns    6f <iputtest+0x6f>
    printf(stdout, "chdir iputdir failed\n");
      55:	a1 f4 62 00 00       	mov    0x62f4,%eax
      5a:	c7 44 24 04 6b 44 00 	movl   $0x446b,0x4(%esp)
      61:	00 
      62:	89 04 24             	mov    %eax,(%esp)
      65:	e8 fb 3f 00 00       	call   4065 <printf>
    exit();
      6a:	e8 46 3e 00 00       	call   3eb5 <exit>
  }
  if(unlink("../iputdir") < 0){
      6f:	c7 04 24 81 44 00 00 	movl   $0x4481,(%esp)
      76:	e8 8a 3e 00 00       	call   3f05 <unlink>
      7b:	85 c0                	test   %eax,%eax
      7d:	79 1a                	jns    99 <iputtest+0x99>
    printf(stdout, "unlink ../iputdir failed\n");
      7f:	a1 f4 62 00 00       	mov    0x62f4,%eax
      84:	c7 44 24 04 8c 44 00 	movl   $0x448c,0x4(%esp)
      8b:	00 
      8c:	89 04 24             	mov    %eax,(%esp)
      8f:	e8 d1 3f 00 00       	call   4065 <printf>
    exit();
      94:	e8 1c 3e 00 00       	call   3eb5 <exit>
  }
  if(chdir("/") < 0){
      99:	c7 04 24 a6 44 00 00 	movl   $0x44a6,(%esp)
      a0:	e8 80 3e 00 00       	call   3f25 <chdir>
      a5:	85 c0                	test   %eax,%eax
      a7:	79 1a                	jns    c3 <iputtest+0xc3>
    printf(stdout, "chdir / failed\n");
      a9:	a1 f4 62 00 00       	mov    0x62f4,%eax
      ae:	c7 44 24 04 a8 44 00 	movl   $0x44a8,0x4(%esp)
      b5:	00 
      b6:	89 04 24             	mov    %eax,(%esp)
      b9:	e8 a7 3f 00 00       	call   4065 <printf>
    exit();
      be:	e8 f2 3d 00 00       	call   3eb5 <exit>
  }
  printf(stdout, "iput test ok\n");
      c3:	a1 f4 62 00 00       	mov    0x62f4,%eax
      c8:	c7 44 24 04 b8 44 00 	movl   $0x44b8,0x4(%esp)
      cf:	00 
      d0:	89 04 24             	mov    %eax,(%esp)
      d3:	e8 8d 3f 00 00       	call   4065 <printf>
}
      d8:	c9                   	leave  
      d9:	c3                   	ret    
...
exitiputtest(void)
{
  ...
  printf(stdout, "exitiput test\n");
      e0:	a1 f4 62 00 00       	mov    0x62f4,%eax
      e5:	c7 44 24 04 c6 44 00 	movl   $0x44c6,0x4(%esp)
      ec:	00 
      ed:	89 04 24             	mov    %eax,(%esp)
      f0:	e8 70 3f 00 00       	call   4065 <printf>
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     103:	a1 f4 62 00 00       	mov    0x62f4,%eax
     108:	c7 44 24 04 d5 44 00 	movl   $0x44d5,0x4(%esp)
     10f:	00 
     110:	89 04 24             	mov    %eax,(%esp)
     113:	e8 4d 3f 00 00       	call   4065 <printf>
    exit();
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     127:	c7 04 24 55 44 00 00 	movl   $0x4455,(%esp)
     12e:	e8 ea 3d 00 00       	call   3f1d <mkdir>
     133:	85 c0                	test   %eax,%eax
     135:	79 1a                	jns    151 <exitiputtest+0x77>
      printf(stdout, "mkdir failed\n");
     137:	a1 f4 62 00 00       	mov    0x62f4,%eax
     13c:	c7 44 24 04 5d 44 00 	movl   $0x445d,0x4(%esp)
     143:	00 
     144:	89 04 24             	mov    %eax,(%esp)
     147:	e8 19 3f 00 00       	call   4065 <printf>
      exit();
     14c:	e8 64 3d 00 00       	call   3eb5 <exit>
    }
    if(chdir("iputdir") < 0){
     151:	c7 04 24 55 44 00 00 	movl   $0x4455,(%esp)
     158:	e8 c8 3d 00 00       	call   3f25 <chdir>
     15d:	85 c0                	test   %eax,%eax
     15f:	79 1a                	jns    17b <exitiputtest+0xa1>
      printf(stdout, "child chdir failed\n");
     161:	a1 f4 62 00 00       	mov    0x62f4,%eax
     166:	c7 44 24 04 e2 44 00 	movl   $0x44e2,0x4(%esp)
     16d:	00 
     16e:	89 04 24             	mov    %eax,(%esp)
     171:	e8 ef 3e 00 00       	call   4065 <printf>
      exit();
     176:	e8 3a 3d 00 00       	call   3eb5 <exit>
    }
    if(unlink("../iputdir") < 0){
     17b:	c7 04 24 81 44 00 00 	movl   $0x4481,(%esp)
     182:	e8 7e 3d 00 00       	call   3f05 <unlink>
     187:	85 c0                	test   %eax,%eax
     189:	79 1a                	jns    1a5 <exitiputtest+0xcb>
      printf(stdout, "unlink ../iputdir failed\n");
     18b:	a1 f4 62 00 00       	mov    0x62f4,%eax
     190:	c7 44 24 04 8c 44 00 	movl   $0x448c,0x4(%esp)
     197:	00 
     198:	89 04 24             	mov    %eax,(%esp)
     19b:	e8 c5 3e 00 00       	call   4065 <printf>
      exit();
  ...
  printf(stdout, "exitiput test ok\n");
     1af:	a1 f4 62 00 00       	mov    0x62f4,%eax
     1b4:	c7 44 24 04 f6 44 00 	movl   $0x44f6,0x4(%esp)
     1bb:	00 
     1bc:	89 04 24             	mov    %eax,(%esp)
     1bf:	e8 a1 3e 00 00       	call   4065 <printf>
}
     1c4:	c9                   	leave  
     1c5:	c3                   	ret    
...
openiputtest(void)
{
  ...
  printf(stdout, "openiput test\n");
     1cc:	a1 f4 62 00 00       	mov    0x62f4,%eax
     1d1:	c7 44 24 04 08 45 00 	movl   $0x4508,0x4(%esp)
     1d8:	00 
     1d9:	89 04 24             	mov    %eax,(%esp)
     1dc:	e8 84 3e 00 00       	call   4065 <printf>
  if(mkdir("oidir") < 0){
     1e1:	c7 04 24 17 45 00 00 	movl   $0x4517,(%esp)
     1e8:	e8 30 3d 00 00       	call   3f1d <mkdir>
     1ed:	85 c0                	test   %eax,%eax
     1ef:	79 1a                	jns    20b <openiputtest+0x45>
    printf(stdout, "mkdir oidir failed\n");
     1f1:	a1 f4 62 00 00       	mov    0x62f4,%eax
     1f6:	c7 44 24 04 1d 45 00 	movl   $0x451d,0x4(%esp)
     1fd:	00 
     1fe:	89 04 24             	mov    %eax,(%esp)
     201:	e8 5f 3e 00 00       	call   4065 <printf>
    exit();
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     219:	a1 f4 62 00 00       	mov    0x62f4,%eax
     21e:	c7 44 24 04 d5 44 00 	movl   $0x44d5,0x4(%esp)
     225:	00 
     226:	89 04 24             	mov    %eax,(%esp)
     229:	e8 37 3e 00 00       	call   4065 <printf>
    exit();
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     240:	00 
     241:	c7 04 24 17 45 00 00 	movl   $0x4517,(%esp)
    ...
    if(fd >= 0){
     ...
     256:	a1 f4 62 00 00       	mov    0x62f4,%eax
     25b:	c7 44 24 04 34 45 00 	movl   $0x4534,0x4(%esp)
     262:	00 
     263:	89 04 24             	mov    %eax,(%esp)
     266:	e8 fa 3d 00 00       	call   4065 <printf>
      exit();
  ...
  if(unlink("oidir") != 0){
     281:	c7 04 24 17 45 00 00 	movl   $0x4517,(%esp)
     288:	e8 78 3c 00 00       	call   3f05 <unlink>
     28d:	85 c0                	test   %eax,%eax
     28f:	74 1a                	je     2ab <openiputtest+0xe5>
    printf(stdout, "unlink failed\n");
     291:	a1 f4 62 00 00       	mov    0x62f4,%eax
     296:	c7 44 24 04 58 45 00 	movl   $0x4558,0x4(%esp)
     29d:	00 
     29e:	89 04 24             	mov    %eax,(%esp)
     2a1:	e8 bf 3d 00 00       	call   4065 <printf>
    exit();
  ...
  printf(stdout, "openiput test ok\n");
     2b0:	a1 f4 62 00 00       	mov    0x62f4,%eax
     2b5:	c7 44 24 04 67 45 00 	movl   $0x4567,0x4(%esp)
     2bc:	00 
     2bd:	89 04 24             	mov    %eax,(%esp)
     2c0:	e8 a0 3d 00 00       	call   4065 <printf>
}
     2c5:	c9                   	leave  
     2c6:	c3                   	ret    
...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
     2cd:	a1 f4 62 00 00       	mov    0x62f4,%eax
     2d2:	c7 44 24 04 79 45 00 	movl   $0x4579,0x4(%esp)
     2d9:	00 
     2da:	89 04 24             	mov    %eax,(%esp)
     2dd:	e8 83 3d 00 00       	call   4065 <printf>
  fd = open("echo", 0);
     2e2:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
     2e9:	00 
     2ea:	c7 04 24 34 44 00 00 	movl   $0x4434,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "open echo failed!\n");
     2ff:	a1 f4 62 00 00       	mov    0x62f4,%eax
     304:	c7 44 24 04 84 45 00 	movl   $0x4584,0x4(%esp)
     30b:	00 
     30c:	89 04 24             	mov    %eax,(%esp)
     30f:	e8 51 3d 00 00       	call   4065 <printf>
    exit();
  ...
  fd = open("doesnotexist", 0);
     ...
     32b:	00 
     32c:	c7 04 24 97 45 00 00 	movl   $0x4597,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     341:	a1 f4 62 00 00       	mov    0x62f4,%eax
     346:	c7 44 24 04 a4 45 00 	movl   $0x45a4,0x4(%esp)
     34d:	00 
     34e:	89 04 24             	mov    %eax,(%esp)
     351:	e8 0f 3d 00 00       	call   4065 <printf>
    exit();
     356:	e8 5a 3b 00 00       	call   3eb5 <exit>
  }
  printf(stdout, "open test ok\n");
     35b:	a1 f4 62 00 00       	mov    0x62f4,%eax
     360:	c7 44 24 04 c2 45 00 	movl   $0x45c2,0x4(%esp)
     367:	00 
     368:	89 04 24             	mov    %eax,(%esp)
     36b:	e8 f5 3c 00 00       	call   4065 <printf>
}
     370:	c9                   	leave  
     371:	c3                   	ret    
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
     378:	a1 f4 62 00 00       	mov    0x62f4,%eax
     37d:	c7 44 24 04 d0 45 00 	movl   $0x45d0,0x4(%esp)
     384:	00 
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     394:	00 
     395:	c7 04 24 e1 45 00 00 	movl   $0x45e1,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     3aa:	a1 f4 62 00 00       	mov    0x62f4,%eax
     3af:	c7 44 24 04 e7 45 00 	movl   $0x45e7,0x4(%esp)
     3b6:	00 
     3b7:	89 04 24             	mov    %eax,(%esp)
     3ba:	e8 a6 3c 00 00       	call   4065 <printf>
  } else {
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
     3cb:	a1 f4 62 00 00       	mov    0x62f4,%eax
     3d0:	c7 44 24 04 02 46 00 	movl   $0x4602,0x4(%esp)
     3d7:	00 
     3d8:	89 04 24             	mov    %eax,(%esp)
     3db:	e8 85 3c 00 00       	call   4065 <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     3ec:	00 
     3ed:	c7 44 24 04 1e 46 00 	movl   $0x461e,0x4(%esp)
     3f4:	00 
     ...
     405:	a1 f4 62 00 00       	mov    0x62f4,%eax
     40a:	8b 55 f4             	mov    -0xc(%ebp),%edx
     40d:	89 54 24 08          	mov    %edx,0x8(%esp)
     411:	c7 44 24 04 2c 46 00 	movl   $0x462c,0x4(%esp)
     418:	00 
     419:	89 04 24             	mov    %eax,(%esp)
     41c:	e8 44 3c 00 00       	call   4065 <printf>
      exit();
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     42d:	00 
     42e:	c7 44 24 04 50 46 00 	movl   $0x4650,0x4(%esp)
     435:	00 
     ...
     446:	a1 f4 62 00 00       	mov    0x62f4,%eax
     44b:	8b 55 f4             	mov    -0xc(%ebp),%edx
     44e:	89 54 24 08          	mov    %edx,0x8(%esp)
     452:	c7 44 24 04 5c 46 00 	movl   $0x465c,0x4(%esp)
     459:	00 
     45a:	89 04 24             	mov    %eax,(%esp)
     45d:	e8 03 3c 00 00       	call   4065 <printf>
      exit();
  ...
  printf(stdout, "writes ok\n");
     475:	a1 f4 62 00 00       	mov    0x62f4,%eax
     47a:	c7 44 24 04 80 46 00 	movl   $0x4680,0x4(%esp)
     481:	00 
     482:	89 04 24             	mov    %eax,(%esp)
     485:	e8 db 3b 00 00       	call   4065 <printf>
  close(fd);
  ...
  fd = open("small", O_RDONLY);
     ...
     49c:	00 
     49d:	c7 04 24 e1 45 00 00 	movl   $0x45e1,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     4b7:	c7 44 24 04 8b 46 00 	movl   $0x468b,0x4(%esp)
     4be:	00 
     4bf:	89 04 24             	mov    %eax,(%esp)
     4c2:	e8 9e 3b 00 00       	call   4065 <printf>
  } else {
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
     4f0:	a1 f4 62 00 00       	mov    0x62f4,%eax
     4f5:	c7 44 24 04 a4 46 00 	movl   $0x46a4,0x4(%esp)
     4fc:	00 
     4fd:	89 04 24             	mov    %eax,(%esp)
     500:	e8 60 3b 00 00       	call   4065 <printf>
    exit();
  ...
  if(i == 2000){
    printf(stdout, "read succeeded ok\n");
     50a:	a1 f4 62 00 00       	mov    0x62f4,%eax
     50f:	c7 44 24 04 bf 46 00 	movl   $0x46bf,0x4(%esp)
     516:	00 
     517:	89 04 24             	mov    %eax,(%esp)
     51a:	e8 46 3b 00 00       	call   4065 <printf>
  } else {
  ...
  if(unlink("small") < 0){
     52a:	c7 04 24 e1 45 00 00 	movl   $0x45e1,(%esp)
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
     53c:	a1 f4 62 00 00       	mov    0x62f4,%eax
     541:	c7 44 24 04 d2 46 00 	movl   $0x46d2,0x4(%esp)
     548:	00 
     549:	89 04 24             	mov    %eax,(%esp)
     54c:	e8 14 3b 00 00       	call   4065 <printf>
    exit();
  ...
  if(unlink("small") < 0){
    printf(stdout, "unlink small failed\n");
     556:	a1 f4 62 00 00       	mov    0x62f4,%eax
     55b:	c7 44 24 04 df 46 00 	movl   $0x46df,0x4(%esp)
     562:	00 
     563:	89 04 24             	mov    %eax,(%esp)
     566:	e8 fa 3a 00 00       	call   4065 <printf>
    exit();
     56b:	e8 45 39 00 00       	call   3eb5 <exit>
  }
  printf(stdout, "small file test ok\n");
     570:	a1 f4 62 00 00       	mov    0x62f4,%eax
     575:	c7 44 24 04 f4 46 00 	movl   $0x46f4,0x4(%esp)
     57c:	00 
     57d:	89 04 24             	mov    %eax,(%esp)
     580:	e8 e0 3a 00 00       	call   4065 <printf>
}
     585:	c9                   	leave  
     586:	c3                   	ret    
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     58d:	a1 f4 62 00 00       	mov    0x62f4,%eax
     592:	c7 44 24 04 08 47 00 	movl   $0x4708,0x4(%esp)
     599:	00 
     59a:	89 04 24             	mov    %eax,(%esp)
     59d:	e8 c3 3a 00 00       	call   4065 <printf>

  fd = open("big", O_CREATE|O_RDWR);
     5a2:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     5a9:	00 
     5aa:	c7 04 24 18 47 00 00 	movl   $0x4718,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: creat big failed!\n");
     5bf:	a1 f4 62 00 00       	mov    0x62f4,%eax
     5c4:	c7 44 24 04 1c 47 00 	movl   $0x471c,0x4(%esp)
     5cb:	00 
     5cc:	89 04 24             	mov    %eax,(%esp)
     5cf:	e8 91 3a 00 00       	call   4065 <printf>
    exit();
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     60e:	a1 f4 62 00 00       	mov    0x62f4,%eax
     613:	8b 55 f4             	mov    -0xc(%ebp),%edx
     616:	89 54 24 08          	mov    %edx,0x8(%esp)
     61a:	c7 44 24 04 36 47 00 	movl   $0x4736,0x4(%esp)
     621:	00 
     622:	89 04 24             	mov    %eax,(%esp)
     625:	e8 3b 3a 00 00       	call   4065 <printf>
      exit();
  ...
  fd = open("big", O_RDONLY);
     ...
     64f:	00 
     650:	c7 04 24 18 47 00 00 	movl   $0x4718,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
     665:	a1 f4 62 00 00       	mov    0x62f4,%eax
     66a:	c7 44 24 04 54 47 00 	movl   $0x4754,0x4(%esp)
     671:	00 
     672:	89 04 24             	mov    %eax,(%esp)
     675:	e8 eb 39 00 00       	call   4065 <printf>
    exit();
  ...
  for(;;){
    ...
    if(i == 0){
     ...
     6b3:	a1 f4 62 00 00       	mov    0x62f4,%eax
     6b8:	8b 55 f0             	mov    -0x10(%ebp),%edx
     6bb:	89 54 24 08          	mov    %edx,0x8(%esp)
     6bf:	c7 44 24 04 6d 47 00 	movl   $0x476d,0x4(%esp)
     6c6:	00 
     6c7:	89 04 24             	mov    %eax,(%esp)
     6ca:	e8 96 39 00 00       	call   4065 <printf>
        exit();
  ...
  if(unlink("big") < 0){
     6e0:	c7 04 24 18 47 00 00 	movl   $0x4718,(%esp)
     ...
     6ff:	a1 f4 62 00 00       	mov    0x62f4,%eax
     704:	8b 55 f4             	mov    -0xc(%ebp),%edx
     707:	89 54 24 08          	mov    %edx,0x8(%esp)
     70b:	c7 44 24 04 8a 47 00 	movl   $0x478a,0x4(%esp)
     712:	00 
     713:	89 04 24             	mov    %eax,(%esp)
     716:	e8 4a 39 00 00       	call   4065 <printf>
      exit();
  ...
  if(unlink("big") < 0){
    printf(stdout, "unlink big failed\n");
     761:	a1 f4 62 00 00       	mov    0x62f4,%eax
     766:	c7 44 24 04 bc 47 00 	movl   $0x47bc,0x4(%esp)
     76d:	00 
     76e:	89 04 24             	mov    %eax,(%esp)
     771:	e8 ef 38 00 00       	call   4065 <printf>
    exit();
     776:	e8 3a 37 00 00       	call   3eb5 <exit>
  }
  printf(stdout, "big files ok\n");
     77b:	a1 f4 62 00 00       	mov    0x62f4,%eax
     780:	c7 44 24 04 cf 47 00 	movl   $0x47cf,0x4(%esp)
     787:	00 
     788:	89 04 24             	mov    %eax,(%esp)
     78b:	e8 d5 38 00 00       	call   4065 <printf>
}
     790:	c9                   	leave  
     791:	c3                   	ret    
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     798:	a1 f4 62 00 00       	mov    0x62f4,%eax
     79d:	c7 44 24 04 e0 47 00 	movl   $0x47e0,0x4(%esp)
     7a4:	00 
     7a5:	89 04 24             	mov    %eax,(%esp)
     7a8:	e8 b8 38 00 00       	call   4065 <printf>
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     833:	a1 f4 62 00 00       	mov    0x62f4,%eax
     838:	c7 44 24 04 08 48 00 	movl   $0x4808,0x4(%esp)
     83f:	00 
     840:	89 04 24             	mov    %eax,(%esp)
     843:	e8 1d 38 00 00       	call   4065 <printf>
}
     848:	c9                   	leave  
     849:	c3                   	ret    
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     850:	a1 f4 62 00 00       	mov    0x62f4,%eax
     855:	c7 44 24 04 2e 48 00 	movl   $0x482e,0x4(%esp)
     85c:	00 
     85d:	89 04 24             	mov    %eax,(%esp)
     860:	e8 00 38 00 00       	call   4065 <printf>

  if(mkdir("dir0") < 0){
     865:	c7 04 24 3a 48 00 00 	movl   $0x483a,(%esp)
     86c:	e8 ac 36 00 00       	call   3f1d <mkdir>
     871:	85 c0                	test   %eax,%eax
     873:	79 1a                	jns    88f <dirtest+0x45>
    printf(stdout, "mkdir failed\n");
     875:	a1 f4 62 00 00       	mov    0x62f4,%eax
     87a:	c7 44 24 04 5d 44 00 	movl   $0x445d,0x4(%esp)
     881:	00 
     882:	89 04 24             	mov    %eax,(%esp)
     885:	e8 db 37 00 00       	call   4065 <printf>
    exit();
     88a:	e8 26 36 00 00       	call   3eb5 <exit>
  }

  if(chdir("dir0") < 0){
     88f:	c7 04 24 3a 48 00 00 	movl   $0x483a,(%esp)
     896:	e8 8a 36 00 00       	call   3f25 <chdir>
     89b:	85 c0                	test   %eax,%eax
     89d:	79 1a                	jns    8b9 <dirtest+0x6f>
    printf(stdout, "chdir dir0 failed\n");
     89f:	a1 f4 62 00 00       	mov    0x62f4,%eax
     8a4:	c7 44 24 04 3f 48 00 	movl   $0x483f,0x4(%esp)
     8ab:	00 
     8ac:	89 04 24             	mov    %eax,(%esp)
     8af:	e8 b1 37 00 00       	call   4065 <printf>
    exit();
     8b4:	e8 fc 35 00 00       	call   3eb5 <exit>
  }

  if(chdir("..") < 0){
     8b9:	c7 04 24 52 48 00 00 	movl   $0x4852,(%esp)
     8c0:	e8 60 36 00 00       	call   3f25 <chdir>
     8c5:	85 c0                	test   %eax,%eax
     8c7:	79 1a                	jns    8e3 <dirtest+0x99>
    printf(stdout, "chdir .. failed\n");
     8c9:	a1 f4 62 00 00       	mov    0x62f4,%eax
     8ce:	c7 44 24 04 55 48 00 	movl   $0x4855,0x4(%esp)
     8d5:	00 
     8d6:	89 04 24             	mov    %eax,(%esp)
     8d9:	e8 87 37 00 00       	call   4065 <printf>
    exit();
     8de:	e8 d2 35 00 00       	call   3eb5 <exit>
  }

  if(unlink("dir0") < 0){
     8e3:	c7 04 24 3a 48 00 00 	movl   $0x483a,(%esp)
     8ea:	e8 16 36 00 00       	call   3f05 <unlink>
     8ef:	85 c0                	test   %eax,%eax
     8f1:	79 1a                	jns    90d <dirtest+0xc3>
    printf(stdout, "unlink dir0 failed\n");
     8f3:	a1 f4 62 00 00       	mov    0x62f4,%eax
     8f8:	c7 44 24 04 66 48 00 	movl   $0x4866,0x4(%esp)
     8ff:	00 
     900:	89 04 24             	mov    %eax,(%esp)
     903:	e8 5d 37 00 00       	call   4065 <printf>
    exit();
     908:	e8 a8 35 00 00       	call   3eb5 <exit>
  }
  printf(stdout, "mkdir test ok\n");
     90d:	a1 f4 62 00 00       	mov    0x62f4,%eax
     912:	c7 44 24 04 7a 48 00 	movl   $0x487a,0x4(%esp)
     919:	00 
     91a:	89 04 24             	mov    %eax,(%esp)
     91d:	e8 43 37 00 00       	call   4065 <printf>
}
     922:	c9                   	leave  
     923:	c3                   	ret    
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     92a:	a1 f4 62 00 00       	mov    0x62f4,%eax
     92f:	c7 44 24 04 89 48 00 	movl   $0x4889,0x4(%esp)
     936:	00 
     937:	89 04 24             	mov    %eax,(%esp)
     93a:	e8 26 37 00 00       	call   4065 <printf>
  if(exec("echo", echoargv) < 0){
     93f:	c7 44 24 04 e0 62 00 	movl   $0x62e0,0x4(%esp)
     946:	00 
     947:	c7 04 24 34 44 00 00 	movl   $0x4434,(%esp)
     94e:	e8 9a 35 00 00       	call   3eed <exec>
     953:	85 c0                	test   %eax,%eax
     955:	79 1a                	jns    971 <exectest+0x4d>
    printf(stdout, "exec echo failed\n");
     957:	a1 f4 62 00 00       	mov    0x62f4,%eax
     95c:	c7 44 24 04 94 48 00 	movl   $0x4894,0x4(%esp)
     963:	00 
     964:	89 04 24             	mov    %eax,(%esp)
     967:	e8 f9 36 00 00       	call   4065 <printf>
    exit();
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
     988:	c7 44 24 04 a6 48 00 	movl   $0x48a6,0x4(%esp)
     98f:	00 
     990:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     997:	e8 c9 36 00 00       	call   4065 <printf>
    exit();
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     a1a:	c7 44 24 04 b5 48 00 	movl   $0x48b5,0x4(%esp)
     a21:	00 
     a22:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a29:	e8 37 36 00 00       	call   4065 <printf>
        exit();
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a90:	c7 44 24 04 c3 48 00 	movl   $0x48c3,0x4(%esp)
     a97:	00 
     a98:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a9f:	e8 c1 35 00 00       	call   4065 <printf>
    ...
    if(total != 5 * 1033){
     ...
     b06:	c7 44 24 04 d1 48 00 	movl   $0x48d1,0x4(%esp)
     b0d:	00 
     b0e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b15:	e8 4b 35 00 00       	call   4065 <printf>
      exit();
  ...
  printf(1, "pipe1 ok\n");
     b2f:	c7 44 24 04 f7 48 00 	movl   $0x48f7,0x4(%esp)
     b36:	00 
     b37:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b3e:	e8 22 35 00 00       	call   4065 <printf>
    ...
    printf(1, "fork() failed\n");
     b45:	c7 44 24 04 e8 48 00 	movl   $0x48e8,0x4(%esp)
     b4c:	00 
     b4d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b54:	e8 0c 35 00 00       	call   4065 <printf>
    exit();
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     b66:	c7 44 24 04 01 49 00 	movl   $0x4901,0x4(%esp)
     b6d:	00 
     b6e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b75:	e8 eb 34 00 00       	call   4065 <printf>
  pid1 = fork();
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     bc8:	00 
     bc9:	c7 44 24 04 0b 49 00 	movl   $0x490b,0x4(%esp)
     bd0:	00 
     ...
     bde:	c7 44 24 04 0d 49 00 	movl   $0x490d,0x4(%esp)
     be5:	00 
     be6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     bed:	e8 73 34 00 00       	call   4065 <printf>
    close(pfds[1]);
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    printf(1, "preempt read error");
     c2a:	c7 44 24 04 21 49 00 	movl   $0x4921,0x4(%esp)
     c31:	00 
     c32:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c39:	e8 27 34 00 00       	call   4065 <printf>
  ...
  printf(1, "kill... ");
     c4b:	c7 44 24 04 34 49 00 	movl   $0x4934,0x4(%esp)
     c52:	00 
     c53:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c5a:	e8 06 34 00 00       	call   4065 <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     c80:	c7 44 24 04 3d 49 00 	movl   $0x493d,0x4(%esp)
     c87:	00 
     c88:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c8f:	e8 d1 33 00 00       	call   4065 <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     ca3:	c7 44 24 04 46 49 00 	movl   $0x4946,0x4(%esp)
     caa:	00 
     cab:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     cb2:	e8 ae 33 00 00       	call   4065 <printf>
}
     cb7:	c9                   	leave  
     cb8:	c3                   	ret    
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     cd4:	79 16                	jns    cec <exitwait+0x33>
      printf(1, "fork failed\n");
     cd6:	c7 44 24 04 d5 44 00 	movl   $0x44d5,0x4(%esp)
     cdd:	00 
     cde:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ce5:	e8 7b 33 00 00       	call   4065 <printf>
      return;
    ...
    if(pid){
     ...
     cfc:	c7 44 24 04 52 49 00 	movl   $0x4952,0x4(%esp)
     d03:	00 
     d04:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d0b:	e8 55 33 00 00       	call   4065 <printf>
        return;
...
exitwait(void)
{
  ...
  printf(1, "exitwait ok\n");
     d21:	c7 44 24 04 62 49 00 	movl   $0x4962,0x4(%esp)
     d28:	00 
     d29:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d30:	e8 30 33 00 00       	call   4065 <printf>
}
     d35:	c9                   	leave  
     d36:	c3                   	ret    
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     d3d:	c7 44 24 04 6f 49 00 	movl   $0x496f,0x4(%esp)
     d44:	00 
     d45:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d4c:	e8 14 33 00 00       	call   4065 <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     d89:	e8 c3 35 00 00       	call   4351 <malloc>
    ...
    while(m1){
     ...
     da7:	e8 6c 34 00 00       	call   4218 <free>
      m1 = m2;
    ...
    free(m1);
     ...
     df7:	e8 1c 34 00 00       	call   4218 <free>
    printf(1, "mem ok\n");
     dfc:	c7 44 24 04 93 49 00 	movl   $0x4993,0x4(%esp)
     e03:	00 
     e04:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e0b:	e8 55 32 00 00       	call   4065 <printf>
    exit();
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     e22:	c7 44 24 04 9b 49 00 	movl   $0x499b,0x4(%esp)
     e29:	00 
     e2a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e31:	e8 2f 32 00 00       	call   4065 <printf>

  unlink("sharedfd");
     e36:	c7 04 24 aa 49 00 00 	movl   $0x49aa,(%esp)
     e3d:	e8 c3 30 00 00       	call   3f05 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e42:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     e49:	00 
     e4a:	c7 04 24 aa 49 00 00 	movl   $0x49aa,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     e5f:	c7 44 24 04 b4 49 00 	movl   $0x49b4,0x4(%esp)
     e66:	00 
     e67:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e6e:	e8 f2 31 00 00       	call   4065 <printf>
    return;
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     ed1:	c7 44 24 04 e0 49 00 	movl   $0x49e0,0x4(%esp)
     ed8:	00 
     ed9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ee0:	e8 80 31 00 00       	call   4065 <printf>
      break;
  ...
  fd = open("sharedfd", 0);
     ...
     f16:	00 
     f17:	c7 04 24 aa 49 00 00 	movl   $0x49aa,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     f2c:	c7 44 24 04 00 4a 00 	movl   $0x4a00,0x4(%esp)
     f33:	00 
     f34:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f3b:	e8 25 31 00 00       	call   4065 <printf>
    return;
  ...
  unlink("sharedfd");
     fbd:	c7 04 24 aa 49 00 00 	movl   $0x49aa,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     fdb:	c7 44 24 04 2b 4a 00 	movl   $0x4a2b,0x4(%esp)
     fe2:	00 
     fe3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fea:	e8 76 30 00 00       	call   4065 <printf>
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ...
     fff:	c7 44 24 04 38 4a 00 	movl   $0x4a38,0x4(%esp)
    1006:	00 
    1007:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    100e:	e8 52 30 00 00       	call   4065 <printf>
    exit();
...
fourfiles(void)
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    1020:	c7 45 c8 4d 4a 00 00 	movl   $0x4a4d,-0x38(%ebp)
    1027:	c7 45 cc 50 4a 00 00 	movl   $0x4a50,-0x34(%ebp)
    102e:	c7 45 d0 53 4a 00 00 	movl   $0x4a53,-0x30(%ebp)
    1035:	c7 45 d4 56 4a 00 00 	movl   $0x4a56,-0x2c(%ebp)
  char *fname;

  printf(1, "fourfiles test\n");
    103c:	c7 44 24 04 59 4a 00 	movl   $0x4a59,0x4(%esp)
    1043:	00 
    1044:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    104b:	e8 15 30 00 00       	call   4065 <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    107d:	79 19                	jns    1098 <fourfiles+0x7e>
      printf(1, "fork failed\n");
    107f:	c7 44 24 04 d5 44 00 	movl   $0x44d5,0x4(%esp)
    1086:	00 
    1087:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    108e:	e8 d2 2f 00 00       	call   4065 <printf>
      exit();
    ...
    10be:	c7 44 24 04 69 4a 00 	movl   $0x4a69,0x4(%esp)
    10c5:	00 
    10c6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    10cd:	e8 93 2f 00 00       	call   4065 <printf>
        exit();
    ...
    112c:	c7 44 24 04 78 4a 00 	movl   $0x4a78,0x4(%esp)
    1133:	00 
    1134:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    113b:	e8 25 2f 00 00       	call   4065 <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    11ce:	74 19                	je     11e9 <fourfiles+0x1cf>
          printf(1, "wrong char\n");
    11d0:	c7 44 24 04 89 4a 00 	movl   $0x4a89,0x4(%esp)
    11d7:	00 
    11d8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11df:	e8 81 2e 00 00       	call   4065 <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    123a:	c7 44 24 04 95 4a 00 	movl   $0x4a95,0x4(%esp)
    1241:	00 
    1242:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1249:	e8 17 2e 00 00       	call   4065 <printf>
      exit();
  ...
  printf(1, "fourfiles ok\n");
    126c:	c7 44 24 04 a6 4a 00 	movl   $0x4aa6,0x4(%esp)
    1273:	00 
    1274:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    127b:	e8 e5 2d 00 00       	call   4065 <printf>
}
    1280:	c9                   	leave  
    1281:	c3                   	ret    
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
    1288:	c7 44 24 04 b4 4a 00 	movl   $0x4ab4,0x4(%esp)
    128f:	00 
    1290:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1297:	e8 c9 2d 00 00       	call   4065 <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    12b4:	79 19                	jns    12cf <createdelete+0x4d>
      printf(1, "fork failed\n");
    12b6:	c7 44 24 04 d5 44 00 	movl   $0x44d5,0x4(%esp)
    12bd:	00 
    12be:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    12c5:	e8 9b 2d 00 00       	call   4065 <printf>
      exit();
    ...
    1315:	79 19                	jns    1330 <createdelete+0xae>
          printf(1, "create failed\n");
    1317:	c7 44 24 04 69 4a 00 	movl   $0x4a69,0x4(%esp)
    131e:	00 
    131f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1326:	e8 3a 2d 00 00       	call   4065 <printf>
          exit();
    ...
    136c:	c7 44 24 04 58 45 00 	movl   $0x4558,0x4(%esp)
    1373:	00 
    1374:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    137b:	e8 e5 2c 00 00       	call   4065 <printf>
            exit();
  ...
  for(i = 0; i < N; i++){
    ...
    1429:	c7 44 24 04 c8 4a 00 	movl   $0x4ac8,0x4(%esp)
    1430:	00 
    1431:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1438:	e8 28 2c 00 00       	call   4065 <printf>
        exit();
    ...
    145b:	c7 44 24 04 ec 4a 00 	movl   $0x4aec,0x4(%esp)
    1462:	00 
    1463:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    146a:	e8 f6 2b 00 00       	call   4065 <printf>
        exit();
  ...
  printf(1, "createdelete ok\n");
    14e4:	c7 44 24 04 0c 4b 00 	movl   $0x4b0c,0x4(%esp)
    14eb:	00 
    14ec:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14f3:	e8 6d 2b 00 00       	call   4065 <printf>
}
    14f8:	c9                   	leave  
    14f9:	c3                   	ret    
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    1500:	c7 44 24 04 1d 4b 00 	movl   $0x4b1d,0x4(%esp)
    1507:	00 
    1508:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    150f:	e8 51 2b 00 00       	call   4065 <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    1514:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    151b:	00 
    151c:	c7 04 24 2e 4b 00 00 	movl   $0x4b2e,(%esp)
  ...
  if(fd < 0){
    ...
    1531:	c7 44 24 04 39 4b 00 	movl   $0x4b39,0x4(%esp)
    1538:	00 
    1539:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1540:	e8 20 2b 00 00       	call   4065 <printf>
    exit();
  ...
  write(fd, "hello", 5);
    ...
    1551:	00 
    1552:	c7 44 24 04 53 4b 00 	movl   $0x4b53,0x4(%esp)
    1559:	00 
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    1577:	00 
    1578:	c7 04 24 2e 4b 00 00 	movl   $0x4b2e,(%esp)
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    162c:	c7 44 24 04 8f 4b 00 	movl   $0x4b8f,0x4(%esp)
    1633:	00 
    1634:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    163b:	e8 25 2a 00 00       	call   4065 <printf>
    exit();
  ...
  if(buf[0] != 'h'){
    ...
    1650:	c7 44 24 04 a6 4b 00 	movl   $0x4ba6,0x4(%esp)
    1657:	00 
    1658:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    165f:	e8 01 2a 00 00       	call   4065 <printf>
    exit();
  ...
  if(write(fd, buf, 10) != 10){
    ...
    1689:	c7 44 24 04 bd 4b 00 	movl   $0x4bbd,0x4(%esp)
    1690:	00 
    1691:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1698:	e8 c8 29 00 00       	call   4065 <printf>
    exit();
  ...
  unlink("unlinkread");
    16ad:	c7 04 24 2e 4b 00 00 	movl   $0x4b2e,(%esp)
    16b4:	e8 4c 28 00 00       	call   3f05 <unlink>
  printf(1, "unlinkread ok\n");
    16b9:	c7 44 24 04 d6 4b 00 	movl   $0x4bd6,0x4(%esp)
    16c0:	00 
    16c1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16c8:	e8 98 29 00 00       	call   4065 <printf>
}
    16cd:	c9                   	leave  
    16ce:	c3                   	ret    
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    16d5:	c7 44 24 04 e5 4b 00 	movl   $0x4be5,0x4(%esp)
    16dc:	00 
    16dd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16e4:	e8 7c 29 00 00       	call   4065 <printf>

  unlink("lf1");
    16e9:	c7 04 24 ef 4b 00 00 	movl   $0x4bef,(%esp)
    16f0:	e8 10 28 00 00       	call   3f05 <unlink>
  unlink("lf2");
    16f5:	c7 04 24 f3 4b 00 00 	movl   $0x4bf3,(%esp)
    16fc:	e8 04 28 00 00       	call   3f05 <unlink>

  fd = open("lf1", O_CREATE|O_RDWR);
    1701:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1708:	00 
    1709:	c7 04 24 ef 4b 00 00 	movl   $0x4bef,(%esp)
  ...
  if(fd < 0){
    ...
    171e:	c7 44 24 04 f7 4b 00 	movl   $0x4bf7,0x4(%esp)
    1725:	00 
    1726:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    172d:	e8 33 29 00 00       	call   4065 <printf>
    exit();
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    173e:	00 
    173f:	c7 44 24 04 53 4b 00 	movl   $0x4b53,0x4(%esp)
    1746:	00 
    ...
    1757:	c7 44 24 04 0a 4c 00 	movl   $0x4c0a,0x4(%esp)
    175e:	00 
    175f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1766:	e8 fa 28 00 00       	call   4065 <printf>
    exit();
  ...
  fd = open("lf2", 0);
    ...
    17f0:	00 
    17f1:	c7 04 24 f3 4b 00 00 	movl   $0x4bf3,(%esp)
  ...
  if(fd < 0){
    ...
    1806:	c7 44 24 04 59 4c 00 	movl   $0x4c59,0x4(%esp)
    180d:	00 
    180e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1815:	e8 4b 28 00 00       	call   4065 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    183f:	c7 44 24 04 6a 4c 00 	movl   $0x4c6a,0x4(%esp)
    1846:	00 
    1847:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    184e:	e8 12 28 00 00       	call   4065 <printf>
    exit();
  ...
  if(link("lf2", "lf2") >= 0){
    1863:	c7 44 24 04 f3 4b 00 	movl   $0x4bf3,0x4(%esp)
    186a:	00 
    186b:	c7 04 24 f3 4b 00 00 	movl   $0x4bf3,(%esp)
    1872:	e8 9e 26 00 00       	call   3f15 <link>
    1877:	85 c0                	test   %eax,%eax
    1879:	78 19                	js     1894 <linktest+0x1c5>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    187b:	c7 44 24 04 7b 4c 00 	movl   $0x4c7b,0x4(%esp)
    1882:	00 
    1883:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    188a:	e8 d6 27 00 00       	call   4065 <printf>
    exit();
    188f:	e8 21 26 00 00       	call   3eb5 <exit>
  }

  unlink("lf2");
    1894:	c7 04 24 f3 4b 00 00 	movl   $0x4bf3,(%esp)
    189b:	e8 65 26 00 00       	call   3f05 <unlink>
  if(link("lf2", "lf1") >= 0){
    18a0:	c7 44 24 04 ef 4b 00 	movl   $0x4bef,0x4(%esp)
    18a7:	00 
    18a8:	c7 04 24 f3 4b 00 00 	movl   $0x4bf3,(%esp)
    18af:	e8 61 26 00 00       	call   3f15 <link>
    18b4:	85 c0                	test   %eax,%eax
    18b6:	78 19                	js     18d1 <linktest+0x202>
    printf(1, "link non-existant succeeded! oops\n");
    18b8:	c7 44 24 04 9c 4c 00 	movl   $0x4c9c,0x4(%esp)
    18bf:	00 
    18c0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18c7:	e8 99 27 00 00       	call   4065 <printf>
    exit();
    18cc:	e8 e4 25 00 00       	call   3eb5 <exit>
  }

  if(link(".", "lf1") >= 0){
    18d1:	c7 44 24 04 ef 4b 00 	movl   $0x4bef,0x4(%esp)
    18d8:	00 
    18d9:	c7 04 24 bf 4c 00 00 	movl   $0x4cbf,(%esp)
    18e0:	e8 30 26 00 00       	call   3f15 <link>
    18e5:	85 c0                	test   %eax,%eax
    18e7:	78 19                	js     1902 <linktest+0x233>
    printf(1, "link . lf1 succeeded! oops\n");
    18e9:	c7 44 24 04 c1 4c 00 	movl   $0x4cc1,0x4(%esp)
    18f0:	00 
    18f1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18f8:	e8 68 27 00 00       	call   4065 <printf>
    exit();
    18fd:	e8 b3 25 00 00       	call   3eb5 <exit>
  }

  printf(1, "linktest ok\n");
    1902:	c7 44 24 04 dd 4c 00 	movl   $0x4cdd,0x4(%esp)
    1909:	00 
    190a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1911:	e8 4f 27 00 00       	call   4065 <printf>
}
    1916:	c9                   	leave  
    1917:	c3                   	ret    
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    191e:	c7 44 24 04 ea 4c 00 	movl   $0x4cea,0x4(%esp)
    1925:	00 
    1926:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    192d:	e8 33 27 00 00       	call   4065 <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    1991:	c7 04 24 fa 4c 00 00 	movl   $0x4cfa,(%esp)
    ...
    19d4:	c7 04 24 fa 4c 00 00 	movl   $0x4cfa,(%esp)
    ...
    1a05:	c7 44 24 04 fd 4c 00 	movl   $0x4cfd,0x4(%esp)
    1a0c:	00 
    1a0d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a14:	e8 4c 26 00 00       	call   4065 <printf>
        exit();
  ...
  fd = open(".", 0);
    ...
    1a69:	00 
    1a6a:	c7 04 24 bf 4c 00 00 	movl   $0x4cbf,(%esp)
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1acc:	c7 44 24 04 19 4d 00 	movl   $0x4d19,0x4(%esp)
    1ad3:	00 
    1ad4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1adb:	e8 85 25 00 00       	call   4065 <printf>
        exit();
    ...
    1afe:	c7 44 24 04 32 4d 00 	movl   $0x4d32,0x4(%esp)
    1b05:	00 
    1b06:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b0d:	e8 53 25 00 00       	call   4065 <printf>
        exit();
  ...
  if(n != 40){
    ...
    1b59:	c7 44 24 04 50 4d 00 	movl   $0x4d50,0x4(%esp)
    1b60:	00 
    1b61:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b68:	e8 f8 24 00 00       	call   4065 <printf>
    exit();
  ...
  for(i = 0; i < 40; i++){
    ...
    1b93:	79 19                	jns    1bae <concreate+0x296>
      printf(1, "fork failed\n");
    1b95:	c7 44 24 04 d5 44 00 	movl   $0x44d5,0x4(%esp)
    1b9c:	00 
    1b9d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ba4:	e8 bc 24 00 00       	call   4065 <printf>
      exit();
  ...
  printf(1, "concreate ok\n");
    1cb5:	c7 44 24 04 81 4d 00 	movl   $0x4d81,0x4(%esp)
    1cbc:	00 
    1cbd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cc4:	e8 9c 23 00 00       	call   4065 <printf>
}
    1cc9:	c9                   	leave  
    1cca:	c3                   	ret    
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    1cd1:	c7 44 24 04 8f 4d 00 	movl   $0x4d8f,0x4(%esp)
    1cd8:	00 
    1cd9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ce0:	e8 80 23 00 00       	call   4065 <printf>

  unlink("x");
    1ce5:	c7 04 24 0b 49 00 00 	movl   $0x490b,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
    1cff:	c7 44 24 04 d5 44 00 	movl   $0x44d5,0x4(%esp)
    1d06:	00 
    1d07:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d0e:	e8 52 23 00 00       	call   4065 <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    ...
    1d6d:	00 
    1d6e:	c7 04 24 0b 49 00 00 	movl   $0x490b,(%esp)
    ...
    1d9f:	75 16                	jne    1db7 <linkunlink+0xec>
      link("cat", "x");
    1da1:	c7 44 24 04 0b 49 00 	movl   $0x490b,0x4(%esp)
    1da8:	00 
    1da9:	c7 04 24 a0 4d 00 00 	movl   $0x4da0,(%esp)
    1db0:	e8 60 21 00 00       	call   3f15 <link>
    1db5:	eb 0c                	jmp    1dc3 <linkunlink+0xf8>
    } else {
      unlink("x");
    1db7:	c7 04 24 0b 49 00 00 	movl   $0x490b,(%esp)
  ...
  printf(1, "linkunlink ok\n");
    1de3:	c7 44 24 04 a4 4d 00 	movl   $0x4da4,0x4(%esp)
    1dea:	00 
    1deb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1df2:	e8 6e 22 00 00       	call   4065 <printf>
}
    1df7:	c9                   	leave  
    1df8:	c3                   	ret    
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    1dff:	c7 44 24 04 b3 4d 00 	movl   $0x4db3,0x4(%esp)
    1e06:	00 
    1e07:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e0e:	e8 52 22 00 00       	call   4065 <printf>
  unlink("bd");
    1e13:	c7 04 24 c0 4d 00 00 	movl   $0x4dc0,(%esp)
    1e1a:	e8 e6 20 00 00       	call   3f05 <unlink>

  fd = open("bd", O_CREATE);
    1e1f:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    1e26:	00 
    1e27:	c7 04 24 c0 4d 00 00 	movl   $0x4dc0,(%esp)
  ...
  if(fd < 0){
    ...
    1e3c:	c7 44 24 04 c3 4d 00 	movl   $0x4dc3,0x4(%esp)
    1e43:	00 
    1e44:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e4b:	e8 15 22 00 00       	call   4065 <printf>
    exit();
  ...
  unlink("bd");
    1ed6:	c7 04 24 c0 4d 00 00 	movl   $0x4dc0,(%esp)
  ...
  for(i = 0; i < 500; i++){
    ...
    1f2a:	c7 44 24 04 ed 4d 00 	movl   $0x4ded,0x4(%esp)
    1f31:	00 
    1f32:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f39:	e8 27 21 00 00       	call   4065 <printf>
      exit();
  ...
  printf(1, "bigdir ok\n");
    1f50:	c7 44 24 04 02 4e 00 	movl   $0x4e02,0x4(%esp)
    1f57:	00 
    1f58:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f5f:	e8 01 21 00 00       	call   4065 <printf>
}
    1f64:	c9                   	leave  
    1f65:	c3                   	ret    
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    1f6c:	c7 44 24 04 0d 4e 00 	movl   $0x4e0d,0x4(%esp)
    1f73:	00 
    1f74:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f7b:	e8 e5 20 00 00       	call   4065 <printf>

  unlink("ff");
    1f80:	c7 04 24 1a 4e 00 00 	movl   $0x4e1a,(%esp)
    1f87:	e8 79 1f 00 00       	call   3f05 <unlink>
  if(mkdir("dd") != 0){
    1f8c:	c7 04 24 1d 4e 00 00 	movl   $0x4e1d,(%esp)
    1f93:	e8 85 1f 00 00       	call   3f1d <mkdir>
    1f98:	85 c0                	test   %eax,%eax
    1f9a:	74 19                	je     1fb5 <subdir+0x4f>
    printf(1, "subdir mkdir dd failed\n");
    1f9c:	c7 44 24 04 20 4e 00 	movl   $0x4e20,0x4(%esp)
    1fa3:	00 
    1fa4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1fab:	e8 b5 20 00 00       	call   4065 <printf>
    exit();
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1fbc:	00 
    1fbd:	c7 04 24 38 4e 00 00 	movl   $0x4e38,(%esp)
  ...
  if(fd < 0){
    ...
    1fd2:	c7 44 24 04 3e 4e 00 	movl   $0x4e3e,0x4(%esp)
    1fd9:	00 
    1fda:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1fe1:	e8 7f 20 00 00       	call   4065 <printf>
    exit();
  ...
  write(fd, "ff", 2);
    ...
    1ff2:	00 
    1ff3:	c7 44 24 04 1a 4e 00 	movl   $0x4e1a,0x4(%esp)
    1ffa:	00 
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    206a:	00 
    206b:	c7 04 24 9c 4e 00 00 	movl   $0x4e9c,(%esp)
  ...
  if(fd < 0){
    ...
    2080:	c7 44 24 04 a5 4e 00 	movl   $0x4ea5,0x4(%esp)
    2087:	00 
    2088:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    208f:	e8 d1 1f 00 00       	call   4065 <printf>
    exit();
  ...
  write(fd, "FF", 2);
    ...
    20a0:	00 
    20a1:	c7 44 24 04 bd 4e 00 	movl   $0x4ebd,0x4(%esp)
    20a8:	00 
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    20c6:	00 
    20c7:	c7 04 24 c0 4e 00 00 	movl   $0x4ec0,(%esp)
  ...
  if(fd < 0){
    ...
    20dc:	c7 44 24 04 cc 4e 00 	movl   $0x4ecc,0x4(%esp)
    20e3:	00 
    20e4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    20eb:	e8 75 1f 00 00       	call   4065 <printf>
    exit();
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    2124:	c7 44 24 04 e5 4e 00 	movl   $0x4ee5,0x4(%esp)
    212b:	00 
    212c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2133:	e8 2d 1f 00 00       	call   4065 <printf>
    exit();
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    227e:	00 
    227f:	c7 04 24 00 4f 00 00 	movl   $0x4f00,(%esp)
  ...
  if(fd < 0){
    ...
    2294:	c7 44 24 04 ca 4f 00 	movl   $0x4fca,0x4(%esp)
    229b:	00 
    229c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    22a3:	e8 bd 1d 00 00       	call   4065 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    22cd:	c7 44 24 04 e2 4f 00 	movl   $0x4fe2,0x4(%esp)
    22d4:	00 
    22d5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    22dc:	e8 84 1d 00 00       	call   4065 <printf>
    exit();
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    26b2:	c7 44 24 04 5c 52 00 	movl   $0x525c,0x4(%esp)
    26b9:	00 
    26ba:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    26c1:	e8 9f 19 00 00       	call   4065 <printf>

  unlink("bigwrite");
    26c6:	c7 04 24 6b 52 00 00 	movl   $0x526b,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    26e5:	00 
    26e6:	c7 04 24 6b 52 00 00 	movl   $0x526b,(%esp)
    ...
    26fb:	c7 44 24 04 74 52 00 	movl   $0x5274,0x4(%esp)
    2702:	00 
    2703:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    270a:	e8 56 19 00 00       	call   4065 <printf>
      exit();
    ...
    2750:	c7 44 24 04 8c 52 00 	movl   $0x528c,0x4(%esp)
    2757:	00 
    2758:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    275f:	e8 01 19 00 00       	call   4065 <printf>
        exit();
    ...
    unlink("bigwrite");
    277e:	c7 04 24 6b 52 00 00 	movl   $0x526b,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    279e:	c7 44 24 04 9e 52 00 	movl   $0x529e,0x4(%esp)
    27a5:	00 
    27a6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27ad:	e8 b3 18 00 00       	call   4065 <printf>
}
    27b2:	c9                   	leave  
    27b3:	c3                   	ret    
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    27ba:	c7 44 24 04 ab 52 00 	movl   $0x52ab,0x4(%esp)
    27c1:	00 
    27c2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27c9:	e8 97 18 00 00       	call   4065 <printf>

  unlink("bigfile");
    27ce:	c7 04 24 b9 52 00 00 	movl   $0x52b9,(%esp)
    27d5:	e8 2b 17 00 00       	call   3f05 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    27da:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    27e1:	00 
    27e2:	c7 04 24 b9 52 00 00 	movl   $0x52b9,(%esp)
  ...
  if(fd < 0){
    ...
    27f7:	c7 44 24 04 c1 52 00 	movl   $0x52c1,0x4(%esp)
    27fe:	00 
    27ff:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2806:	e8 5a 18 00 00       	call   4065 <printf>
    exit();
  ...
  for(i = 0; i < 20; i++){
    ...
    2856:	c7 44 24 04 d7 52 00 	movl   $0x52d7,0x4(%esp)
    285d:	00 
    285e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2865:	e8 fb 17 00 00       	call   4065 <printf>
      exit();
  ...
  fd = open("bigfile", 0);
    ...
    288b:	00 
    288c:	c7 04 24 b9 52 00 00 	movl   $0x52b9,(%esp)
  ...
  if(fd < 0){
    ...
    28a1:	c7 44 24 04 ed 52 00 	movl   $0x52ed,0x4(%esp)
    28a8:	00 
    28a9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    28b0:	e8 b0 17 00 00       	call   4065 <printf>
    exit();
  ...
  for(i = 0; ; i++){
    ...
    28ec:	c7 44 24 04 02 53 00 	movl   $0x5302,0x4(%esp)
    28f3:	00 
    28f4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    28fb:	e8 65 17 00 00       	call   4065 <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    292f:	c7 44 24 04 17 53 00 	movl   $0x5317,0x4(%esp)
    2936:	00 
    2937:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    293e:	e8 22 17 00 00       	call   4065 <printf>
      exit();
    ...
    297a:	74 19                	je     2995 <bigfile+0x1e1>
      printf(1, "read bigfile wrong data\n");
    297c:	c7 44 24 04 2b 53 00 	movl   $0x532b,0x4(%esp)
    2983:	00 
    2984:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    298b:	e8 d5 16 00 00       	call   4065 <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    29a4:	c7 44 24 04 44 53 00 	movl   $0x5344,0x4(%esp)
    29ab:	00 
    29ac:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    29b3:	e8 ad 16 00 00       	call   4065 <printf>
    exit();
    29b8:	e8 f8 14 00 00       	call   3eb5 <exit>
  }
  unlink("bigfile");
    29bd:	c7 04 24 b9 52 00 00 	movl   $0x52b9,(%esp)
    29c4:	e8 3c 15 00 00       	call   3f05 <unlink>

  printf(1, "bigfile test ok\n");
    29c9:	c7 44 24 04 5e 53 00 	movl   $0x535e,0x4(%esp)
    29d0:	00 
    29d1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    29d8:	e8 88 16 00 00       	call   4065 <printf>
}
    29dd:	c9                   	leave  
    29de:	c3                   	ret    
...
fourteen(void)
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2a52:	00 
    2a53:	c7 04 24 fc 53 00 00 	movl   $0x53fc,(%esp)
  ...
  if(fd < 0){
    ...
    2a68:	c7 44 24 04 2c 54 00 	movl   $0x542c,0x4(%esp)
    2a6f:	00 
    2a70:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a77:	e8 e9 15 00 00       	call   4065 <printf>
    exit();
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2a93:	00 
    2a94:	c7 04 24 6c 54 00 00 	movl   $0x546c,(%esp)
  ...
  if(fd < 0){
    ...
    2aa9:	c7 44 24 04 9c 54 00 	movl   $0x549c,0x4(%esp)
    2ab0:	00 
    2ab1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ab8:	e8 a8 15 00 00       	call   4065 <printf>
    exit();
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2cb3:	c7 44 24 04 33 56 00 	movl   $0x5633,0x4(%esp)
    2cba:	00 
    2cbb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2cc2:	e8 9e 13 00 00       	call   4065 <printf>

  fd = open("dirfile", O_CREATE);
    2cc7:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2cce:	00 
    2ccf:	c7 04 24 40 56 00 00 	movl   $0x5640,(%esp)
  ...
  if(fd < 0){
    ...
    2ce4:	c7 44 24 04 48 56 00 	movl   $0x5648,0x4(%esp)
    2ceb:	00 
    2cec:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2cf3:	e8 6d 13 00 00       	call   4065 <printf>
    exit();
  ...
  fd = open("dirfile/xx", 0);
    ...
    2d38:	00 
    2d39:	c7 04 24 79 56 00 00 	movl   $0x5679,(%esp)
  ...
  if(fd >= 0){
    ...
    2d4e:	c7 44 24 04 84 56 00 	movl   $0x5684,0x4(%esp)
    2d55:	00 
    2d56:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d5d:	e8 03 13 00 00       	call   4065 <printf>
    exit();
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2d6e:	00 
    2d6f:	c7 04 24 79 56 00 00 	movl   $0x5679,(%esp)
  ...
  fd = open(".", O_RDWR);
    ...
    2e50:	00 
    2e51:	c7 04 24 bf 4c 00 00 	movl   $0x4cbf,(%esp)
  ...
  if(fd >= 0){
    ...
    2e66:	c7 44 24 04 1c 57 00 	movl   $0x571c,0x4(%esp)
    2e6d:	00 
    2e6e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e75:	e8 eb 11 00 00       	call   4065 <printf>
    exit();
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2eb5:	c7 44 24 04 3b 57 00 	movl   $0x573b,0x4(%esp)
    2ebc:	00 
    2ebd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ec4:	e8 9c 11 00 00       	call   4065 <printf>
    exit();
  ...
  printf(1, "dir vs file OK\n");
    2ed9:	c7 44 24 04 4f 57 00 	movl   $0x574f,0x4(%esp)
    2ee0:	00 
    2ee1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ee8:	e8 78 11 00 00       	call   4065 <printf>
}
    2eed:	c9                   	leave  
    2eee:	c3                   	ret    
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2ef5:	c7 44 24 04 5f 57 00 	movl   $0x575f,0x4(%esp)
    2efc:	00 
    2efd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2f04:	e8 5c 11 00 00       	call   4065 <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2fb6:	00 
    2fb7:	c7 04 24 9f 57 00 00 	movl   $0x579f,(%esp)
    ...
    unlink("xx");
    2fd7:	c7 04 24 9f 57 00 00 	movl   $0x579f,(%esp)
  ...
  chdir("/");
    2ff1:	c7 04 24 a6 44 00 00 	movl   $0x44a6,(%esp)
    2ff8:	e8 28 0f 00 00       	call   3f25 <chdir>
  printf(1, "empty file name OK\n");
    2ffd:	c7 44 24 04 a2 57 00 	movl   $0x57a2,0x4(%esp)
    3004:	00 
    3005:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    300c:	e8 54 10 00 00       	call   4065 <printf>
}
    3011:	c9                   	leave  
    3012:	c3                   	ret    
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    3019:	c7 44 24 04 b6 57 00 	movl   $0x57b6,0x4(%esp)
    3020:	00 
    3021:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3028:	e8 38 10 00 00       	call   4065 <printf>
    ...
    304c:	e8 64 0e 00 00       	call   3eb5 <exit>
{
  ...
  if(n == 1000){
    ...
    3067:	c7 44 24 04 c4 57 00 	movl   $0x57c4,0x4(%esp)
    306e:	00 
    306f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3076:	e8 ea 0f 00 00       	call   4065 <printf>
    exit();
  ...
  for(; n > 0; n--){
    ...
    308b:	c7 44 24 04 e6 57 00 	movl   $0x57e6,0x4(%esp)
    3092:	00 
    3093:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    309a:	e8 c6 0f 00 00       	call   4065 <printf>
      exit();
  ...
  if(wait() != -1){
    ...
    30b8:	c7 44 24 04 fa 57 00 	movl   $0x57fa,0x4(%esp)
    30bf:	00 
    30c0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    30c7:	e8 99 0f 00 00       	call   4065 <printf>
    exit();
    30cc:	e8 e4 0d 00 00       	call   3eb5 <exit>
  }
  
  printf(1, "fork test OK\n");
    30d1:	c7 44 24 04 0d 58 00 	movl   $0x580d,0x4(%esp)
    30d8:	00 
    30d9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    30e0:	e8 80 0f 00 00       	call   4065 <printf>
}
    30e5:	c9                   	leave  
    30e6:	c3                   	ret    
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    30f1:	a1 f4 62 00 00       	mov    0x62f4,%eax
    30f6:	c7 44 24 04 1b 58 00 	movl   $0x581b,0x4(%esp)
    30fd:	00 
    30fe:	89 04 24             	mov    %eax,(%esp)
    3101:	e8 5f 0f 00 00       	call   4065 <printf>
  oldbrk = sbrk(0);
  ...
  for(i = 0; i < 5000; i++){ 
    ...
    3144:	a1 f4 62 00 00       	mov    0x62f4,%eax
    ...
    315e:	c7 44 24 04 26 58 00 	movl   $0x5826,0x4(%esp)
    3165:	00 
    3166:	89 04 24             	mov    %eax,(%esp)
    3169:	e8 f7 0e 00 00       	call   4065 <printf>
      exit();
  ...
  if(pid < 0){
    ...
    319d:	a1 f4 62 00 00       	mov    0x62f4,%eax
    31a2:	c7 44 24 04 41 58 00 	movl   $0x5841,0x4(%esp)
    31a9:	00 
    31aa:	89 04 24             	mov    %eax,(%esp)
    31ad:	e8 b3 0e 00 00       	call   4065 <printf>
    exit();
  ...
  if(c != a + 1){
    ...
    31e0:	a1 f4 62 00 00       	mov    0x62f4,%eax
    31e5:	c7 44 24 04 58 58 00 	movl   $0x5858,0x4(%esp)
    31ec:	00 
    31ed:	89 04 24             	mov    %eax,(%esp)
    31f0:	e8 70 0e 00 00       	call   4065 <printf>
    exit();
...
#define BIG (100*1024*1024)
  ...
  if (p != a) { 
    ...
    323e:	a1 f4 62 00 00       	mov    0x62f4,%eax
    3243:	c7 44 24 04 74 58 00 	movl   $0x5874,0x4(%esp)
    324a:	00 
    324b:	89 04 24             	mov    %eax,(%esp)
    324e:	e8 12 0e 00 00       	call   4065 <printf>
    exit();
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    3289:	a1 f4 62 00 00       	mov    0x62f4,%eax
    328e:	c7 44 24 04 b2 58 00 	movl   $0x58b2,0x4(%esp)
    3295:	00 
    3296:	89 04 24             	mov    %eax,(%esp)
    3299:	e8 c7 0d 00 00       	call   4065 <printf>
    exit();
  ...
  if(c != a - 4096){
    ...
    32bf:	a1 f4 62 00 00       	mov    0x62f4,%eax
    ...
    32d2:	c7 44 24 04 d0 58 00 	movl   $0x58d0,0x4(%esp)
    32d9:	00 
    32da:	89 04 24             	mov    %eax,(%esp)
    32dd:	e8 83 0d 00 00       	call   4065 <printf>
    exit();
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3326:	a1 f4 62 00 00       	mov    0x62f4,%eax
    ...
    3339:	c7 44 24 04 08 59 00 	movl   $0x5908,0x4(%esp)
    3340:	00 
    3341:	89 04 24             	mov    %eax,(%esp)
    3344:	e8 1c 0d 00 00       	call   4065 <printf>
    exit();
  ...
  if(*lastaddr == 99){
    ...
    3358:	a1 f4 62 00 00       	mov    0x62f4,%eax
    335d:	c7 44 24 04 30 59 00 	movl   $0x5930,0x4(%esp)
    3364:	00 
    3365:	89 04 24             	mov    %eax,(%esp)
    3368:	e8 f8 0c 00 00       	call   4065 <printf>
    exit();
  ...
  if(c != a){
    ...
    33a7:	a1 f4 62 00 00       	mov    0x62f4,%eax
    ...
    33ba:	c7 44 24 04 60 59 00 	movl   $0x5960,0x4(%esp)
    33c1:	00 
    33c2:	89 04 24             	mov    %eax,(%esp)
    33c5:	e8 9b 0c 00 00       	call   4065 <printf>
    exit();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    33ec:	79 1a                	jns    3408 <sbrktest+0x321>
      printf(stdout, "fork failed\n");
    33ee:	a1 f4 62 00 00       	mov    0x62f4,%eax
    33f3:	c7 44 24 04 d5 44 00 	movl   $0x44d5,0x4(%esp)
    33fa:	00 
    33fb:	89 04 24             	mov    %eax,(%esp)
    33fe:	e8 62 0c 00 00       	call   4065 <printf>
      exit();
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
    346f:	c7 44 24 04 a6 48 00 	movl   $0x48a6,0x4(%esp)
    3476:	00 
    3477:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    347e:	e8 e2 0b 00 00       	call   4065 <printf>
    exit();
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    34d2:	00 
    34d3:	c7 44 24 04 0b 49 00 	movl   $0x490b,0x4(%esp)
    34da:	00 
  ...
  if(c == (char*)0xffffffff){
    ...
    3573:	a1 f4 62 00 00       	mov    0x62f4,%eax
    3578:	c7 44 24 04 9a 59 00 	movl   $0x599a,0x4(%esp)
    357f:	00 
    3580:	89 04 24             	mov    %eax,(%esp)
    3583:	e8 dd 0a 00 00       	call   4065 <printf>
    exit();
  ...
  printf(stdout, "sbrk test OK\n");
    35b9:	a1 f4 62 00 00       	mov    0x62f4,%eax
    35be:	c7 44 24 04 b5 59 00 	movl   $0x59b5,0x4(%esp)
    35c5:	00 
    35c6:	89 04 24             	mov    %eax,(%esp)
    35c9:	e8 97 0a 00 00       	call   4065 <printf>
}
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    35ff:	a1 f4 62 00 00       	mov    0x62f4,%eax
    3604:	c7 44 24 04 c3 59 00 	movl   $0x59c3,0x4(%esp)
    360b:	00 
    360c:	89 04 24             	mov    %eax,(%esp)
    360f:	e8 51 0a 00 00       	call   4065 <printf>
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    3671:	c7 04 24 d2 59 00 00 	movl   $0x59d2,(%esp)
    3678:	e8 98 08 00 00       	call   3f15 <link>
    367d:	83 f8 ff             	cmp    $0xffffffff,%eax
    3680:	74 1a                	je     369c <validatetest+0xa3>
      printf(stdout, "link should not succeed\n");
    3682:	a1 f4 62 00 00       	mov    0x62f4,%eax
    3687:	c7 44 24 04 dd 59 00 	movl   $0x59dd,0x4(%esp)
    368e:	00 
    368f:	89 04 24             	mov    %eax,(%esp)
    3692:	e8 ce 09 00 00       	call   4065 <printf>
      exit();
  ...
  printf(stdout, "validate ok\n");
    36af:	a1 f4 62 00 00       	mov    0x62f4,%eax
    36b4:	c7 44 24 04 f6 59 00 	movl   $0x59f6,0x4(%esp)
    36bb:	00 
    36bc:	89 04 24             	mov    %eax,(%esp)
    36bf:	e8 a1 09 00 00       	call   4065 <printf>
}
    36c4:	c9                   	leave  
    36c5:	c3                   	ret    
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    36cc:	a1 f4 62 00 00       	mov    0x62f4,%eax
    36d1:	c7 44 24 04 03 5a 00 	movl   $0x5a03,0x4(%esp)
    36d8:	00 
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    36f9:	a1 f4 62 00 00       	mov    0x62f4,%eax
    36fe:	c7 44 24 04 0d 5a 00 	movl   $0x5a0d,0x4(%esp)
    3705:	00 
    3706:	89 04 24             	mov    %eax,(%esp)
    3709:	e8 57 09 00 00       	call   4065 <printf>
      exit();
...
bsstest(void)
{
  ...
  printf(stdout, "bss test ok\n");
    3721:	a1 f4 62 00 00       	mov    0x62f4,%eax
    3726:	c7 44 24 04 1e 5a 00 	movl   $0x5a1e,0x4(%esp)
    372d:	00 
    372e:	89 04 24             	mov    %eax,(%esp)
    3731:	e8 2f 09 00 00       	call   4065 <printf>
}
    3736:	c9                   	leave  
    3737:	c3                   	ret    
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    373e:	c7 04 24 2b 5a 00 00 	movl   $0x5a2b,(%esp)
  ...
  if(pid == 0){
    ...
    3768:	c7 04 85 20 63 00 00 	movl   $0x5a38,0x6320(,%eax,4)
    376f:	38 5a 00 00 
  unlink("bigarg-ok");
  pid = fork();
  if(pid == 0){
    ...
    3787:	a1 f4 62 00 00       	mov    0x62f4,%eax
    378c:	c7 44 24 04 15 5b 00 	movl   $0x5b15,0x4(%esp)
    3793:	00 
    3794:	89 04 24             	mov    %eax,(%esp)
    3797:	e8 c9 08 00 00       	call   4065 <printf>
    exec("echo", args);
    379c:	c7 44 24 04 20 63 00 	movl   $0x6320,0x4(%esp)
    37a3:	00 
    37a4:	c7 04 24 34 44 00 00 	movl   $0x4434,(%esp)
    37ab:	e8 3d 07 00 00       	call   3eed <exec>
    printf(stdout, "bigarg test ok\n");
    37b0:	a1 f4 62 00 00       	mov    0x62f4,%eax
    37b5:	c7 44 24 04 22 5b 00 	movl   $0x5b22,0x4(%esp)
    37bc:	00 
    37bd:	89 04 24             	mov    %eax,(%esp)
    37c0:	e8 a0 08 00 00       	call   4065 <printf>
    fd = open("bigarg-ok", O_CREATE);
    37c5:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    37cc:	00 
    37cd:	c7 04 24 2b 5a 00 00 	movl   $0x5a2b,(%esp)
    ...
    37f2:	a1 f4 62 00 00       	mov    0x62f4,%eax
    37f7:	c7 44 24 04 32 5b 00 	movl   $0x5b32,0x4(%esp)
    37fe:	00 
    37ff:	89 04 24             	mov    %eax,(%esp)
    3802:	e8 5e 08 00 00       	call   4065 <printf>
    exit();
  ...
  fd = open("bigarg-ok", 0);
    ...
    3818:	00 
    3819:	c7 04 24 2b 5a 00 00 	movl   $0x5a2b,(%esp)
  ...
  if(fd < 0){
    ...
    382e:	a1 f4 62 00 00       	mov    0x62f4,%eax
    3833:	c7 44 24 04 4b 5b 00 	movl   $0x5b4b,0x4(%esp)
    383a:	00 
    383b:	89 04 24             	mov    %eax,(%esp)
    383e:	e8 22 08 00 00       	call   4065 <printf>
    exit();
  ...
  unlink("bigarg-ok");
    3853:	c7 04 24 2b 5a 00 00 	movl   $0x5a2b,(%esp)
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    386f:	c7 44 24 04 60 5b 00 	movl   $0x5b60,0x4(%esp)
    3876:	00 
    3877:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    387e:	e8 e2 07 00 00       	call   4065 <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3959:	c7 44 24 04 6d 5b 00 	movl   $0x5b6d,0x4(%esp)
    3960:	00 
    3961:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3968:	e8 f8 06 00 00       	call   4065 <printf>
    ...
    3990:	c7 44 24 04 79 5b 00 	movl   $0x5b79,0x4(%esp)
    3997:	00 
    3998:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    399f:	e8 c1 06 00 00       	call   4065 <printf>
      break;
    ...
    39dc:	c7 44 24 04 89 5b 00 	movl   $0x5b89,0x4(%esp)
    39e3:	00 
    39e4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    39eb:	e8 75 06 00 00       	call   4065 <printf>
    close(fd);
  ...
  printf(1, "fsfull test finished\n");
    3b00:	c7 44 24 04 99 5b 00 	movl   $0x5b99,0x4(%esp)
    3b07:	00 
    3b08:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b0f:	e8 51 05 00 00       	call   4065 <printf>
}
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    3b1d:	a1 f8 62 00 00       	mov    0x62f8,%eax
    3b22:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    3b28:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    3b2d:	a3 f8 62 00 00       	mov    %eax,0x62f8
  return randstate;
    3b32:	a1 f8 62 00 00       	mov    0x62f8,%eax
}
    3b37:	5d                   	pop    %ebp
    3b38:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    3b8e:	00 
    3b8f:	c7 04 24 c3 5b 00 00 	movl   $0x5bc3,(%esp)
...
00003f5d <sigsend>:
SYSCALL(sigsend)
    3f5d:	b8 19 00 00 00       	mov    $0x19,%eax
    3f62:	cd 40                	int    $0x40
    3f64:	c3                   	ret    

00003f65 <sigreturn>:
SYSCALL(sigreturn)
    3f65:	b8 1a 00 00 00       	mov    $0x1a,%eax
    3f6a:	cd 40                	int    $0x40
    3f6c:	c3                   	ret    

00003f6d <advanceprocstats>:
SYSCALL(advanceprocstats)
    3f6d:	b8 17 00 00 00       	mov    $0x17,%eax
    3f72:	cd 40                	int    $0x40
    3f74:	c3                   	ret    

00003f75 <wait_stat>:
SYSCALL(wait_stat)
    3f75:	b8 18 00 00 00       	mov    $0x18,%eax
    3f7a:	cd 40                	int    $0x40
    3f7c:	c3                   	ret    
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
    ...
    3f98:	00 
    3f99:	8d 45 f4             	lea    -0xc(%ebp),%eax
    3f9c:	89 44 24 04          	mov    %eax,0x4(%esp)
    3fa0:	8b 45 08             	mov    0x8(%ebp),%eax
    3fa3:	89 04 24             	mov    %eax,(%esp)
    3fa6:	e8 2a ff ff ff       	call   3ed5 <write>
}
    3fab:	c9                   	leave  
    3fac:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
    3fb5:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
    3fbc:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
    3fc0:	74 17                	je     3fd9 <printint+0x2c>
    3fc2:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    3fc6:	79 11                	jns    3fd9 <printint+0x2c>
    neg = 1;
    3fc8:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
    3fcf:	8b 45 0c             	mov    0xc(%ebp),%eax
    3fd2:	f7 d8                	neg    %eax
    3fd4:	89 45 ec             	mov    %eax,-0x14(%ebp)
    3fd7:	eb 06                	jmp    3fdf <printint+0x32>
  } else {
    x = xx;
    3fd9:	8b 45 0c             	mov    0xc(%ebp),%eax
    3fdc:	89 45 ec             	mov    %eax,-0x14(%ebp)
  }

  i = 0;
    3fdf:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
    3fe6:	8b 4d f4             	mov    -0xc(%ebp),%ecx
    3fe9:	8d 41 01             	lea    0x1(%ecx),%eax
    3fec:	89 45 f4             	mov    %eax,-0xc(%ebp)
    3fef:	8b 5d 10             	mov    0x10(%ebp),%ebx
    3ff2:	8b 45 ec             	mov    -0x14(%ebp),%eax
    3ff5:	ba 00 00 00 00       	mov    $0x0,%edx
    3ffa:	f7 f3                	div    %ebx
    3ffc:	89 d0                	mov    %edx,%eax
    3ffe:	0f b6 80 fc 62 00 00 	movzbl 0x62fc(%eax),%eax
    4005:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
    4009:	8b 75 10             	mov    0x10(%ebp),%esi
    400c:	8b 45 ec             	mov    -0x14(%ebp),%eax
    400f:	ba 00 00 00 00       	mov    $0x0,%edx
    4014:	f7 f6                	div    %esi
    4016:	89 45 ec             	mov    %eax,-0x14(%ebp)
    4019:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    401d:	75 c7                	jne    3fe6 <printint+0x39>
  if(neg)
    401f:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    4023:	74 10                	je     4035 <printint+0x88>
    buf[i++] = '-';
    4025:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4028:	8d 50 01             	lea    0x1(%eax),%edx
    402b:	89 55 f4             	mov    %edx,-0xc(%ebp)
    402e:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
    4033:	eb 1f                	jmp    4054 <printint+0xa7>
    4035:	eb 1d                	jmp    4054 <printint+0xa7>
    putc(fd, buf[i]);
    4037:	8d 55 dc             	lea    -0x24(%ebp),%edx
    ...
    404f:	e8 31 ff ff ff       	call   3f85 <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
    4054:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
    4058:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    405c:	79 d9                	jns    4037 <printint+0x8a>
    putc(fd, buf[i]);
}
    405e:	83 c4 30             	add    $0x30,%esp
    4061:	5b                   	pop    %ebx
    4062:	5e                   	pop    %esi
    4063:	5d                   	pop    %ebp
    4064:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    4082:	e9 7c 01 00 00       	jmp    4203 <printf+0x19e>
    c = fmt[i] & 0xff;
    ...
    40b0:	e9 4a 01 00 00       	jmp    41ff <printf+0x19a>
      } else {
        putc(fd, c);
    40b5:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    40b8:	0f be c0             	movsbl %al,%eax
    40bb:	89 44 24 04          	mov    %eax,0x4(%esp)
    40bf:	8b 45 08             	mov    0x8(%ebp),%eax
    40c2:	89 04 24             	mov    %eax,(%esp)
    40c5:	e8 bb fe ff ff       	call   3f85 <putc>
    40ca:	e9 30 01 00 00       	jmp    41ff <printf+0x19a>
      }
    } else if(state == '%'){
    40cf:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    40d3:	0f 85 26 01 00 00    	jne    41ff <printf+0x19a>
      if(c == 'd'){
    40d9:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    40dd:	75 2d                	jne    410c <printf+0xa7>
        printint(fd, *ap, 10, 1);
    40df:	8b 45 e8             	mov    -0x18(%ebp),%eax
    40e2:	8b 00                	mov    (%eax),%eax
    40e4:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
    40eb:	00 
    40ec:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    40f3:	00 
    40f4:	89 44 24 04          	mov    %eax,0x4(%esp)
    40f8:	8b 45 08             	mov    0x8(%ebp),%eax
    40fb:	89 04 24             	mov    %eax,(%esp)
    40fe:	e8 aa fe ff ff       	call   3fad <printint>
        ap++;
    4103:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    4107:	e9 ec 00 00 00       	jmp    41f8 <printf+0x193>
      } else if(c == 'x' || c == 'p'){
    410c:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    4110:	74 06                	je     4118 <printf+0xb3>
    4112:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    4116:	75 2d                	jne    4145 <printf+0xe0>
        printint(fd, *ap, 16, 0);
    4118:	8b 45 e8             	mov    -0x18(%ebp),%eax
    411b:	8b 00                	mov    (%eax),%eax
    411d:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    4124:	00 
    4125:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
    412c:	00 
    412d:	89 44 24 04          	mov    %eax,0x4(%esp)
    4131:	8b 45 08             	mov    0x8(%ebp),%eax
    4134:	89 04 24             	mov    %eax,(%esp)
    4137:	e8 71 fe ff ff       	call   3fad <printint>
        ap++;
    413c:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    4140:	e9 b3 00 00 00       	jmp    41f8 <printf+0x193>
      } else if(c == 's'){
    4145:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    4149:	75 45                	jne    4190 <printf+0x12b>
        s = (char*)*ap;
    414b:	8b 45 e8             	mov    -0x18(%ebp),%eax
    414e:	8b 00                	mov    (%eax),%eax
    4150:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
    4153:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
    4157:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    415b:	75 09                	jne    4166 <printf+0x101>
          s = "(null)";
    415d:	c7 45 f4 fe 5b 00 00 	movl   $0x5bfe,-0xc(%ebp)
        while(*s != 0){
    4164:	eb 1e                	jmp    4184 <printf+0x11f>
    4166:	eb 1c                	jmp    4184 <printf+0x11f>
          putc(fd, *s);
    ...
    417b:	e8 05 fe ff ff       	call   3f85 <putc>
          s++;
    ...
    418c:	75 da                	jne    4168 <printf+0x103>
    418e:	eb 68                	jmp    41f8 <printf+0x193>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
    4190:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    4194:	75 1d                	jne    41b3 <printf+0x14e>
        putc(fd, *ap);
    ...
    41a8:	e8 d8 fd ff ff       	call   3f85 <putc>
        ap++;
    41ad:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    41b1:	eb 45                	jmp    41f8 <printf+0x193>
      } else if(c == '%'){
    41b3:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    41b7:	75 17                	jne    41d0 <printf+0x16b>
        putc(fd, c);
    ...
    41c9:	e8 b7 fd ff ff       	call   3f85 <putc>
    41ce:	eb 28                	jmp    41f8 <printf+0x193>
      } else {
    ...
    41de:	e8 a2 fd ff ff       	call   3f85 <putc>
        putc(fd, c);
    ...
    41f3:	e8 8d fd ff ff       	call   3f85 <putc>
      }
      state = 0;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    41ff:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
    4203:	8b 55 0c             	mov    0xc(%ebp),%edx
    4206:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4209:	01 d0                	add    %edx,%eax
    420b:	0f b6 00             	movzbl (%eax),%eax
    420e:	84 c0                	test   %al,%al
    4210:	0f 85 71 fe ff ff    	jne    4087 <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4227:	a1 a8 63 00 00       	mov    0x63a8,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    42f2:	a3 a8 63 00 00       	mov    %eax,0x63a8
}
    42f7:	c9                   	leave  
    42f8:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    4318:	e8 20 fc ff ff       	call   3f3d <sbrk>
...
malloc(uint nbytes)
{
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    43f5:	eb 38                	jmp    442f <malloc+0xde>
    }
    if(p == freep)
    43f7:	a1 a8 63 00 00       	mov    0x63a8,%eax
    43fc:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    43ff:	75 1b                	jne    441c <malloc+0xcb>
      if((p = morecore(nunits)) == 0)
    4401:	8b 45 ec             	mov    -0x14(%ebp),%eax
    4404:	89 04 24             	mov    %eax,(%esp)
    4407:	e8 ed fe ff ff       	call   42f9 <morecore>
    440c:	89 45 f4             	mov    %eax,-0xc(%ebp)
    440f:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    4413:	75 07                	jne    441c <malloc+0xcb>
        return 0;
    4415:	b8 00 00 00 00       	mov    $0x0,%eax
    441a:	eb 13                	jmp    442f <malloc+0xde>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    441f:	89 45 f0             	mov    %eax,-0x10(%ebp)
    ...
    442a:	e9 70 ff ff ff       	jmp    439f <malloc+0x4e>
}
    442f:	c9                   	leave  
    4430:	c3                   	ret    
