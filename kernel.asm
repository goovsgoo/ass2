...
8010003a:	c7 44 24 04 38 8d 10 	movl   $0x80108d38,0x4(%esp)
80100041:	80 
80100042:	c7 04 24 80 d6 10 80 	movl   $0x8010d680,(%esp)
80100049:	e8 13 52 00 00       	call   80105261 <initlock>
...
801000bd:	e8 c0 51 00 00       	call   80105282 <acquire>
...
80100104:	e8 db 51 00 00       	call   801052e4 <release>
        return b;
...
8010011f:	e8 82 4b 00 00       	call   80104ca6 <sleep>
      goto loop;
...
8010017c:	e8 63 51 00 00       	call   801052e4 <release>
      return b;
...
80100198:	c7 04 24 3f 8d 10 80 	movl   $0x80108d3f,(%esp)
...
801001ed:	75 0c                	jne    801001fb <bwrite+0x1e>
    panic("bwrite");
801001ef:	c7 04 24 50 8d 10 80 	movl   $0x80108d50,(%esp)
...
80100227:	75 0c                	jne    80100235 <brelse+0x1e>
    panic("brelse");
80100229:	c7 04 24 57 8d 10 80 	movl   $0x80108d57,(%esp)
80100230:	e8 05 03 00 00       	call   8010053a <panic>

  acquire(&bcache.lock);
80100235:	c7 04 24 80 d6 10 80 	movl   $0x8010d680,(%esp)
8010023c:	e8 41 50 00 00       	call   80105282 <acquire>
...
8010029d:	e8 10 4b 00 00       	call   80104db2 <wakeup>

  release(&bcache.lock);
801002a2:	c7 04 24 80 d6 10 80 	movl   $0x8010d680,(%esp)
801002a9:	e8 36 50 00 00       	call   801052e4 <release>
}
801002ae:	c9                   	leave  
801002af:	c3                   	ret    
...
801003bb:	e8 c2 4e 00 00       	call   80105282 <acquire>
...
801003c5:	75 0c                	jne    801003d3 <cprintf+0x33>
    panic("null fmt");
801003c7:	c7 04 24 5e 8d 10 80 	movl   $0x80108d5e,(%esp)
...
801004ae:	75 09                	jne    801004b9 <cprintf+0x119>
        s = "(null)";
801004b0:	c7 45 ec 67 8d 10 80 	movl   $0x80108d67,-0x14(%ebp)
      for(; *s; s++)
...
80100533:	e8 ac 4d 00 00       	call   801052e4 <release>
}
80100538:	c9                   	leave  
80100539:	c3                   	ret    
...
8010055f:	c7 04 24 6e 8d 10 80 	movl   $0x80108d6e,(%esp)
...
80100571:	e8 2a fe ff ff       	call   801003a0 <cprintf>
  cprintf("\n");
80100576:	c7 04 24 7d 8d 10 80 	movl   $0x80108d7d,(%esp)
...
8010058f:	e8 9f 4d 00 00       	call   80105333 <getcallerpcs>
  for(i=0; i<10; i++)
...
801005a8:	c7 04 24 7f 8d 10 80 	movl   $0x80108d7f,(%esp)
...
801006b2:	e8 ee 4e 00 00       	call   801055a5 <memmove>
    pos -= 80;
...
801006e1:	e8 f0 4d 00 00       	call   801054d6 <memset>
  }
...
80100776:	e8 fe 6b 00 00       	call   80107379 <uartputc>
8010077b:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100782:	e8 f2 6b 00 00       	call   80107379 <uartputc>
80100787:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010078e:	e8 e6 6b 00 00       	call   80107379 <uartputc>
80100793:	eb 0b                	jmp    801007a0 <consputc+0x50>
  } else
    uartputc(c);
80100795:	8b 45 08             	mov    0x8(%ebp),%eax
80100798:	89 04 24             	mov    %eax,(%esp)
8010079b:	e8 d9 6b 00 00       	call   80107379 <uartputc>
  cgaputc(c);
...
801007ba:	e8 c3 4a 00 00       	call   80105282 <acquire>
  while((c = getc()) >= 0){
...
801007e5:	e9 82 00 00 00       	jmp    8010086c <consoleintr+0xbf>
    case C('P'):  // Process listing.
      procdump();
801007ea:	e8 69 46 00 00       	call   80104e58 <procdump>
      break;
...
801008f3:	e8 ba 44 00 00       	call   80104db2 <wakeup>
        }
      }
      break;
...
80100914:	e8 cb 49 00 00       	call   801052e4 <release>
}
80100919:	c9                   	leave  
8010091a:	c3                   	ret    
...
80100939:	e8 44 49 00 00       	call   80105282 <acquire>
  while(n > 0){
...
80100959:	e8 86 49 00 00       	call   801052e4 <release>
        ilock(ip);
...
80100982:	e8 1f 43 00 00       	call   80104ca6 <sleep>
...
801009fe:	e8 e1 48 00 00       	call   801052e4 <release>
  ilock(ip);
...
80100a32:	e8 4b 48 00 00       	call   80105282 <acquire>
  for(i = 0; i < n; i++)
...
80100a6c:	e8 73 48 00 00       	call   801052e4 <release>
  ilock(ip);
...
80100a87:	c7 44 24 04 83 8d 10 	movl   $0x80108d83,0x4(%esp)
80100a8e:	80 
80100a8f:	c7 04 24 e0 c5 10 80 	movl   $0x8010c5e0,(%esp)
80100a96:	e8 c6 47 00 00       	call   80105261 <initlock>
  initlock(&input.lock, "input");
80100a9b:	c7 44 24 04 8b 8d 10 	movl   $0x80108d8b,0x4(%esp)
80100aa2:	80 
80100aa3:	c7 04 24 a0 17 11 80 	movl   $0x801117a0,(%esp)
80100aaa:	e8 b2 47 00 00       	call   80105261 <initlock>
...
80100b6e:	e9 69 03 00 00       	jmp    80100edc <exec+0x3ed>
  ...
  if((pgdir = setupkvm()) == 0)
80100b73:	e8 52 79 00 00       	call   801084ca <setupkvm>
...
80100c14:	e8 7f 7c 00 00       	call   80108898 <allocuvm>
...
80100c52:	e8 56 7b 00 00       	call   801087ad <loaduvm>
...
80100cc0:	e8 d3 7b 00 00       	call   80108898 <allocuvm>
...
80100ce5:	e8 de 7d 00 00       	call   80108ac8 <clearpteu>
  sp = sz;
...
80100d1b:	e8 20 4a 00 00       	call   80105740 <strlen>
...
80100d44:	e8 f7 49 00 00       	call   80105740 <strlen>
...
80100d74:	e8 14 7f 00 00       	call   80108c8d <copyout>
...
80100e1b:	e8 6d 7e 00 00       	call   80108c8d <copyout>
...
80100e73:	e8 7e 48 00 00       	call   801056f6 <safestrcpy>
...
80100ec5:	e8 f1 76 00 00       	call   801085bb <switchuvm>
  freevm(oldpgdir);
80100eca:	8b 45 d0             	mov    -0x30(%ebp),%eax
80100ecd:	89 04 24             	mov    %eax,(%esp)
80100ed0:	e8 59 7b 00 00       	call   80108a2e <freevm>
  return 0;
...
80100ee8:	e8 41 7b 00 00       	call   80108a2e <freevm>
  if(ip){
...
80100f10:	c7 44 24 04 91 8d 10 	movl   $0x80108d91,0x4(%esp)
80100f17:	80 
80100f18:	c7 04 24 60 18 11 80 	movl   $0x80111860,(%esp)
80100f1f:	e8 3d 43 00 00       	call   80105261 <initlock>
}
80100f24:	c9                   	leave  
80100f25:	c3                   	ret    
...
80100f33:	e8 4a 43 00 00       	call   80105282 <acquire>
...
80100f5c:	e8 83 43 00 00       	call   801052e4 <release>
      return f;
...
80100f7a:	e8 65 43 00 00       	call   801052e4 <release>
  return 0;
...
80100f93:	e8 ea 42 00 00       	call   80105282 <acquire>
  if(f->ref < 1)
...
80100fa0:	7f 0c                	jg     80100fae <filedup+0x28>
    panic("filedup");
80100fa2:	c7 04 24 98 8d 10 80 	movl   $0x80108d98,(%esp)
...
80100fc4:	e8 1b 43 00 00       	call   801052e4 <release>
  return f;
...
80100fdb:	e8 a2 42 00 00       	call   80105282 <acquire>
  if(f->ref < 1)
...
80100fe8:	7f 0c                	jg     80100ff6 <fileclose+0x28>
    panic("fileclose");
80100fea:	c7 04 24 a0 8d 10 80 	movl   $0x80108da0,(%esp)
...
80101016:	e8 c9 42 00 00       	call   801052e4 <release>
...
80101060:	e8 7f 42 00 00       	call   801052e4 <release>
...
8010119f:	eb 0c                	jmp    801011ad <fileread+0xba>
  ...
  panic("fileread");
801011a1:	c7 04 24 aa 8d 10 80 	movl   $0x80108daa,(%esp)
...
801012ad:	c7 04 24 b3 8d 10 80 	movl   $0x80108db3,(%esp)
...
801012dd:	eb 0c                	jmp    801012eb <filewrite+0x13c>
  ...
  panic("filewrite");
801012df:	c7 04 24 c3 8d 10 80 	movl   $0x80108dc3,(%esp)
...
80101325:	e8 7b 42 00 00       	call   801055a5 <memmove>
  brelse(bp);
...
8010136b:	e8 66 41 00 00       	call   801054d6 <memset>
  log_write(bp);
...
801014c8:	c7 04 24 cd 8d 10 80 	movl   $0x80108dcd,(%esp)
...
8010155a:	c7 04 24 e3 8d 10 80 	movl   $0x80108de3,(%esp)
...
801015aa:	c7 44 24 04 f6 8d 10 	movl   $0x80108df6,0x4(%esp)
801015b1:	80 
801015b2:	c7 04 24 60 22 11 80 	movl   $0x80112260,(%esp)
801015b9:	e8 a3 3c 00 00       	call   80105261 <initlock>
}
801015be:	c9                   	leave  
801015bf:	c3                   	ret    
...
8010163b:	e8 96 3e 00 00       	call   801054d6 <memset>
      dip->type = type;
...
80101691:	c7 04 24 fd 8d 10 80 	movl   $0x80108dfd,(%esp)
...
8010173a:	e8 66 3e 00 00       	call   801055a5 <memmove>
  log_write(bp);
...
80101764:	e8 19 3b 00 00       	call   80105282 <acquire>
...
801017ae:	e8 31 3b 00 00       	call   801052e4 <release>
      return ip;
...
801017e1:	c7 04 24 0f 8e 10 80 	movl   $0x80108e0f,(%esp)
...
8010181f:	e8 c0 3a 00 00       	call   801052e4 <release>
...
80101836:	e8 47 3a 00 00       	call   80105282 <acquire>
  ip->ref++;
...
80101851:	e8 8e 3a 00 00       	call   801052e4 <release>
  return ip;
...
8010186f:	7f 0c                	jg     8010187d <ilock+0x22>
    panic("ilock");
80101871:	c7 04 24 1f 8e 10 80 	movl   $0x80108e1f,(%esp)
80101878:	e8 bd ec ff ff       	call   8010053a <panic>

  acquire(&icache.lock);
8010187d:	c7 04 24 60 22 11 80 	movl   $0x80112260,(%esp)
80101884:	e8 f9 39 00 00       	call   80105282 <acquire>
...
80101899:	e8 08 34 00 00       	call   80104ca6 <sleep>
...
801018c3:	e8 1c 3a 00 00       	call   801052e4 <release>
...
8010196e:	e8 32 3c 00 00       	call   801055a5 <memmove>
    brelse(bp);
...
80101999:	75 0c                	jne    801019a7 <ilock+0x14c>
      panic("ilock: no type");
8010199b:	c7 04 24 25 8e 10 80 	movl   $0x80108e25,(%esp)
...
801019ca:	7f 0c                	jg     801019d8 <iunlock+0x2f>
    panic("iunlock");
801019cc:	c7 04 24 34 8e 10 80 	movl   $0x80108e34,(%esp)
801019d3:	e8 62 eb ff ff       	call   8010053a <panic>

  acquire(&icache.lock);
801019d8:	c7 04 24 60 22 11 80 	movl   $0x80112260,(%esp)
801019df:	e8 9e 38 00 00       	call   80105282 <acquire>
  ip->flags &= ~I_BUSY;
...
801019fb:	e8 b2 33 00 00       	call   80104db2 <wakeup>
  release(&icache.lock);
80101a00:	c7 04 24 60 22 11 80 	movl   $0x80112260,(%esp)
80101a07:	e8 d8 38 00 00       	call   801052e4 <release>
}
80101a0c:	c9                   	leave  
80101a0d:	c3                   	ret    
...
80101a1b:	e8 62 38 00 00       	call   80105282 <acquire>
...
80101a57:	74 0c                	je     80101a65 <iput+0x57>
      panic("iput busy");
80101a59:	c7 04 24 3c 8e 10 80 	movl   $0x80108e3c,(%esp)
...
80101a7d:	e8 62 38 00 00       	call   801052e4 <release>
    itrunc(ip);
...
80101aa8:	e8 d5 37 00 00       	call   80105282 <acquire>
    ip->flags = 0;
...
80101abd:	e8 f0 32 00 00       	call   80104db2 <wakeup>
  }
  ip->ref--;
...
80101ad8:	e8 07 38 00 00       	call   801052e4 <release>
}
80101add:	c9                   	leave  
80101ade:	c3                   	ret    
...
80101bf8:	c7 04 24 46 8e 10 80 	movl   $0x80108e46,(%esp)
...
80101e99:	e8 07 37 00 00       	call   801055a5 <memmove>
    brelse(bp);
...
80101ff8:	e8 a8 35 00 00       	call   801055a5 <memmove>
    log_write(bp);
...
80102076:	e8 cd 35 00 00       	call   80105648 <strncmp>
}
8010207b:	c9                   	leave  
8010207c:	c3                   	ret    
...
80102090:	c7 04 24 59 8e 10 80 	movl   $0x80108e59,(%esp)
...
801020cc:	74 0c                	je     801020da <dirlookup+0x5d>
      panic("dirlink read");
801020ce:	c7 04 24 6b 8e 10 80 	movl   $0x80108e6b,(%esp)
...
801021b1:	74 0c                	je     801021bf <dirlink+0x79>
      panic("dirlink read");
801021b3:	c7 04 24 6b 8e 10 80 	movl   $0x80108e6b,(%esp)
...
801021f8:	e8 a1 34 00 00       	call   8010569e <strncpy>
  de.inum = inum;
...
80102228:	74 0c                	je     80102236 <dirlink+0xf0>
    panic("dirlink");
8010222a:	c7 04 24 78 8e 10 80 	movl   $0x80108e78,(%esp)
...
801022af:	e8 f1 32 00 00       	call   801055a5 <memmove>
  else {
    memmove(name, s, len);
    name[len] = 0;
  }
...
801022ca:	e8 d6 32 00 00       	call   801055a5 <memmove>
    name[len] = 0;
...
80102519:	c7 44 24 04 80 8e 10 	movl   $0x80108e80,0x4(%esp)
80102520:	80 
80102521:	c7 04 24 20 c6 10 80 	movl   $0x8010c620,(%esp)
80102528:	e8 34 2d 00 00       	call   80105261 <initlock>
  picenable(IRQ_IDE);
...
801025c3:	75 0c                	jne    801025d1 <idestart+0x18>
    panic("idestart");
801025c5:	c7 04 24 84 8e 10 80 	movl   $0x80108e84,(%esp)
...
801026eb:	e8 92 2b 00 00       	call   80105282 <acquire>
  if((b = idequeue) == 0){
...
80102705:	e8 da 2b 00 00       	call   801052e4 <release>
...
80102778:	e8 35 26 00 00       	call   80104db2 <wakeup>
...
8010279a:	e8 45 2b 00 00       	call   801052e4 <release>
}
8010279f:	c9                   	leave  
801027a0:	c3                   	ret    
...
801027b3:	c7 04 24 8d 8e 10 80 	movl   $0x80108e8d,(%esp)
...
801027cc:	c7 04 24 a1 8e 10 80 	movl   $0x80108ea1,(%esp)
...
80102859:	e8 48 24 00 00       	call   80104ca6 <sleep>
  // Start disk if necessary.
  if(idequeue == b)
    idestart(b);
...
80102872:	e8 6d 2a 00 00       	call   801052e4 <release>
}
80102877:	c9                   	leave  
80102878:	c3                   	ret    
...
80102900:	c7 04 24 d4 8e 10 80 	movl   $0x80108ed4,(%esp)
...
801029ba:	c7 44 24 04 06 8f 10 	movl   $0x80108f06,0x4(%esp)
801029c1:	80 
801029c2:	c7 04 24 40 32 11 80 	movl   $0x80113240,(%esp)
801029c9:	e8 93 28 00 00       	call   80105261 <initlock>
  kmem.use_lock = 0;
...
80102a5b:	81 7d 08 5c 8b 11 80 	cmpl   $0x80118b5c,0x8(%ebp)
...
80102a74:	76 0c                	jbe    80102a82 <kfree+0x39>
    panic("kfree");
80102a76:	c7 04 24 0b 8f 10 80 	movl   $0x80108f0b,(%esp)
...
80102a98:	e8 39 2a 00 00       	call   801054d6 <memset>
...
80102aad:	e8 d0 27 00 00       	call   80105282 <acquire>
  r = (struct run*)v;
...
80102adb:	e8 04 28 00 00       	call   801052e4 <release>
}
80102ae0:	c9                   	leave  
80102ae1:	c3                   	ret    
...
80102af8:	e8 85 27 00 00       	call   80105282 <acquire>
  r = kmem.freelist;
...
80102b25:	e8 ba 27 00 00       	call   801052e4 <release>
  return (char*)r;
...
80102ea5:	c7 04 24 14 8f 10 80 	movl   $0x80108f14,(%esp)
...
80103108:	e8 40 24 00 00       	call   8010554d <memcmp>
...
80103208:	c7 44 24 04 40 8f 10 	movl   $0x80108f40,0x4(%esp)
8010320f:	80 
80103210:	c7 04 24 80 32 11 80 	movl   $0x80113280,(%esp)
80103217:	e8 45 20 00 00       	call   80105261 <initlock>
  readsb(ROOTDEV, &sb);
...
801032cb:	e8 d5 22 00 00       	call   801055a5 <memmove>
...
8010341d:	e8 60 1e 00 00       	call   80105282 <acquire>
  while(1){
    if(log.committing){
...
8010343a:	e8 67 18 00 00       	call   80104ca6 <sleep>
...
8010346e:	e8 33 18 00 00       	call   80104ca6 <sleep>
...
80103489:	e8 56 1e 00 00       	call   801052e4 <release>
      break;
...
801034a8:	e8 d5 1d 00 00       	call   80105282 <acquire>
  log.outstanding -= 1;
...
801034c3:	c7 04 24 44 8f 10 80 	movl   $0x80108f44,(%esp)
...
801034f2:	e8 bb 18 00 00       	call   80104db2 <wakeup>
  }
  release(&log.lock);
801034f7:	c7 04 24 80 32 11 80 	movl   $0x80113280,(%esp)
801034fe:	e8 e1 1d 00 00       	call   801052e4 <release>
...
801035b2:	e8 ee 1f 00 00       	call   801055a5 <memmove>
...
8010363d:	c7 04 24 53 8f 10 80 	movl   $0x80108f53,(%esp)
...
80103652:	c7 04 24 69 8f 10 80 	movl   $0x80108f69,(%esp)
80103659:	e8 dc ce ff ff       	call   8010053a <panic>

  acquire(&log.lock);
8010365e:	c7 04 24 80 32 11 80 	movl   $0x80113280,(%esp)
80103665:	e8 18 1c 00 00       	call   80105282 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
801036dc:	e8 03 1c 00 00       	call   801052e4 <release>
}
801036e1:	c9                   	leave  
801036e2:	c3                   	ret    
...
80103758:	c7 04 24 84 8f 10 80 	movl   $0x80108f84,(%esp)
...
80103773:	e8 f1 3a 00 00       	call   80107269 <uartinit>
  pinit();         // process table
80103778:	e8 cf 0b 00 00       	call   8010434c <pinit>
  tvinit();        // trap vectors
8010377d:	e8 f1 32 00 00       	call   80106a73 <tvinit>
  binit();         // buffer cache
...
8010379f:	e8 0d 32 00 00       	call   801069b1 <timerinit>
...
801037bd:	e8 f7 0c 00 00       	call   801044b9 <userinit>
...
801037ca:	83 ec 08             	sub    $0x8,%esp
  switchkvm(); 
801037cd:	e8 cc 4d 00 00       	call   8010859e <switchkvm>
  seginit();
801037d2:	e8 43 47 00 00       	call   80107f1a <seginit>
  lapicinit();
...
801037f7:	c7 04 24 9b 8f 10 80 	movl   $0x80108f9b,(%esp)
801037fe:	e8 9d cb ff ff       	call   801003a0 <cprintf>
  idtinit();       // load idt register
80103803:	e8 df 33 00 00       	call   80106be7 <idtinit>
...
80103823:	e8 d3 12 00 00       	call   80104afb <scheduler>
...
80103855:	e8 4b 1d 00 00       	call   801055a5 <memmove>
...
801039d6:	00 
801039d7:	c7 44 24 04 ac 8f 10 	movl   $0x80108fac,0x4(%esp)
801039de:	80 
801039df:	8b 45 f4             	mov    -0xc(%ebp),%eax
801039e2:	89 04 24             	mov    %eax,(%esp)
801039e5:	e8 63 1b 00 00       	call   8010554d <memcmp>
...
80103b17:	00 
80103b18:	c7 44 24 04 b1 8f 10 	movl   $0x80108fb1,0x4(%esp)
80103b1f:	80 
80103b20:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103b23:	89 04 24             	mov    %eax,(%esp)
80103b26:	e8 22 1a 00 00       	call   8010554d <memcmp>
...
80103bf4:	8b 04 85 f4 8f 10 80 	mov    -0x7fef700c(,%eax,4),%eax
...
80103c2d:	c7 04 24 b6 8f 10 80 	movl   $0x80108fb6,(%esp)
...
80103cc0:	c7 04 24 d4 8f 10 80 	movl   $0x80108fd4,(%esp)
...
80103fb9:	c7 44 24 04 08 90 10 	movl   $0x80109008,0x4(%esp)
80103fc0:	80 
80103fc1:	89 04 24             	mov    %eax,(%esp)
80103fc4:	e8 98 12 00 00       	call   80105261 <initlock>
  (*f0)->type = FD_PIPE;
...
80104070:	e8 0d 12 00 00       	call   80105282 <acquire>
  if(writable){
...
80104093:	e8 1a 0d 00 00       	call   80104db2 <wakeup>
...
801040b2:	e8 fb 0c 00 00       	call   80104db2 <wakeup>
  }
...
801040d7:	e8 08 12 00 00       	call   801052e4 <release>
    kfree((char*)p);
...
801040ef:	e8 f0 11 00 00       	call   801052e4 <release>
}
801040f4:	c9                   	leave  
801040f5:	c3                   	ret    
...
80104102:	e8 7b 11 00 00       	call   80105282 <acquire>
  for(i = 0; i < n; i++){
...
80104135:	e8 aa 11 00 00       	call   801052e4 <release>
        return -1;
...
8010414f:	e8 5e 0c 00 00       	call   80104db2 <wakeup>
...
80104167:	e8 3a 0b 00 00       	call   80104ca6 <sleep>
{
  int i;
...
801041d0:	e8 dd 0b 00 00       	call   80104db2 <wakeup>
  release(&p->lock);
801041d5:	8b 45 08             	mov    0x8(%ebp),%eax
801041d8:	89 04 24             	mov    %eax,(%esp)
801041db:	e8 04 11 00 00       	call   801052e4 <release>
  return n;
...
801041f2:	e8 8b 10 00 00       	call   80105282 <acquire>
...
8010420c:	e8 d3 10 00 00       	call   801052e4 <release>
      return -1;
...
8010422e:	e8 73 0a 00 00       	call   80104ca6 <sleep>
piperead(struct pipe *p, char *addr, int n)
{
  int i;
...
801042bd:	e8 f0 0a 00 00       	call   80104db2 <wakeup>
  release(&p->lock);
801042c2:	8b 45 08             	mov    0x8(%ebp),%eax
801042c5:	89 04 24             	mov    %eax,(%esp)
801042c8:	e8 17 10 00 00       	call   801052e4 <release>
  return i;
...
80104352:	c7 44 24 04 0d 90 10 	movl   $0x8010900d,0x4(%esp)
80104359:	80 
8010435a:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104361:	e8 fb 0e 00 00       	call   80105261 <initlock>
}
80104366:	c9                   	leave  
80104367:	c3                   	ret    
...
8010436b:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ptable.lock);
8010436e:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104375:	e8 08 0f 00 00       	call   80105282 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010437a:	c7 45 f4 b4 39 11 80 	movl   $0x801139b4,-0xc(%ebp)
80104381:	e9 9b 00 00 00       	jmp    80104421 <allocproc+0xb9>
    if(p->state == UNUSED)
80104386:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104389:	8b 40 0c             	mov    0xc(%eax),%eax
8010438c:	85 c0                	test   %eax,%eax
8010438e:	0f 85 86 00 00 00    	jne    8010441a <allocproc+0xb2>
      goto found;
80104394:	90                   	nop
  release(&ptable.lock);
  return 0;
...
801043a7:	89 15 04 c0 10 80    	mov    %edx,0x8010c004
...
801043b6:	c7 80 20 01 00 00 e8 	movl   $0x3e8,0x120(%eax)
801043bd:	03 00 00 
  totalTickets += EXE_TICKETS;
801043c0:	a1 68 c6 10 80       	mov    0x8010c668,%eax
801043c5:	05 e8 03 00 00       	add    $0x3e8,%eax
801043ca:	a3 68 c6 10 80       	mov    %eax,0x8010c668
  acquire(&tickslock);
801043cf:	c7 04 24 c0 82 11 80 	movl   $0x801182c0,(%esp)
801043d6:	e8 a7 0e 00 00       	call   80105282 <acquire>
  p->ctime = ticks;
801043db:	a1 00 8b 11 80       	mov    0x80118b00,%eax
801043e0:	89 c2                	mov    %eax,%edx
801043e2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801043e5:	89 90 04 01 00 00    	mov    %edx,0x104(%eax)
  release(&tickslock);
801043eb:	c7 04 24 c0 82 11 80 	movl   $0x801182c0,(%esp)
801043f2:	e8 ed 0e 00 00       	call   801052e4 <release>
  release(&ptable.lock);
801043f7:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
801043fe:	e8 e1 0e 00 00       	call   801052e4 <release>

  // Allocate kernel stack.
  if((p->kstack = kalloc()) == 0){
80104403:	e8 da e6 ff ff       	call   80102ae2 <kalloc>
...
80104416:	75 3a                	jne    80104452 <allocproc+0xea>
80104418:	eb 27                	jmp    80104441 <allocproc+0xd9>
{
  struct proc *p;
  char *sp;
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010441a:	81 45 f4 24 01 00 00 	addl   $0x124,-0xc(%ebp)
80104421:	81 7d f4 b4 82 11 80 	cmpl   $0x801182b4,-0xc(%ebp)
80104428:	0f 82 58 ff ff ff    	jb     80104386 <allocproc+0x1e>
    if(p->state == UNUSED)
      goto found;
  release(&ptable.lock);
8010442e:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104435:	e8 aa 0e 00 00       	call   801052e4 <release>
  return 0;
8010443a:	b8 00 00 00 00       	mov    $0x0,%eax
8010443f:	eb 76                	jmp    801044b7 <allocproc+0x14f>
  release(&tickslock);
  release(&ptable.lock);
...
80104444:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
    return 0;
8010444b:	b8 00 00 00 00       	mov    $0x0,%eax
80104450:	eb 65                	jmp    801044b7 <allocproc+0x14f>
  }
...
80104471:	ba 26 6a 10 80       	mov    $0x80106a26,%edx
...
80104485:	89 50 20             	mov    %edx,0x20(%eax)
  memset(p->context, 0, sizeof *p->context);
80104488:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010448b:	8b 40 20             	mov    0x20(%eax),%eax
...
801044a1:	e8 30 10 00 00       	call   801054d6 <memset>
  p->context->eip = (uint)forkret;
801044a6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801044a9:	8b 40 20             	mov    0x20(%eax),%eax
801044ac:	ba 7a 4c 10 80       	mov    $0x80104c7a,%edx
...
801044bc:	83 ec 28             	sub    $0x28,%esp
  ...
  p = allocproc();
801044bf:	e8 a4 fe ff ff       	call   80104368 <allocproc>
801044c4:	89 45 f4             	mov    %eax,-0xc(%ebp)
  initproc = p;
801044c7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801044ca:	a3 6c c6 10 80       	mov    %eax,0x8010c66c
  if((p->pgdir = setupkvm()) == 0)
801044cf:	e8 f6 3f 00 00       	call   801084ca <setupkvm>
...
801044e2:	75 0c                	jne    801044f0 <userinit+0x37>
    panic("userinit: out of memory?");
801044e4:	c7 04 24 14 90 10 80 	movl   $0x80109014,(%esp)
801044eb:	e8 4a c0 ff ff       	call   8010053a <panic>
  inituvm(p->pgdir, _binary_initcode_start, (int)_binary_initcode_size);
801044f0:	ba 2c 00 00 00       	mov    $0x2c,%edx
801044f5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801044f8:	8b 40 04             	mov    0x4(%eax),%eax
801044fb:	89 54 24 08          	mov    %edx,0x8(%esp)
801044ff:	c7 44 24 04 00 c5 10 	movl   $0x8010c500,0x4(%esp)
80104506:	80 
80104507:	89 04 24             	mov    %eax,(%esp)
8010450a:	e8 13 42 00 00       	call   80108722 <inituvm>
  p->sz = PGSIZE;
8010450f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104512:	c7 00 00 10 00 00    	movl   $0x1000,(%eax)
  memset(p->tf, 0, sizeof(*p->tf));
80104518:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010451b:	8b 40 18             	mov    0x18(%eax),%eax
8010451e:	c7 44 24 08 4c 00 00 	movl   $0x4c,0x8(%esp)
80104525:	00 
80104526:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010452d:	00 
8010452e:	89 04 24             	mov    %eax,(%esp)
80104531:	e8 a0 0f 00 00       	call   801054d6 <memset>
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
80104536:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104539:	8b 40 18             	mov    0x18(%eax),%eax
8010453c:	66 c7 40 3c 23 00    	movw   $0x23,0x3c(%eax)
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
80104542:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104545:	8b 40 18             	mov    0x18(%eax),%eax
80104548:	66 c7 40 2c 2b 00    	movw   $0x2b,0x2c(%eax)
  p->tf->es = p->tf->ds;
8010454e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104551:	8b 40 18             	mov    0x18(%eax),%eax
80104554:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104557:	8b 52 18             	mov    0x18(%edx),%edx
...
801045a0:	83 c0 70             	add    $0x70,%eax
801045a3:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
801045aa:	00 
801045ab:	c7 44 24 04 2d 90 10 	movl   $0x8010902d,0x4(%esp)
801045b2:	80 
801045b3:	89 04 24             	mov    %eax,(%esp)
801045b6:	e8 3b 11 00 00       	call   801056f6 <safestrcpy>
  p->cwd = namei("/");
801045bb:	c7 04 24 36 90 10 80 	movl   $0x80109036,(%esp)
801045c2:	e8 3f de ff ff       	call   80102406 <namei>
801045c7:	8b 55 f4             	mov    -0xc(%ebp),%edx
801045ca:	89 42 6c             	mov    %eax,0x6c(%edx)

  p->state = RUNNABLE;
801045cd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801045d0:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  p->tickets = EXE_TICKETS;
801045d7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801045da:	c7 80 20 01 00 00 e8 	movl   $0x3e8,0x120(%eax)
801045e1:	03 00 00 
		rrqueue.first = p;
	if (rrqueue.last)
...
801045e9:	83 ec 28             	sub    $0x28,%esp
  uint sz;
  
  sz = proc->sz;
801045ec:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801045f2:	8b 00                	mov    (%eax),%eax
801045f4:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(n > 0){
801045f7:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
801045fb:	7e 34                	jle    80104631 <growproc+0x4b>
    if((sz = allocuvm(proc->pgdir, sz, sz + n)) == 0)
801045fd:	8b 55 08             	mov    0x8(%ebp),%edx
80104600:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104603:	01 c2                	add    %eax,%edx
...
8010461c:	e8 77 42 00 00       	call   80108898 <allocuvm>
80104621:	89 45 f4             	mov    %eax,-0xc(%ebp)
80104624:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80104628:	75 41                	jne    8010466b <growproc+0x85>
      return -1;
8010462a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010462f:	eb 58                	jmp    80104689 <growproc+0xa3>
  } else if(n < 0){
80104631:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80104635:	79 34                	jns    8010466b <growproc+0x85>
    if((sz = deallocuvm(proc->pgdir, sz, sz + n)) == 0)
80104637:	8b 55 08             	mov    0x8(%ebp),%edx
8010463a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010463d:	01 c2                	add    %eax,%edx
...
80104691:	83 ec 2c             	sub    $0x2c,%esp
  int i, pid;
  struct proc *np;

  // Allocate process.
  if((np = allocproc()) == 0)
80104694:	e8 cf fc ff ff       	call   80104368 <allocproc>
...
801046a7:	e9 ad 01 00 00       	jmp    80104859 <fork+0x1ce>
...
801046c4:	e8 45 44 00 00       	call   80108b0e <copyuvm>
801046c9:	8b 55 e0             	mov    -0x20(%ebp),%edx
801046cc:	89 42 04             	mov    %eax,0x4(%edx)
801046cf:	8b 45 e0             	mov    -0x20(%ebp),%eax
801046d2:	8b 40 04             	mov    0x4(%eax),%eax
801046d5:	85 c0                	test   %eax,%eax
801046d7:	75 2c                	jne    80104705 <fork+0x7a>
    kfree(np->kstack);
801046d9:	8b 45 e0             	mov    -0x20(%ebp),%eax
801046dc:	8b 40 08             	mov    0x8(%eax),%eax
801046df:	89 04 24             	mov    %eax,(%esp)
801046e2:	e8 62 e3 ff ff       	call   80102a49 <kfree>
    np->kstack = 0;
801046e7:	8b 45 e0             	mov    -0x20(%ebp),%eax
801046ea:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
    np->state = UNUSED;
801046f1:	8b 45 e0             	mov    -0x20(%ebp),%eax
801046f4:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
    return -1;
801046fb:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104700:	e9 54 01 00 00       	jmp    80104859 <fork+0x1ce>
  }
  np->sz = proc->sz;
80104705:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010470b:	8b 10                	mov    (%eax),%edx
8010470d:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104710:	89 10                	mov    %edx,(%eax)
  np->parent = proc;
80104712:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104719:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010471c:	89 50 14             	mov    %edx,0x14(%eax)
  *np->tf = *proc->tf;
8010471f:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104722:	8b 50 18             	mov    0x18(%eax),%edx
80104725:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010472b:	8b 40 18             	mov    0x18(%eax),%eax
8010472e:	89 c3                	mov    %eax,%ebx
80104730:	b8 13 00 00 00       	mov    $0x13,%eax
80104735:	89 d7                	mov    %edx,%edi
80104737:	89 de                	mov    %ebx,%esi
80104739:	89 c1                	mov    %eax,%ecx
8010473b:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)

  // Clear %eax so that fork returns 0 in the child.
  np->tf->eax = 0;
8010473d:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104740:	8b 40 18             	mov    0x18(%eax),%eax
80104743:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)

  for(i = 0; i < NOFILE; i++)
8010474a:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
80104751:	eb 3d                	jmp    80104790 <fork+0x105>
    if(proc->ofile[i])
80104753:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104759:	8b 55 e4             	mov    -0x1c(%ebp),%edx
8010475c:	83 c2 08             	add    $0x8,%edx
8010475f:	8b 44 90 0c          	mov    0xc(%eax,%edx,4),%eax
80104763:	85 c0                	test   %eax,%eax
80104765:	74 25                	je     8010478c <fork+0x101>
      np->ofile[i] = filedup(proc->ofile[i]);
80104767:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010476d:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80104770:	83 c2 08             	add    $0x8,%edx
80104773:	8b 44 90 0c          	mov    0xc(%eax,%edx,4),%eax
80104777:	89 04 24             	mov    %eax,(%esp)
8010477a:	e8 07 c8 ff ff       	call   80100f86 <filedup>
8010477f:	8b 55 e0             	mov    -0x20(%ebp),%edx
80104782:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80104785:	83 c1 08             	add    $0x8,%ecx
80104788:	89 44 8a 0c          	mov    %eax,0xc(%edx,%ecx,4)
  *np->tf = *proc->tf;
  ...
  for(i = 0; i < NOFILE; i++)
8010478c:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
80104790:	83 7d e4 0f          	cmpl   $0xf,-0x1c(%ebp)
80104794:	7e bd                	jle    80104753 <fork+0xc8>
    if(proc->ofile[i])
      np->ofile[i] = filedup(proc->ofile[i]);
  np->cwd = idup(proc->cwd);
80104796:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010479c:	8b 40 6c             	mov    0x6c(%eax),%eax
8010479f:	89 04 24             	mov    %eax,(%esp)
801047a2:	e8 82 d0 ff ff       	call   80101829 <idup>
801047a7:	8b 55 e0             	mov    -0x20(%ebp),%edx
801047aa:	89 42 6c             	mov    %eax,0x6c(%edx)

  safestrcpy(np->name, proc->name, sizeof(proc->name));
801047ad:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801047b3:	8d 50 70             	lea    0x70(%eax),%edx
801047b6:	8b 45 e0             	mov    -0x20(%ebp),%eax
801047b9:	83 c0 70             	add    $0x70,%eax
801047bc:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
801047c3:	00 
801047c4:	89 54 24 04          	mov    %edx,0x4(%esp)
801047c8:	89 04 24             	mov    %eax,(%esp)
801047cb:	e8 26 0f 00 00       	call   801056f6 <safestrcpy>
 
  pid = np->pid;
801047d0:	8b 45 e0             	mov    -0x20(%ebp),%eax
801047d3:	8b 40 10             	mov    0x10(%eax),%eax
801047d6:	89 45 dc             	mov    %eax,-0x24(%ebp)
   np->runQuanta = 0;		//reset proc Time
801047d9:	8b 45 e0             	mov    -0x20(%ebp),%eax
801047dc:	c7 80 18 01 00 00 00 	movl   $0x0,0x118(%eax)
801047e3:	00 00 00 
   np->rutime = 0;
801047e6:	8b 45 e0             	mov    -0x20(%ebp),%eax
801047e9:	c7 80 14 01 00 00 00 	movl   $0x0,0x114(%eax)
801047f0:	00 00 00 
   np->ctime	 = 0;
801047f3:	8b 45 e0             	mov    -0x20(%ebp),%eax
801047f6:	c7 80 04 01 00 00 00 	movl   $0x0,0x104(%eax)
801047fd:	00 00 00 
   np->ttime	 = 0;
80104800:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104803:	c7 80 08 01 00 00 00 	movl   $0x0,0x108(%eax)
8010480a:	00 00 00 
   np->stime	 = 0;
8010480d:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104810:	c7 80 0c 01 00 00 00 	movl   $0x0,0x10c(%eax)
80104817:	00 00 00 
   np->retime	 = 0;
8010481a:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010481d:	c7 80 10 01 00 00 00 	movl   $0x0,0x110(%eax)
80104824:	00 00 00 
   np->priority = 0;
80104827:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010482a:	c7 80 1c 01 00 00 00 	movl   $0x0,0x11c(%eax)
80104831:	00 00 00 
  // lock to force the compiler to emit the np->state write last.
  acquire(&ptable.lock);
80104834:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
8010483b:	e8 42 0a 00 00       	call   80105282 <acquire>
  np->state = RUNNABLE;
...
80104851:	e8 8e 0a 00 00       	call   801052e4 <release>
...
8010486e:	a1 6c c6 10 80       	mov    0x8010c66c,%eax
80104873:	39 c2                	cmp    %eax,%edx
80104875:	75 0c                	jne    80104883 <exit+0x22>
    panic("init exiting");
80104877:	c7 04 24 38 90 10 80 	movl   $0x80109038,(%esp)
...
80104898:	8b 44 90 0c          	mov    0xc(%eax,%edx,4),%eax
...
801048ac:	8b 44 90 0c          	mov    0xc(%eax,%edx,4),%eax
801048b0:	89 04 24             	mov    %eax,(%esp)
801048b3:	e8 16 c7 ff ff       	call   80100fce <fileclose>
      proc->ofile[fd] = 0;
801048b8:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801048be:	8b 55 f0             	mov    -0x10(%ebp),%edx
801048c1:	83 c2 08             	add    $0x8,%edx
801048c4:	c7 44 90 0c 00 00 00 	movl   $0x0,0xc(%eax,%edx,4)
801048cb:	00 
...
801048d4:	7e b6                	jle    8010488c <exit+0x2b>
  ...
  begin_op();
801048d6:	e8 35 eb ff ff       	call   80103410 <begin_op>
  iput(proc->cwd);
801048db:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801048e1:	8b 40 6c             	mov    0x6c(%eax),%eax
801048e4:	89 04 24             	mov    %eax,(%esp)
801048e7:	e8 22 d1 ff ff       	call   80101a0e <iput>
  end_op();
801048ec:	e8 a3 eb ff ff       	call   80103494 <end_op>
  proc->cwd = 0;
801048f1:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801048f7:	c7 40 6c 00 00 00 00 	movl   $0x0,0x6c(%eax)

  acquire(&ptable.lock);
801048fe:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104905:	e8 78 09 00 00       	call   80105282 <acquire>

  totalTickets -= proc->tickets;
8010490a:	8b 15 68 c6 10 80    	mov    0x8010c668,%edx
80104910:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104916:	8b 80 20 01 00 00    	mov    0x120(%eax),%eax
8010491c:	29 c2                	sub    %eax,%edx
8010491e:	89 d0                	mov    %edx,%eax
80104920:	a3 68 c6 10 80       	mov    %eax,0x8010c668
  // Parent might be sleeping in wait().
  wakeup1(proc->parent);
80104925:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010492b:	8b 40 14             	mov    0x14(%eax),%eax
8010492e:	89 04 24             	mov    %eax,(%esp)
80104931:	e8 26 04 00 00       	call   80104d5c <wakeup1>

  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104936:	c7 45 f4 b4 39 11 80 	movl   $0x801139b4,-0xc(%ebp)
8010493d:	eb 3b                	jmp    8010497a <exit+0x119>
    if(p->parent == proc){
8010493f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104942:	8b 50 14             	mov    0x14(%eax),%edx
80104945:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010494b:	39 c2                	cmp    %eax,%edx
8010494d:	75 24                	jne    80104973 <exit+0x112>
      p->parent = initproc;
8010494f:	8b 15 6c c6 10 80    	mov    0x8010c66c,%edx
...
80104964:	75 0d                	jne    80104973 <exit+0x112>
        wakeup1(initproc);
80104966:	a1 6c c6 10 80       	mov    0x8010c66c,%eax
8010496b:	89 04 24             	mov    %eax,(%esp)
8010496e:	e8 e9 03 00 00       	call   80104d5c <wakeup1>
  totalTickets -= proc->tickets;
  // Parent might be sleeping in wait().
  wakeup1(proc->parent);
  ...
  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104973:	81 45 f4 24 01 00 00 	addl   $0x124,-0xc(%ebp)
8010497a:	81 7d f4 b4 82 11 80 	cmpl   $0x801182b4,-0xc(%ebp)
80104981:	72 bc                	jb     8010493f <exit+0xde>
        wakeup1(initproc);
    }
  }
...
80104989:	c7 40 0c 05 00 00 00 	movl   $0x5,0xc(%eax)
  acquire(&tickslock);
80104990:	c7 04 24 c0 82 11 80 	movl   $0x801182c0,(%esp)
80104997:	e8 e6 08 00 00       	call   80105282 <acquire>
  proc->ttime = ticks;
8010499c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801049a2:	8b 15 00 8b 11 80    	mov    0x80118b00,%edx
801049a8:	89 90 08 01 00 00    	mov    %edx,0x108(%eax)
  release(&tickslock);
801049ae:	c7 04 24 c0 82 11 80 	movl   $0x801182c0,(%esp)
801049b5:	e8 2a 09 00 00       	call   801052e4 <release>
  sched();
801049ba:	e8 d7 01 00 00       	call   80104b96 <sched>
  panic("zombie exit");
801049bf:	c7 04 24 45 90 10 80 	movl   $0x80109045,(%esp)
801049c6:	e8 6f bb ff ff       	call   8010053a <panic>
...
801049ce:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;
  int havekids, pid;

  acquire(&ptable.lock);
801049d1:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
801049d8:	e8 a5 08 00 00       	call   80105282 <acquire>
  for(;;){
    // Scan through table looking for zombie children.
    havekids = 0;
801049dd:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801049e4:	c7 45 f4 b4 39 11 80 	movl   $0x801139b4,-0xc(%ebp)
801049eb:	e9 bb 00 00 00       	jmp    80104aab <wait+0xe0>
      if(p->parent != proc)
801049f0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801049f3:	8b 50 14             	mov    0x14(%eax),%edx
801049f6:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801049fc:	39 c2                	cmp    %eax,%edx
801049fe:	74 05                	je     80104a05 <wait+0x3a>
        continue;
80104a00:	e9 9f 00 00 00       	jmp    80104aa4 <wait+0xd9>
      havekids = 1;
80104a05:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
      if(p->state == ZOMBIE){
80104a0c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104a0f:	8b 40 0c             	mov    0xc(%eax),%eax
80104a12:	83 f8 05             	cmp    $0x5,%eax
80104a15:	0f 85 89 00 00 00    	jne    80104aa4 <wait+0xd9>
        // Found one.
        pid = p->pid;
...
80104a2d:	e8 17 e0 ff ff       	call   80102a49 <kfree>
        p->kstack = 0;
80104a32:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104a35:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
        freevm(p->pgdir);
80104a3c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104a3f:	8b 40 04             	mov    0x4(%eax),%eax
80104a42:	89 04 24             	mov    %eax,(%esp)
80104a45:	e8 e4 3f 00 00       	call   80108a2e <freevm>
        p->state = UNUSED;
80104a4a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104a4d:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
        p->pid = 0;
80104a54:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104a57:	c7 40 10 00 00 00 00 	movl   $0x0,0x10(%eax)
        p->parent = 0;
80104a5e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104a61:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
        p->name[0] = 0;
80104a68:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104a6b:	c6 40 70 00          	movb   $0x0,0x70(%eax)
        p->killed = 0;
80104a6f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104a72:	c7 40 28 00 00 00 00 	movl   $0x0,0x28(%eax)
        p->runQuanta = 0;		//reset proc Time
80104a79:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104a7c:	c7 80 18 01 00 00 00 	movl   $0x0,0x118(%eax)
80104a83:	00 00 00 
        p->rutime = 0;
80104a86:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104a89:	c7 80 14 01 00 00 00 	movl   $0x0,0x114(%eax)
80104a90:	00 00 00 
        release(&ptable.lock);
80104a93:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104a9a:	e8 45 08 00 00       	call   801052e4 <release>
        return pid;
80104a9f:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104aa2:	eb 55                	jmp    80104af9 <wait+0x12e>
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104aa4:	81 45 f4 24 01 00 00 	addl   $0x124,-0xc(%ebp)
80104aab:	81 7d f4 b4 82 11 80 	cmpl   $0x801182b4,-0xc(%ebp)
80104ab2:	0f 82 38 ff ff ff    	jb     801049f0 <wait+0x25>
        return pid;
      }
    }
...
80104ab8:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80104abc:	74 0d                	je     80104acb <wait+0x100>
80104abe:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104ac4:	8b 40 28             	mov    0x28(%eax),%eax
80104ac7:	85 c0                	test   %eax,%eax
80104ac9:	74 13                	je     80104ade <wait+0x113>
      release(&ptable.lock);
80104acb:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104ad2:	e8 0d 08 00 00       	call   801052e4 <release>
      return -1;
80104ad7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104adc:	eb 1b                	jmp    80104af9 <wait+0x12e>
    }

    // Wait for children to exit.  (See wakeup1 call in proc_exit.)
    sleep(proc, &ptable.lock);  //DOC: wait-sleep
80104ade:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104ae4:	c7 44 24 04 80 39 11 	movl   $0x80113980,0x4(%esp)
80104aeb:	80 
80104aec:	89 04 24             	mov    %eax,(%esp)
80104aef:	e8 b2 01 00 00       	call   80104ca6 <sleep>
  }
80104af4:	e9 e4 fe ff ff       	jmp    801049dd <wait+0x12>
}
80104af9:	c9                   	leave  
80104afa:	c3                   	ret    
...
80104afe:	83 ec 28             	sub    $0x28,%esp
  ...
  for(;;){
    ...
    sti();
80104b01:	e8 e0 f7 ff ff       	call   801042e6 <sti>

    // Loop over process table looking for process to run.
    acquire(&ptable.lock);
80104b06:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104b0d:	e8 70 07 00 00       	call   80105282 <acquire>
#ifdef DEFAULT
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104b12:	c7 45 f4 b4 39 11 80 	movl   $0x801139b4,-0xc(%ebp)
80104b19:	eb 61                	jmp    80104b7c <scheduler+0x81>
      if(p->state != RUNNABLE)
80104b1b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b1e:	8b 40 0c             	mov    0xc(%eax),%eax
80104b21:	83 f8 03             	cmp    $0x3,%eax
80104b24:	74 02                	je     80104b28 <scheduler+0x2d>
        continue;
80104b26:	eb 4d                	jmp    80104b75 <scheduler+0x7a>
      // Switch to chosen process.  It is the process's job
      // to release ptable.lock and then reacquire it
      // before jumping back to us.
      proc = p;
80104b28:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b2b:	65 a3 04 00 00 00    	mov    %eax,%gs:0x4
      switchuvm(p);
80104b31:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b34:	89 04 24             	mov    %eax,(%esp)
80104b37:	e8 7f 3a 00 00       	call   801085bb <switchuvm>
      p->state = RUNNING;
80104b3c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b3f:	c7 40 0c 04 00 00 00 	movl   $0x4,0xc(%eax)
      swtch(&cpu->scheduler, proc->context);
80104b46:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104b4c:	8b 40 20             	mov    0x20(%eax),%eax
80104b4f:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80104b56:	83 c2 04             	add    $0x4,%edx
80104b59:	89 44 24 04          	mov    %eax,0x4(%esp)
80104b5d:	89 14 24             	mov    %edx,(%esp)
80104b60:	e8 02 0c 00 00       	call   80105767 <swtch>
      switchkvm();
80104b65:	e8 34 3a 00 00       	call   8010859e <switchkvm>

      // Process is done running for now.
      // It should have changed its p->state before coming back.
      proc = 0;
80104b6a:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
80104b71:	00 00 00 00 
    sti();
...
#ifdef DEFAULT
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104b75:	81 45 f4 24 01 00 00 	addl   $0x124,-0xc(%ebp)
80104b7c:	81 7d f4 b4 82 11 80 	cmpl   $0x801182b4,-0xc(%ebp)
80104b83:	72 96                	jb     80104b1b <scheduler+0x20>
    			// It should have changed its p->state before coming back.
    			proc = 0;
    			//break;
    		}
#endif
    release(&ptable.lock);
80104b85:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104b8c:	e8 53 07 00 00       	call   801052e4 <release>

  }
80104b91:	e9 6b ff ff ff       	jmp    80104b01 <scheduler+0x6>
...
80104b9c:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104ba3:	e8 04 08 00 00       	call   801053ac <holding>
80104ba8:	85 c0                	test   %eax,%eax
80104baa:	75 0c                	jne    80104bb8 <sched+0x22>
    panic("sched ptable.lock");
80104bac:	c7 04 24 51 90 10 80 	movl   $0x80109051,(%esp)
80104bb3:	e8 82 b9 ff ff       	call   8010053a <panic>
  if(cpu->ncli != 1)
80104bb8:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104bbe:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80104bc4:	83 f8 01             	cmp    $0x1,%eax
80104bc7:	74 0c                	je     80104bd5 <sched+0x3f>
    panic("sched locks");
80104bc9:	c7 04 24 63 90 10 80 	movl   $0x80109063,(%esp)
...
80104bde:	83 f8 04             	cmp    $0x4,%eax
80104be1:	75 0c                	jne    80104bef <sched+0x59>
    panic("sched running");
80104be3:	c7 04 24 6f 90 10 80 	movl   $0x8010906f,(%esp)
80104bea:	e8 4b b9 ff ff       	call   8010053a <panic>
  if(readeflags()&FL_IF)
80104bef:	e8 e2 f6 ff ff       	call   801042d6 <readeflags>
80104bf4:	25 00 02 00 00       	and    $0x200,%eax
80104bf9:	85 c0                	test   %eax,%eax
80104bfb:	74 0c                	je     80104c09 <sched+0x73>
    panic("sched interruptible");
80104bfd:	c7 04 24 7d 90 10 80 	movl   $0x8010907d,(%esp)
80104c04:	e8 31 b9 ff ff       	call   8010053a <panic>
  intena = cpu->intena;
80104c09:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104c0f:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
80104c15:	89 45 f4             	mov    %eax,-0xc(%ebp)
  swtch(&proc->context, cpu->scheduler);
80104c18:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104c1e:	8b 40 04             	mov    0x4(%eax),%eax
80104c21:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104c28:	83 c2 20             	add    $0x20,%edx
80104c2b:	89 44 24 04          	mov    %eax,0x4(%esp)
80104c2f:	89 14 24             	mov    %edx,(%esp)
80104c32:	e8 30 0b 00 00       	call   80105767 <swtch>
  cpu->intena = intena;
80104c37:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104c3d:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104c40:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
80104c46:	c9                   	leave  
80104c47:	c3                   	ret    
...
80104c4e:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104c55:	e8 28 06 00 00       	call   80105282 <acquire>
  proc->state = RUNNABLE;
80104c5a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104c60:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
		rrqueue.first = proc;
	if (rrqueue.last)
  ...
  #endif
  sched();
80104c67:	e8 2a ff ff ff       	call   80104b96 <sched>
  release(&ptable.lock);
80104c6c:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104c73:	e8 6c 06 00 00       	call   801052e4 <release>
}
80104c78:	c9                   	leave  
80104c79:	c3                   	ret    
...
80104c7d:	83 ec 18             	sub    $0x18,%esp
  ...
  release(&ptable.lock);
80104c80:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104c87:	e8 58 06 00 00       	call   801052e4 <release>

  if (first) {
80104c8c:	a1 18 c0 10 80       	mov    0x8010c018,%eax
80104c91:	85 c0                	test   %eax,%eax
80104c93:	74 0f                	je     80104ca4 <forkret+0x2a>
    // Some initialization functions must be run in the context
    // of a regular process (e.g., they call sleep), and thus cannot 
    // be run from main().
    first = 0;
80104c95:	c7 05 18 c0 10 80 00 	movl   $0x0,0x8010c018
80104c9c:	00 00 00 
    initlog();
80104c9f:	e8 5e e5 ff ff       	call   80103202 <initlog>
  }
...
80104cb4:	75 0c                	jne    80104cc2 <sleep+0x1c>
    panic("sleep");
80104cb6:	c7 04 24 91 90 10 80 	movl   $0x80109091,(%esp)
80104cbd:	e8 78 b8 ff ff       	call   8010053a <panic>

  if(lk == 0)
80104cc2:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80104cc6:	75 0c                	jne    80104cd4 <sleep+0x2e>
    panic("sleep without lk");
80104cc8:	c7 04 24 97 90 10 80 	movl   $0x80109097,(%esp)
...
80104cdb:	74 17                	je     80104cf4 <sleep+0x4e>
    acquire(&ptable.lock);  //DOC: sleeplock1
80104cdd:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104ce4:	e8 99 05 00 00       	call   80105282 <acquire>
    release(lk);
80104ce9:	8b 45 0c             	mov    0xc(%ebp),%eax
80104cec:	89 04 24             	mov    %eax,(%esp)
80104cef:	e8 f0 05 00 00       	call   801052e4 <release>
  }
...
80104d06:	c7 40 0c 02 00 00 00 	movl   $0x2,0xc(%eax)
  totalTickets -= proc->tickets;
80104d0d:	8b 15 68 c6 10 80    	mov    0x8010c668,%edx
80104d13:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104d19:	8b 80 20 01 00 00    	mov    0x120(%eax),%eax
80104d1f:	29 c2                	sub    %eax,%edx
80104d21:	89 d0                	mov    %edx,%eax
80104d23:	a3 68 c6 10 80       	mov    %eax,0x8010c668
  sched();
80104d28:	e8 69 fe ff ff       	call   80104b96 <sched>
...
80104d3a:	81 7d 0c 80 39 11 80 	cmpl   $0x80113980,0xc(%ebp)
80104d41:	74 17                	je     80104d5a <sleep+0xb4>
    release(&ptable.lock);
80104d43:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104d4a:	e8 95 05 00 00       	call   801052e4 <release>
    acquire(lk);
80104d4f:	8b 45 0c             	mov    0xc(%ebp),%eax
80104d52:	89 04 24             	mov    %eax,(%esp)
80104d55:	e8 28 05 00 00       	call   80105282 <acquire>
  }
}
80104d5a:	c9                   	leave  
80104d5b:	c3                   	ret    
...
80104d5f:	83 ec 10             	sub    $0x10,%esp
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104d62:	c7 45 fc b4 39 11 80 	movl   $0x801139b4,-0x4(%ebp)
80104d69:	eb 3c                	jmp    80104da7 <wakeup1+0x4b>
    if(p->state == SLEEPING && p->chan == chan){
80104d6b:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104d6e:	8b 40 0c             	mov    0xc(%eax),%eax
80104d71:	83 f8 02             	cmp    $0x2,%eax
80104d74:	75 2a                	jne    80104da0 <wakeup1+0x44>
80104d76:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104d79:	8b 40 24             	mov    0x24(%eax),%eax
80104d7c:	3b 45 08             	cmp    0x8(%ebp),%eax
80104d7f:	75 1f                	jne    80104da0 <wakeup1+0x44>
      p->state = RUNNABLE;
80104d81:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104d84:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
     totalTickets += p->tickets;
80104d8b:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104d8e:	8b 90 20 01 00 00    	mov    0x120(%eax),%edx
80104d94:	a1 68 c6 10 80       	mov    0x8010c668,%eax
80104d99:	01 d0                	add    %edx,%eax
80104d9b:	a3 68 c6 10 80       	mov    %eax,0x8010c668
static void
wakeup1(void *chan)
{
  struct proc *p;
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104da0:	81 45 fc 24 01 00 00 	addl   $0x124,-0x4(%ebp)
80104da7:	81 7d fc b4 82 11 80 	cmpl   $0x801182b4,-0x4(%ebp)
80104dae:	72 bb                	jb     80104d6b <wakeup1+0xf>
			if (rrqueue.last)
				rrqueue.last->rrnext = p;
			rrqueue.last = p;
	  #endif
...
80104dbf:	e8 be 04 00 00       	call   80105282 <acquire>
  wakeup1(chan);
80104dc4:	8b 45 08             	mov    0x8(%ebp),%eax
80104dc7:	89 04 24             	mov    %eax,(%esp)
80104dca:	e8 8d ff ff ff       	call   80104d5c <wakeup1>
  release(&ptable.lock);
80104dcf:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104dd6:	e8 09 05 00 00       	call   801052e4 <release>
}
80104ddb:	c9                   	leave  
80104ddc:	c3                   	ret    
...
80104dea:	e8 93 04 00 00       	call   80105282 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104def:	c7 45 f4 b4 39 11 80 	movl   $0x801139b4,-0xc(%ebp)
80104df6:	eb 44                	jmp    80104e3c <kill+0x5f>
    if(p->pid == pid){
80104df8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104dfb:	8b 40 10             	mov    0x10(%eax),%eax
80104dfe:	3b 45 08             	cmp    0x8(%ebp),%eax
80104e01:	75 32                	jne    80104e35 <kill+0x58>
      p->killed = 1;
80104e03:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104e06:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING){
80104e0d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104e10:	8b 40 0c             	mov    0xc(%eax),%eax
80104e13:	83 f8 02             	cmp    $0x2,%eax
80104e16:	75 0a                	jne    80104e22 <kill+0x45>
        p->state = RUNNABLE;
...
80104e1b:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
      ...
      release(&ptable.lock);
80104e22:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104e29:	e8 b6 04 00 00       	call   801052e4 <release>
      return 0;
80104e2e:	b8 00 00 00 00       	mov    $0x0,%eax
80104e33:	eb 21                	jmp    80104e56 <kill+0x79>
kill(int pid)
{
  struct proc *p;
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104e35:	81 45 f4 24 01 00 00 	addl   $0x124,-0xc(%ebp)
80104e3c:	81 7d f4 b4 82 11 80 	cmpl   $0x801182b4,-0xc(%ebp)
80104e43:	72 b3                	jb     80104df8 <kill+0x1b>
      }
      release(&ptable.lock);
      return 0;
    }
  ...
  release(&ptable.lock);
80104e45:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104e4c:	e8 93 04 00 00       	call   801052e4 <release>
  return -1;
...
80104e5b:	83 ec 58             	sub    $0x58,%esp
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104e5e:	c7 45 f0 b4 39 11 80 	movl   $0x801139b4,-0x10(%ebp)
80104e65:	e9 d9 00 00 00       	jmp    80104f43 <procdump+0xeb>
    if(p->state == UNUSED)
80104e6a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104e6d:	8b 40 0c             	mov    0xc(%eax),%eax
80104e70:	85 c0                	test   %eax,%eax
80104e72:	75 05                	jne    80104e79 <procdump+0x21>
      continue;
80104e74:	e9 c3 00 00 00       	jmp    80104f3c <procdump+0xe4>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104e79:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104e7c:	8b 40 0c             	mov    0xc(%eax),%eax
80104e7f:	83 f8 05             	cmp    $0x5,%eax
80104e82:	77 23                	ja     80104ea7 <procdump+0x4f>
80104e84:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104e87:	8b 40 0c             	mov    0xc(%eax),%eax
80104e8a:	8b 04 85 1c c0 10 80 	mov    -0x7fef3fe4(,%eax,4),%eax
80104e91:	85 c0                	test   %eax,%eax
80104e93:	74 12                	je     80104ea7 <procdump+0x4f>
      state = states[p->state];
80104e95:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104e98:	8b 40 0c             	mov    0xc(%eax),%eax
80104e9b:	8b 04 85 1c c0 10 80 	mov    -0x7fef3fe4(,%eax,4),%eax
80104ea2:	89 45 ec             	mov    %eax,-0x14(%ebp)
80104ea5:	eb 07                	jmp    80104eae <procdump+0x56>
    else
      state = "???";
80104ea7:	c7 45 ec a8 90 10 80 	movl   $0x801090a8,-0x14(%ebp)
...
80104eba:	89 54 24 0c          	mov    %edx,0xc(%esp)
80104ebe:	8b 55 ec             	mov    -0x14(%ebp),%edx
80104ec1:	89 54 24 08          	mov    %edx,0x8(%esp)
80104ec5:	89 44 24 04          	mov    %eax,0x4(%esp)
80104ec9:	c7 04 24 ac 90 10 80 	movl   $0x801090ac,(%esp)
80104ed0:	e8 cb b4 ff ff       	call   801003a0 <cprintf>
    if(p->state == SLEEPING){
80104ed5:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104ed8:	8b 40 0c             	mov    0xc(%eax),%eax
80104edb:	83 f8 02             	cmp    $0x2,%eax
80104ede:	75 50                	jne    80104f30 <procdump+0xd8>
      getcallerpcs((uint*)p->context->ebp+2, pc);
80104ee0:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104ee3:	8b 40 20             	mov    0x20(%eax),%eax
80104ee6:	8b 40 0c             	mov    0xc(%eax),%eax
80104ee9:	83 c0 08             	add    $0x8,%eax
80104eec:	8d 55 c4             	lea    -0x3c(%ebp),%edx
80104eef:	89 54 24 04          	mov    %edx,0x4(%esp)
80104ef3:	89 04 24             	mov    %eax,(%esp)
80104ef6:	e8 38 04 00 00       	call   80105333 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
80104efb:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80104f02:	eb 1b                	jmp    80104f1f <procdump+0xc7>
        cprintf(" %p", pc[i]);
80104f04:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104f07:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80104f0b:	89 44 24 04          	mov    %eax,0x4(%esp)
80104f0f:	c7 04 24 b5 90 10 80 	movl   $0x801090b5,(%esp)
...
80104f1f:	83 7d f4 09          	cmpl   $0x9,-0xc(%ebp)
80104f23:	7f 0b                	jg     80104f30 <procdump+0xd8>
80104f25:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104f28:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80104f2c:	85 c0                	test   %eax,%eax
80104f2e:	75 d4                	jne    80104f04 <procdump+0xac>
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
80104f30:	c7 04 24 b9 90 10 80 	movl   $0x801090b9,(%esp)
80104f37:	e8 64 b4 ff ff       	call   801003a0 <cprintf>
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104f3c:	81 45 f0 24 01 00 00 	addl   $0x124,-0x10(%ebp)
80104f43:	81 7d f0 b4 82 11 80 	cmpl   $0x801182b4,-0x10(%ebp)
80104f4a:	0f 82 1a ff ff ff    	jb     80104e6a <procdump+0x12>
      for(i=0; i<10 && pc[i] != 0; i++)
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
...
80104f58:	83 7d 08 1f          	cmpl   $0x1f,0x8(%ebp)
80104f5c:	7f 06                	jg     80104f64 <signal+0x12>
80104f5e:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80104f62:	79 07                	jns    80104f6b <signal+0x19>
	    return -1;
80104f64:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104f69:	eb 29                	jmp    80104f94 <signal+0x42>
	}
	else {	
	    retHandler =  proc->signal_handlers[signum];
80104f6b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104f71:	8b 55 08             	mov    0x8(%ebp),%edx
80104f74:	83 c2 20             	add    $0x20,%edx
80104f77:	8b 44 90 04          	mov    0x4(%eax,%edx,4),%eax
...
80104f87:	8d 4a 20             	lea    0x20(%edx),%ecx
80104f8a:	8b 55 0c             	mov    0xc(%ebp),%edx
80104f8d:	89 54 88 04          	mov    %edx,0x4(%eax,%ecx,4)
	}
...
80104f99:	83 ec 28             	sub    $0x28,%esp
    struct proc *p;

    if (signum >= 31 || signum < 0) {
80104f9c:	83 7d 0c 1e          	cmpl   $0x1e,0xc(%ebp)
80104fa0:	7f 06                	jg     80104fa8 <sigsend+0x12>
80104fa2:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80104fa6:	79 0a                	jns    80104fb2 <sigsend+0x1c>
	return -1;
80104fa8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104fad:	e9 91 00 00 00       	jmp    80105043 <sigsend+0xad>
    }
...
80104fb5:	ba 01 00 00 00       	mov    $0x1,%edx
80104fba:	89 c1                	mov    %eax,%ecx
80104fbc:	d3 e2                	shl    %cl,%edx
80104fbe:	89 d0                	mov    %edx,%eax
80104fc0:	89 45 f0             	mov    %eax,-0x10(%ebp)
    acquire(&ptable.lock);
80104fc3:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104fca:	e8 b3 02 00 00       	call   80105282 <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104fcf:	c7 45 f4 b4 39 11 80 	movl   $0x801139b4,-0xc(%ebp)
80104fd6:	eb 51                	jmp    80105029 <sigsend+0x93>
      if(p->pid == pid){
80104fd8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104fdb:	8b 40 10             	mov    0x10(%eax),%eax
80104fde:	3b 45 08             	cmp    0x8(%ebp),%eax
80104fe1:	75 3f                	jne    80105022 <sigsend+0x8c>
	p->pending |= signumBits;
80104fe3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104fe6:	8b 80 80 00 00 00    	mov    0x80(%eax),%eax
80104fec:	0b 45 f0             	or     -0x10(%ebp),%eax
80104fef:	89 c2                	mov    %eax,%edx
80104ff1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104ff4:	89 90 80 00 00 00    	mov    %edx,0x80(%eax)
	// Wake process from sleep if necessary.
	if(p->state == SLEEPING)
80104ffa:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104ffd:	8b 40 0c             	mov    0xc(%eax),%eax
80105000:	83 f8 02             	cmp    $0x2,%eax
80105003:	75 0a                	jne    8010500f <sigsend+0x79>
	  p->state = RUNNABLE;
80105005:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105008:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
	release(&ptable.lock);
8010500f:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80105016:	e8 c9 02 00 00       	call   801052e4 <release>
	return 0;
8010501b:	b8 00 00 00 00       	mov    $0x0,%eax
80105020:	eb 21                	jmp    80105043 <sigsend+0xad>
    if (signum >= 31 || signum < 0) {
	return -1;
    }
    uint signumBits = 1 << signum; // bit respresentation of signum. e.g: signum = 5 -> signumBits = 000000...0100000         
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80105022:	81 45 f4 24 01 00 00 	addl   $0x124,-0xc(%ebp)
80105029:	81 7d f4 b4 82 11 80 	cmpl   $0x801182b4,-0xc(%ebp)
80105030:	72 a6                	jb     80104fd8 <sigsend+0x42>
	  p->state = RUNNABLE;
	release(&ptable.lock);
	return 0;
      }
    ...
    release(&ptable.lock);
80105032:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80105039:	e8 a6 02 00 00       	call   801052e4 <release>
    return -1;
...
80105048:	83 ec 10             	sub    $0x10,%esp
	...
	for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010504b:	c7 45 fc b4 39 11 80 	movl   $0x801139b4,-0x4(%ebp)
80105052:	eb 6c                	jmp    801050c0 <advanceprocstats+0x7b>
		if(p->state == RUNNING) {
80105054:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105057:	8b 40 0c             	mov    0xc(%eax),%eax
8010505a:	83 f8 04             	cmp    $0x4,%eax
8010505d:	75 17                	jne    80105076 <advanceprocstats+0x31>
			p->rutime++;
8010505f:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105062:	8b 80 14 01 00 00    	mov    0x114(%eax),%eax
80105068:	8d 50 01             	lea    0x1(%eax),%edx
8010506b:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010506e:	89 90 14 01 00 00    	mov    %edx,0x114(%eax)
			continue;
80105074:	eb 43                	jmp    801050b9 <advanceprocstats+0x74>
		}
		if(p->state == RUNNABLE) {
80105076:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105079:	8b 40 0c             	mov    0xc(%eax),%eax
8010507c:	83 f8 03             	cmp    $0x3,%eax
8010507f:	75 17                	jne    80105098 <advanceprocstats+0x53>
			p->retime++;
80105081:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105084:	8b 80 10 01 00 00    	mov    0x110(%eax),%eax
8010508a:	8d 50 01             	lea    0x1(%eax),%edx
8010508d:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105090:	89 90 10 01 00 00    	mov    %edx,0x110(%eax)
			continue;
80105096:	eb 21                	jmp    801050b9 <advanceprocstats+0x74>
		}
		if(p->state == SLEEPING) {
80105098:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010509b:	8b 40 0c             	mov    0xc(%eax),%eax
8010509e:	83 f8 02             	cmp    $0x2,%eax
801050a1:	75 16                	jne    801050b9 <advanceprocstats+0x74>
			p->stime++;
801050a3:	8b 45 fc             	mov    -0x4(%ebp),%eax
801050a6:	8b 80 0c 01 00 00    	mov    0x10c(%eax),%eax
801050ac:	8d 50 01             	lea    0x1(%eax),%edx
801050af:	8b 45 fc             	mov    -0x4(%ebp),%eax
801050b2:	89 90 0c 01 00 00    	mov    %edx,0x10c(%eax)
			continue;
801050b8:	90                   	nop
void
advanceprocstats(void)
{
	...
	for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801050b9:	81 45 fc 24 01 00 00 	addl   $0x124,-0x4(%ebp)
801050c0:	81 7d fc b4 82 11 80 	cmpl   $0x801182b4,-0x4(%ebp)
801050c7:	72 8b                	jb     80105054 <advanceprocstats+0xf>
		if(p->state == SLEEPING) {
			p->stime++;
			continue;
		}
...
801050ce:	83 ec 28             	sub    $0x28,%esp
	struct proc *p;
	int havekids, pid;
	acquire(&ptable.lock);
801050d1:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
801050d8:	e8 a5 01 00 00       	call   80105282 <acquire>
	for(;;){
		// Scan through table looking for zombie children.
		havekids = 0;
801050dd:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
		for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801050e4:	c7 45 f4 b4 39 11 80 	movl   $0x801139b4,-0xc(%ebp)
801050eb:	e9 eb 00 00 00       	jmp    801051db <wait_stat+0x110>
			if(p->parent != proc)
801050f0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801050f3:	8b 50 14             	mov    0x14(%eax),%edx
801050f6:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801050fc:	39 c2                	cmp    %eax,%edx
801050fe:	74 05                	je     80105105 <wait_stat+0x3a>
				continue;
80105100:	e9 cf 00 00 00       	jmp    801051d4 <wait_stat+0x109>
			havekids = 1;
80105105:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
			if(p->state == ZOMBIE){
8010510c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010510f:	8b 40 0c             	mov    0xc(%eax),%eax
80105112:	83 f8 05             	cmp    $0x5,%eax
80105115:	0f 85 b9 00 00 00    	jne    801051d4 <wait_stat+0x109>
				// Found one.
				pid = p->pid;
8010511b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010511e:	8b 40 10             	mov    0x10(%eax),%eax
80105121:	89 45 ec             	mov    %eax,-0x14(%ebp)
	////////////////////////// the extra
				perfP->ctime =  p->ctime ;
80105124:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105127:	8b 90 04 01 00 00    	mov    0x104(%eax),%edx
8010512d:	8b 45 08             	mov    0x8(%ebp),%eax
80105130:	89 10                	mov    %edx,(%eax)
				perfP->ttime =  p->ttime ;
80105132:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105135:	8b 90 08 01 00 00    	mov    0x108(%eax),%edx
8010513b:	8b 45 08             	mov    0x8(%ebp),%eax
8010513e:	89 50 04             	mov    %edx,0x4(%eax)
				perfP->stime =  p->stime ;
80105141:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105144:	8b 90 0c 01 00 00    	mov    0x10c(%eax),%edx
8010514a:	8b 45 08             	mov    0x8(%ebp),%eax
8010514d:	89 50 08             	mov    %edx,0x8(%eax)
				perfP->retime = p->retime ;
80105150:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105153:	8b 90 10 01 00 00    	mov    0x110(%eax),%edx
80105159:	8b 45 08             	mov    0x8(%ebp),%eax
8010515c:	89 50 0c             	mov    %edx,0xc(%eax)
				perfP->rutime = p->rutime ;
8010515f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105162:	8b 90 14 01 00 00    	mov    0x114(%eax),%edx
80105168:	8b 45 08             	mov    0x8(%ebp),%eax
8010516b:	89 50 10             	mov    %edx,0x10(%eax)
//////////////////////////////////////////////////////
				kfree(p->kstack);
8010516e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105171:	8b 40 08             	mov    0x8(%eax),%eax
80105174:	89 04 24             	mov    %eax,(%esp)
80105177:	e8 cd d8 ff ff       	call   80102a49 <kfree>
				p->kstack = 0;
...
8010518f:	e8 9a 38 00 00       	call   80108a2e <freevm>
				p->state = UNUSED;
80105194:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105197:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
				p->pid = 0;
8010519e:	8b 45 f4             	mov    -0xc(%ebp),%eax
801051a1:	c7 40 10 00 00 00 00 	movl   $0x0,0x10(%eax)
				p->parent = 0;
801051a8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801051ab:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
				p->name[0] = 0;
801051b2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801051b5:	c6 40 70 00          	movb   $0x0,0x70(%eax)
				p->killed = 0;
801051b9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801051bc:	c7 40 28 00 00 00 00 	movl   $0x0,0x28(%eax)
				release(&ptable.lock);
801051c3:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
801051ca:	e8 15 01 00 00       	call   801052e4 <release>
				return pid;
801051cf:	8b 45 ec             	mov    -0x14(%ebp),%eax
801051d2:	eb 55                	jmp    80105229 <wait_stat+0x15e>
	int havekids, pid;
	acquire(&ptable.lock);
	for(;;){
		// Scan through table looking for zombie children.
		havekids = 0;
		for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801051d4:	81 45 f4 24 01 00 00 	addl   $0x124,-0xc(%ebp)
801051db:	81 7d f4 b4 82 11 80 	cmpl   $0x801182b4,-0xc(%ebp)
801051e2:	0f 82 08 ff ff ff    	jb     801050f0 <wait_stat+0x25>
				release(&ptable.lock);
				return pid;
			}
		}
		// No point waiting if we don't have any children.
		if(!havekids || proc->killed){
801051e8:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801051ec:	74 0d                	je     801051fb <wait_stat+0x130>
801051ee:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801051f4:	8b 40 28             	mov    0x28(%eax),%eax
801051f7:	85 c0                	test   %eax,%eax
801051f9:	74 13                	je     8010520e <wait_stat+0x143>
			release(&ptable.lock);
801051fb:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80105202:	e8 dd 00 00 00       	call   801052e4 <release>
			return -1;
80105207:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010520c:	eb 1b                	jmp    80105229 <wait_stat+0x15e>
		}

		// Wait for children to exit.  (See wakeup1 call in proc_exit.)
		sleep(proc, &ptable.lock);  //DOC: wait-sleep
8010520e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105214:	c7 44 24 04 80 39 11 	movl   $0x80113980,0x4(%esp)
8010521b:	80 
8010521c:	89 04 24             	mov    %eax,(%esp)
8010521f:	e8 82 fa ff ff       	call   80104ca6 <sleep>
	}
80105224:	e9 b4 fe ff ff       	jmp    801050dd <wait_stat+0x12>
...
80105288:	e8 49 01 00 00       	call   801053d6 <pushcli>
  if(holding(lk))
8010528d:	8b 45 08             	mov    0x8(%ebp),%eax
80105290:	89 04 24             	mov    %eax,(%esp)
80105293:	e8 14 01 00 00       	call   801053ac <holding>
80105298:	85 c0                	test   %eax,%eax
8010529a:	74 0c                	je     801052a8 <acquire+0x26>
    panic("acquire");
8010529c:	c7 04 24 e5 90 10 80 	movl   $0x801090e5,(%esp)
801052a3:	e8 92 b2 ff ff       	call   8010053a <panic>
...
801052ac:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
801052b3:	00 
801052b4:	89 04 24             	mov    %eax,(%esp)
801052b7:	e8 8b ff ff ff       	call   80105247 <xchg>
801052bc:	85 c0                	test   %eax,%eax
801052be:	75 e9                	jne    801052a9 <acquire+0x27>
    ;

  // Record info about lock acquisition for debugging.
  lk->cpu = cpu;
801052c0:	8b 45 08             	mov    0x8(%ebp),%eax
801052c3:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
801052ca:	89 50 08             	mov    %edx,0x8(%eax)
  getcallerpcs(&lk, lk->pcs);
801052cd:	8b 45 08             	mov    0x8(%ebp),%eax
801052d0:	83 c0 0c             	add    $0xc,%eax
801052d3:	89 44 24 04          	mov    %eax,0x4(%esp)
801052d7:	8d 45 08             	lea    0x8(%ebp),%eax
801052da:	89 04 24             	mov    %eax,(%esp)
801052dd:	e8 51 00 00 00       	call   80105333 <getcallerpcs>
}
801052e2:	c9                   	leave  
801052e3:	c3                   	ret    
...
801052f0:	e8 b7 00 00 00       	call   801053ac <holding>
801052f5:	85 c0                	test   %eax,%eax
801052f7:	75 0c                	jne    80105305 <release+0x21>
    panic("release");
801052f9:	c7 04 24 ed 90 10 80 	movl   $0x801090ed,(%esp)
80105300:	e8 35 b2 ff ff       	call   8010053a <panic>

  lk->pcs[0] = 0;
80105305:	8b 45 08             	mov    0x8(%ebp),%eax
80105308:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
  lk->cpu = 0;
...
8010531c:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105323:	00 
80105324:	89 04 24             	mov    %eax,(%esp)
80105327:	e8 1b ff ff ff       	call   80105247 <xchg>

  popcli();
8010532c:	e8 e9 00 00 00       	call   8010541a <popcli>
}
80105331:	c9                   	leave  
80105332:	c3                   	ret    

80105333 <getcallerpcs>:
...
8010533c:	83 e8 08             	sub    $0x8,%eax
8010533f:	89 45 fc             	mov    %eax,-0x4(%ebp)
  for(i = 0; i < 10; i++){
80105342:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
80105349:	eb 38                	jmp    80105383 <getcallerpcs+0x50>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
8010534b:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
8010534f:	74 38                	je     80105389 <getcallerpcs+0x56>
80105351:	81 7d fc ff ff ff 7f 	cmpl   $0x7fffffff,-0x4(%ebp)
80105358:	76 2f                	jbe    80105389 <getcallerpcs+0x56>
8010535a:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%ebp)
8010535e:	74 29                	je     80105389 <getcallerpcs+0x56>
      break;
    pcs[i] = ebp[1];     // saved %eip
80105360:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105363:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
8010536a:	8b 45 0c             	mov    0xc(%ebp),%eax
8010536d:	01 c2                	add    %eax,%edx
8010536f:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105372:	8b 40 04             	mov    0x4(%eax),%eax
80105375:	89 02                	mov    %eax,(%edx)
...
8010537c:	89 45 fc             	mov    %eax,-0x4(%ebp)
{
  ...
  ebp = (uint*)v - 2;
  for(i = 0; i < 10; i++){
8010537f:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
80105383:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
80105387:	7e c2                	jle    8010534b <getcallerpcs+0x18>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
80105389:	eb 19                	jmp    801053a4 <getcallerpcs+0x71>
    pcs[i] = 0;
...
8010539a:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
801053a0:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
801053a4:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
801053a8:	7e e1                	jle    8010538b <getcallerpcs+0x58>
    pcs[i] = 0;
}
801053aa:	c9                   	leave  
801053ab:	c3                   	ret    
...
801053b6:	74 17                	je     801053cf <holding+0x23>
801053b8:	8b 45 08             	mov    0x8(%ebp),%eax
801053bb:	8b 50 08             	mov    0x8(%eax),%edx
801053be:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801053c4:	39 c2                	cmp    %eax,%edx
801053c6:	75 07                	jne    801053cf <holding+0x23>
801053c8:	b8 01 00 00 00       	mov    $0x1,%eax
801053cd:	eb 05                	jmp    801053d4 <holding+0x28>
801053cf:	b8 00 00 00 00       	mov    $0x0,%eax
}
801053d4:	5d                   	pop    %ebp
801053d5:	c3                   	ret    
...
801053d9:	83 ec 10             	sub    $0x10,%esp
  ...
  eflags = readeflags();
801053dc:	e8 4a fe ff ff       	call   8010522b <readeflags>
801053e1:	89 45 fc             	mov    %eax,-0x4(%ebp)
  cli();
801053e4:	e8 52 fe ff ff       	call   8010523b <cli>
  if(cpu->ncli++ == 0)
801053e9:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
801053f0:	8b 82 ac 00 00 00    	mov    0xac(%edx),%eax
801053f6:	8d 48 01             	lea    0x1(%eax),%ecx
801053f9:	89 8a ac 00 00 00    	mov    %ecx,0xac(%edx)
801053ff:	85 c0                	test   %eax,%eax
80105401:	75 15                	jne    80105418 <pushcli+0x42>
    cpu->intena = eflags & FL_IF;
80105403:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105409:	8b 55 fc             	mov    -0x4(%ebp),%edx
8010540c:	81 e2 00 02 00 00    	and    $0x200,%edx
...
8010541d:	83 ec 18             	sub    $0x18,%esp
  if(readeflags()&FL_IF)
80105420:	e8 06 fe ff ff       	call   8010522b <readeflags>
80105425:	25 00 02 00 00       	and    $0x200,%eax
8010542a:	85 c0                	test   %eax,%eax
8010542c:	74 0c                	je     8010543a <popcli+0x20>
    panic("popcli - interruptible");
8010542e:	c7 04 24 f5 90 10 80 	movl   $0x801090f5,(%esp)
80105435:	e8 00 b1 ff ff       	call   8010053a <panic>
  if(--cpu->ncli < 0)
8010543a:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105440:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
80105446:	83 ea 01             	sub    $0x1,%edx
80105449:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
8010544f:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80105455:	85 c0                	test   %eax,%eax
80105457:	79 0c                	jns    80105465 <popcli+0x4b>
    panic("popcli");
80105459:	c7 04 24 0c 91 10 80 	movl   $0x8010910c,(%esp)
80105460:	e8 d5 b0 ff ff       	call   8010053a <panic>
  if(cpu->ncli == 0 && cpu->intena)
80105465:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010546b:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80105471:	85 c0                	test   %eax,%eax
80105473:	75 15                	jne    8010548a <popcli+0x70>
80105475:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010547b:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
80105481:	85 c0                	test   %eax,%eax
80105483:	74 05                	je     8010548a <popcli+0x70>
    sti();
80105485:	e8 b7 fd ff ff       	call   80105241 <sti>
}
8010548a:	c9                   	leave  
8010548b:	c3                   	ret    
...
80105491:	8b 4d 08             	mov    0x8(%ebp),%ecx
80105494:	8b 55 10             	mov    0x10(%ebp),%edx
80105497:	8b 45 0c             	mov    0xc(%ebp),%eax
8010549a:	89 cb                	mov    %ecx,%ebx
8010549c:	89 df                	mov    %ebx,%edi
8010549e:	89 d1                	mov    %edx,%ecx
801054a0:	fc                   	cld    
801054a1:	f3 aa                	rep stos %al,%es:(%edi)
801054a3:	89 ca                	mov    %ecx,%edx
801054a5:	89 fb                	mov    %edi,%ebx
801054a7:	89 5d 08             	mov    %ebx,0x8(%ebp)
...
801054b4:	57                   	push   %edi
801054b5:	53                   	push   %ebx
  asm volatile("cld; rep stosl" :
801054b6:	8b 4d 08             	mov    0x8(%ebp),%ecx
801054b9:	8b 55 10             	mov    0x10(%ebp),%edx
801054bc:	8b 45 0c             	mov    0xc(%ebp),%eax
801054bf:	89 cb                	mov    %ecx,%ebx
801054c1:	89 df                	mov    %ebx,%edi
801054c3:	89 d1                	mov    %edx,%ecx
801054c5:	fc                   	cld    
801054c6:	f3 ab                	rep stos %eax,%es:(%edi)
801054c8:	89 ca                	mov    %ecx,%edx
801054ca:	89 fb                	mov    %edi,%ebx
801054cc:	89 5d 08             	mov    %ebx,0x8(%ebp)
...
801054df:	83 e0 03             	and    $0x3,%eax
801054e2:	85 c0                	test   %eax,%eax
801054e4:	75 49                	jne    8010552f <memset+0x59>
801054e6:	8b 45 10             	mov    0x10(%ebp),%eax
801054e9:	83 e0 03             	and    $0x3,%eax
801054ec:	85 c0                	test   %eax,%eax
801054ee:	75 3f                	jne    8010552f <memset+0x59>
    c &= 0xFF;
801054f0:	81 65 0c ff 00 00 00 	andl   $0xff,0xc(%ebp)
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
801054f7:	8b 45 10             	mov    0x10(%ebp),%eax
801054fa:	c1 e8 02             	shr    $0x2,%eax
801054fd:	89 c2                	mov    %eax,%edx
801054ff:	8b 45 0c             	mov    0xc(%ebp),%eax
80105502:	c1 e0 18             	shl    $0x18,%eax
80105505:	89 c1                	mov    %eax,%ecx
80105507:	8b 45 0c             	mov    0xc(%ebp),%eax
8010550a:	c1 e0 10             	shl    $0x10,%eax
8010550d:	09 c1                	or     %eax,%ecx
8010550f:	8b 45 0c             	mov    0xc(%ebp),%eax
80105512:	c1 e0 08             	shl    $0x8,%eax
80105515:	09 c8                	or     %ecx,%eax
80105517:	0b 45 0c             	or     0xc(%ebp),%eax
8010551a:	89 54 24 08          	mov    %edx,0x8(%esp)
8010551e:	89 44 24 04          	mov    %eax,0x4(%esp)
80105522:	8b 45 08             	mov    0x8(%ebp),%eax
80105525:	89 04 24             	mov    %eax,(%esp)
80105528:	e8 84 ff ff ff       	call   801054b1 <stosl>
8010552d:	eb 19                	jmp    80105548 <memset+0x72>
  } else
    stosb(dst, c, n);
8010552f:	8b 45 10             	mov    0x10(%ebp),%eax
80105532:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80105543:	e8 44 ff ff ff       	call   8010548c <stosb>
  return dst;
...
801055bd:	73 3d                	jae    801055fc <memmove+0x57>
...
801055ca:	76 30                	jbe    801055fc <memmove+0x57>
    s += n;
...
801055f8:	75 e0                	jne    801055da <memmove+0x35>
  ...
  d = dst;
  if(s < d && s + n > d){
801055fa:	eb 26                	jmp    80105622 <memmove+0x7d>
    s += n;
    d += n;
    while(n-- > 0)
      *--d = *--s;
    ...
    while(n-- > 0)
801055fc:	eb 17                	jmp    80105615 <memmove+0x70>
      *d++ = *s++;
801055fe:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105601:	8d 50 01             	lea    0x1(%eax),%edx
80105604:	89 55 f8             	mov    %edx,-0x8(%ebp)
80105607:	8b 55 fc             	mov    -0x4(%ebp),%edx
8010560a:	8d 4a 01             	lea    0x1(%edx),%ecx
8010560d:	89 4d fc             	mov    %ecx,-0x4(%ebp)
80105610:	0f b6 12             	movzbl (%edx),%edx
80105613:	88 10                	mov    %dl,(%eax)
    s += n;
    d += n;
    while(n-- > 0)
      *--d = *--s;
...
80105620:	75 dc                	jne    801055fe <memmove+0x59>
      *d++ = *s++;
...
80105641:	e8 5f ff ff ff       	call   801055a5 <memmove>
}
80105646:	c9                   	leave  
80105647:	c3                   	ret    
...
80105649:	89 e5                	mov    %esp,%ebp
  while(n > 0 && *p && *p == *q)
8010564b:	eb 0c                	jmp    80105659 <strncmp+0x11>
    n--, p++, q++;
8010564d:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105651:	83 45 08 01          	addl   $0x1,0x8(%ebp)
80105655:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
}
...
8010565d:	74 1a                	je     80105679 <strncmp+0x31>
8010565f:	8b 45 08             	mov    0x8(%ebp),%eax
80105662:	0f b6 00             	movzbl (%eax),%eax
80105665:	84 c0                	test   %al,%al
80105667:	74 10                	je     80105679 <strncmp+0x31>
...
80105677:	74 d4                	je     8010564d <strncmp+0x5>
    n--, p++, q++;
  if(n == 0)
80105679:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
8010567d:	75 07                	jne    80105686 <strncmp+0x3e>
    return 0;
8010567f:	b8 00 00 00 00       	mov    $0x0,%eax
80105684:	eb 16                	jmp    8010569c <strncmp+0x54>
  return (uchar)*p - (uchar)*q;
80105686:	8b 45 08             	mov    0x8(%ebp),%eax
80105689:	0f b6 00             	movzbl (%eax),%eax
8010568c:	0f b6 d0             	movzbl %al,%edx
8010568f:	8b 45 0c             	mov    0xc(%ebp),%eax
80105692:	0f b6 00             	movzbl (%eax),%eax
80105695:	0f b6 c0             	movzbl %al,%eax
80105698:	29 c2                	sub    %eax,%edx
8010569a:	89 d0                	mov    %edx,%eax
}
8010569c:	5d                   	pop    %ebp
8010569d:	c3                   	ret    
...
801056a7:	89 45 fc             	mov    %eax,-0x4(%ebp)
  while(n-- > 0 && (*s++ = *t++) != 0)
801056aa:	90                   	nop
801056ab:	8b 45 10             	mov    0x10(%ebp),%eax
801056ae:	8d 50 ff             	lea    -0x1(%eax),%edx
801056b1:	89 55 10             	mov    %edx,0x10(%ebp)
801056b4:	85 c0                	test   %eax,%eax
801056b6:	7e 1e                	jle    801056d6 <strncpy+0x38>
801056b8:	8b 45 08             	mov    0x8(%ebp),%eax
801056bb:	8d 50 01             	lea    0x1(%eax),%edx
801056be:	89 55 08             	mov    %edx,0x8(%ebp)
801056c1:	8b 55 0c             	mov    0xc(%ebp),%edx
801056c4:	8d 4a 01             	lea    0x1(%edx),%ecx
801056c7:	89 4d 0c             	mov    %ecx,0xc(%ebp)
801056ca:	0f b6 12             	movzbl (%edx),%edx
801056cd:	88 10                	mov    %dl,(%eax)
801056cf:	0f b6 00             	movzbl (%eax),%eax
801056d2:	84 c0                	test   %al,%al
801056d4:	75 d5                	jne    801056ab <strncpy+0xd>
    ;
  while(n-- > 0)
801056d6:	eb 0c                	jmp    801056e4 <strncpy+0x46>
    *s++ = 0;
801056d8:	8b 45 08             	mov    0x8(%ebp),%eax
801056db:	8d 50 01             	lea    0x1(%eax),%edx
801056de:	89 55 08             	mov    %edx,0x8(%ebp)
801056e1:	c6 00 00             	movb   $0x0,(%eax)
  char *os;
...
801056e7:	8d 50 ff             	lea    -0x1(%eax),%edx
801056ea:	89 55 10             	mov    %edx,0x10(%ebp)
801056ed:	85 c0                	test   %eax,%eax
801056ef:	7f e7                	jg     801056d8 <strncpy+0x3a>
    *s++ = 0;
  return os;
...
80105706:	7f 05                	jg     8010570d <safestrcpy+0x17>
    return os;
80105708:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010570b:	eb 31                	jmp    8010573e <safestrcpy+0x48>
  while(--n > 0 && (*s++ = *t++) != 0)
8010570d:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105711:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105715:	7e 1e                	jle    80105735 <safestrcpy+0x3f>
...
80105733:	75 d8                	jne    8010570d <safestrcpy+0x17>
    ;
  *s = 0;
...
8010574d:	eb 04                	jmp    80105753 <strlen+0x13>
...
80105760:	75 ed                	jne    8010574f <strlen+0xf>
    ;
  return n;
...
80105787:	3b 45 08             	cmp    0x8(%ebp),%eax
8010578a:	76 12                	jbe    8010579e <fetchint+0x22>
8010578c:	8b 45 08             	mov    0x8(%ebp),%eax
8010578f:	8d 50 04             	lea    0x4(%eax),%edx
80105792:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105798:	8b 00                	mov    (%eax),%eax
8010579a:	39 c2                	cmp    %eax,%edx
8010579c:	76 07                	jbe    801057a5 <fetchint+0x29>
    return -1;
8010579e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801057a3:	eb 0f                	jmp    801057b4 <fetchint+0x38>
  *ip = *(int*)(addr);
801057a5:	8b 45 08             	mov    0x8(%ebp),%eax
801057a8:	8b 10                	mov    (%eax),%edx
801057aa:	8b 45 0c             	mov    0xc(%ebp),%eax
801057ad:	89 10                	mov    %edx,(%eax)
  return 0;
...
801057b9:	83 ec 10             	sub    $0x10,%esp
  char *s, *ep;
...
801057c7:	77 07                	ja     801057d0 <fetchstr+0x1a>
    return -1;
801057c9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801057ce:	eb 46                	jmp    80105816 <fetchstr+0x60>
  *pp = (char*)addr;
801057d0:	8b 55 08             	mov    0x8(%ebp),%edx
801057d3:	8b 45 0c             	mov    0xc(%ebp),%eax
801057d6:	89 10                	mov    %edx,(%eax)
  ep = (char*)proc->sz;
801057d8:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801057de:	8b 00                	mov    (%eax),%eax
801057e0:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(s = *pp; s < ep; s++)
801057e3:	8b 45 0c             	mov    0xc(%ebp),%eax
801057e6:	8b 00                	mov    (%eax),%eax
801057e8:	89 45 fc             	mov    %eax,-0x4(%ebp)
801057eb:	eb 1c                	jmp    80105809 <fetchstr+0x53>
    if(*s == 0)
801057ed:	8b 45 fc             	mov    -0x4(%ebp),%eax
801057f0:	0f b6 00             	movzbl (%eax),%eax
801057f3:	84 c0                	test   %al,%al
801057f5:	75 0e                	jne    80105805 <fetchstr+0x4f>
      return s - *pp;
801057f7:	8b 55 fc             	mov    -0x4(%ebp),%edx
801057fa:	8b 45 0c             	mov    0xc(%ebp),%eax
801057fd:	8b 00                	mov    (%eax),%eax
801057ff:	29 c2                	sub    %eax,%edx
80105801:	89 d0                	mov    %edx,%eax
80105803:	eb 11                	jmp    80105816 <fetchstr+0x60>
  ...
  *pp = (char*)addr;
  ep = (char*)proc->sz;
  for(s = *pp; s < ep; s++)
80105805:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105809:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010580c:	3b 45 f8             	cmp    -0x8(%ebp),%eax
8010580f:	72 dc                	jb     801057ed <fetchstr+0x37>
    if(*s == 0)
      return s - *pp;
  return -1;
...
8010588c:	39 c2                	cmp    %eax,%edx
8010588e:	76 07                	jbe    80105897 <argptr+0x51>
    return -1;
80105890:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105895:	eb 0f                	jmp    801058a6 <argptr+0x60>
  *pp = (char*)i;
...
801058ab:	83 ec 18             	sub    $0x18,%esp
  int addr;
  if(argint(n, &addr) < 0)
801058ae:	8d 45 fc             	lea    -0x4(%ebp),%eax
801058b1:	89 44 24 04          	mov    %eax,0x4(%esp)
801058b5:	8b 45 08             	mov    0x8(%ebp),%eax
801058b8:	89 04 24             	mov    %eax,(%esp)
801058bb:	e8 58 ff ff ff       	call   80105818 <argint>
801058c0:	85 c0                	test   %eax,%eax
801058c2:	79 07                	jns    801058cb <argstr+0x23>
    return -1;
801058c4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801058c9:	eb 12                	jmp    801058dd <argstr+0x35>
  return fetchstr(addr, pp);
801058cb:	8b 45 fc             	mov    -0x4(%ebp),%eax
801058ce:	8b 55 0c             	mov    0xc(%ebp),%edx
801058d1:	89 54 24 04          	mov    %edx,0x4(%esp)
801058d5:	89 04 24             	mov    %eax,(%esp)
801058d8:	e8 d9 fe ff ff       	call   801057b6 <fetchstr>
}
801058dd:	c9                   	leave  
801058de:	c3                   	ret    
...
801058e3:	83 ec 24             	sub    $0x24,%esp
  int num;

  num = proc->tf->eax;
801058e6:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801058ec:	8b 40 18             	mov    0x18(%eax),%eax
801058ef:	8b 40 1c             	mov    0x1c(%eax),%eax
801058f2:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
801058f5:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801058f9:	7e 30                	jle    8010592b <syscall+0x4c>
801058fb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801058fe:	83 f8 1a             	cmp    $0x1a,%eax
80105901:	77 28                	ja     8010592b <syscall+0x4c>
80105903:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105906:	8b 04 85 40 c0 10 80 	mov    -0x7fef3fc0(,%eax,4),%eax
8010590d:	85 c0                	test   %eax,%eax
8010590f:	74 1a                	je     8010592b <syscall+0x4c>
    proc->tf->eax = syscalls[num]();
80105911:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105917:	8b 58 18             	mov    0x18(%eax),%ebx
8010591a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010591d:	8b 04 85 40 c0 10 80 	mov    -0x7fef3fc0(,%eax,4),%eax
80105924:	ff d0                	call   *%eax
80105926:	89 43 1c             	mov    %eax,0x1c(%ebx)
80105929:	eb 3d                	jmp    80105968 <syscall+0x89>
  } else {
    cprintf("%d %s: unknown sys call %d\n",
            proc->pid, proc->name, num);
8010592b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105931:	8d 48 70             	lea    0x70(%eax),%ecx
80105934:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    cprintf("%d %s: unknown sys call %d\n",
8010593a:	8b 40 10             	mov    0x10(%eax),%eax
8010593d:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105940:	89 54 24 0c          	mov    %edx,0xc(%esp)
80105944:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105948:	89 44 24 04          	mov    %eax,0x4(%esp)
8010594c:	c7 04 24 13 91 10 80 	movl   $0x80109113,(%esp)
80105953:	e8 48 aa ff ff       	call   801003a0 <cprintf>
            proc->pid, proc->name, num);
    proc->tf->eax = -1;
80105958:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010595e:	8b 40 18             	mov    0x18(%eax),%eax
80105961:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  }
}
80105968:	83 c4 24             	add    $0x24,%esp
8010596b:	5b                   	pop    %ebx
8010596c:	5d                   	pop    %ebp
8010596d:	c3                   	ret    
...
80105981:	e8 92 fe ff ff       	call   80105818 <argint>
80105986:	85 c0                	test   %eax,%eax
80105988:	79 07                	jns    80105991 <argfd+0x23>
    return -1;
8010598a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010598f:	eb 50                	jmp    801059e1 <argfd+0x73>
  if(fd < 0 || fd >= NOFILE || (f=proc->ofile[fd]) == 0)
80105991:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105994:	85 c0                	test   %eax,%eax
80105996:	78 21                	js     801059b9 <argfd+0x4b>
80105998:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010599b:	83 f8 0f             	cmp    $0xf,%eax
8010599e:	7f 19                	jg     801059b9 <argfd+0x4b>
801059a0:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801059a6:	8b 55 f0             	mov    -0x10(%ebp),%edx
801059a9:	83 c2 08             	add    $0x8,%edx
801059ac:	8b 44 90 0c          	mov    0xc(%eax,%edx,4),%eax
801059b0:	89 45 f4             	mov    %eax,-0xc(%ebp)
801059b3:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801059b7:	75 07                	jne    801059c0 <argfd+0x52>
    return -1;
801059b9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801059be:	eb 21                	jmp    801059e1 <argfd+0x73>
  if(pfd)
801059c0:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
801059c4:	74 08                	je     801059ce <argfd+0x60>
    *pfd = fd;
801059c6:	8b 55 f0             	mov    -0x10(%ebp),%edx
801059c9:	8b 45 0c             	mov    0xc(%ebp),%eax
801059cc:	89 10                	mov    %edx,(%eax)
  if(pf)
801059ce:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801059d2:	74 08                	je     801059dc <argfd+0x6e>
    *pf = f;
801059d4:	8b 45 10             	mov    0x10(%ebp),%eax
801059d7:	8b 55 f4             	mov    -0xc(%ebp),%edx
801059da:	89 10                	mov    %edx,(%eax)
  return 0;
...
801059e6:	83 ec 10             	sub    $0x10,%esp
  ...
  for(fd = 0; fd < NOFILE; fd++){
801059e9:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
801059f0:	eb 30                	jmp    80105a22 <fdalloc+0x3f>
    if(proc->ofile[fd] == 0){
801059f2:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801059f8:	8b 55 fc             	mov    -0x4(%ebp),%edx
801059fb:	83 c2 08             	add    $0x8,%edx
801059fe:	8b 44 90 0c          	mov    0xc(%eax,%edx,4),%eax
80105a02:	85 c0                	test   %eax,%eax
80105a04:	75 18                	jne    80105a1e <fdalloc+0x3b>
      proc->ofile[fd] = f;
80105a06:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105a0c:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105a0f:	8d 4a 08             	lea    0x8(%edx),%ecx
80105a12:	8b 55 08             	mov    0x8(%ebp),%edx
80105a15:	89 54 88 0c          	mov    %edx,0xc(%eax,%ecx,4)
      return fd;
80105a19:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105a1c:	eb 0f                	jmp    80105a2d <fdalloc+0x4a>
static int
fdalloc(struct file *f)
{
  int fd;
  ...
  for(fd = 0; fd < NOFILE; fd++){
80105a1e:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105a22:	83 7d fc 0f          	cmpl   $0xf,-0x4(%ebp)
80105a26:	7e ca                	jle    801059f2 <fdalloc+0xf>
    if(proc->ofile[fd] == 0){
      proc->ofile[fd] = f;
      return fd;
    }
...
80105aa2:	e8 c7 fe ff ff       	call   8010596e <argfd>
80105aa7:	85 c0                	test   %eax,%eax
80105aa9:	78 35                	js     80105ae0 <sys_read+0x5a>
80105aab:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105aae:	89 44 24 04          	mov    %eax,0x4(%esp)
80105ab2:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105ab9:	e8 5a fd ff ff       	call   80105818 <argint>
80105abe:	85 c0                	test   %eax,%eax
80105ac0:	78 1e                	js     80105ae0 <sys_read+0x5a>
80105ac2:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ac5:	89 44 24 08          	mov    %eax,0x8(%esp)
80105ac9:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105acc:	89 44 24 04          	mov    %eax,0x4(%esp)
80105ad0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105ad7:	e8 6a fd ff ff       	call   80105846 <argptr>
80105adc:	85 c0                	test   %eax,%eax
80105ade:	79 07                	jns    80105ae7 <sys_read+0x61>
    return -1;
80105ae0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ae5:	eb 19                	jmp    80105b00 <sys_read+0x7a>
  return fileread(f, p, n);
80105ae7:	8b 4d f0             	mov    -0x10(%ebp),%ecx
80105aea:	8b 55 ec             	mov    -0x14(%ebp),%edx
...
80105afb:	e8 f3 b5 ff ff       	call   801010f3 <fileread>
}
80105b00:	c9                   	leave  
80105b01:	c3                   	ret    
...
80105b05:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  int n;
  char *p;
...
80105b0b:	89 44 24 08          	mov    %eax,0x8(%esp)
80105b0f:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105b16:	00 
80105b17:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105b1e:	e8 4b fe ff ff       	call   8010596e <argfd>
80105b23:	85 c0                	test   %eax,%eax
80105b25:	78 35                	js     80105b5c <sys_write+0x5a>
80105b27:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105b2a:	89 44 24 04          	mov    %eax,0x4(%esp)
80105b2e:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105b35:	e8 de fc ff ff       	call   80105818 <argint>
80105b3a:	85 c0                	test   %eax,%eax
80105b3c:	78 1e                	js     80105b5c <sys_write+0x5a>
80105b3e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b41:	89 44 24 08          	mov    %eax,0x8(%esp)
80105b45:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105b48:	89 44 24 04          	mov    %eax,0x4(%esp)
80105b4c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105b53:	e8 ee fc ff ff       	call   80105846 <argptr>
80105b58:	85 c0                	test   %eax,%eax
80105b5a:	79 07                	jns    80105b63 <sys_write+0x61>
    return -1;
80105b5c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105b61:	eb 19                	jmp    80105b7c <sys_write+0x7a>
  return filewrite(f, p, n);
80105b63:	8b 4d f0             	mov    -0x10(%ebp),%ecx
80105b66:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105b69:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b6c:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105b70:	89 54 24 04          	mov    %edx,0x4(%esp)
80105b74:	89 04 24             	mov    %eax,(%esp)
80105b77:	e8 33 b6 ff ff       	call   801011af <filewrite>
}
80105b7c:	c9                   	leave  
80105b7d:	c3                   	ret    
...
80105b92:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105b99:	e8 d0 fd ff ff       	call   8010596e <argfd>
80105b9e:	85 c0                	test   %eax,%eax
80105ba0:	79 07                	jns    80105ba9 <sys_close+0x2b>
    return -1;
80105ba2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ba7:	eb 24                	jmp    80105bcd <sys_close+0x4f>
  proc->ofile[fd] = 0;
80105ba9:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105baf:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105bb2:	83 c2 08             	add    $0x8,%edx
80105bb5:	c7 44 90 0c 00 00 00 	movl   $0x0,0xc(%eax,%edx,4)
80105bbc:	00 
  fileclose(f);
80105bbd:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105bc0:	89 04 24             	mov    %eax,(%esp)
80105bc3:	e8 06 b4 ff ff       	call   80100fce <fileclose>
  return 0;
...
80105bdc:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105be3:	00 
80105be4:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105beb:	e8 7e fd ff ff       	call   8010596e <argfd>
80105bf0:	85 c0                	test   %eax,%eax
80105bf2:	78 1f                	js     80105c13 <sys_fstat+0x44>
80105bf4:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
80105bfb:	00 
80105bfc:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105bff:	89 44 24 04          	mov    %eax,0x4(%esp)
80105c03:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105c0a:	e8 37 fc ff ff       	call   80105846 <argptr>
80105c0f:	85 c0                	test   %eax,%eax
80105c11:	79 07                	jns    80105c1a <sys_fstat+0x4b>
    return -1;
80105c13:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105c18:	eb 12                	jmp    80105c2c <sys_fstat+0x5d>
  return filestat(f, st);
80105c1a:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105c1d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c20:	89 54 24 04          	mov    %edx,0x4(%esp)
80105c24:	89 04 24             	mov    %eax,(%esp)
80105c27:	e8 78 b4 ff ff       	call   801010a4 <filestat>
}
80105c2c:	c9                   	leave  
80105c2d:	c3                   	ret    
...
80105c31:	83 ec 38             	sub    $0x38,%esp
  char name[DIRSIZ], *new, *old;
  struct inode *dp, *ip;

  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
80105c34:	8d 45 d8             	lea    -0x28(%ebp),%eax
80105c37:	89 44 24 04          	mov    %eax,0x4(%esp)
80105c3b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105c42:	e8 61 fc ff ff       	call   801058a8 <argstr>
80105c47:	85 c0                	test   %eax,%eax
80105c49:	78 17                	js     80105c62 <sys_link+0x34>
80105c4b:	8d 45 dc             	lea    -0x24(%ebp),%eax
80105c4e:	89 44 24 04          	mov    %eax,0x4(%esp)
80105c52:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105c59:	e8 4a fc ff ff       	call   801058a8 <argstr>
80105c5e:	85 c0                	test   %eax,%eax
80105c60:	79 0a                	jns    80105c6c <sys_link+0x3e>
    return -1;
80105c62:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105c67:	e9 42 01 00 00       	jmp    80105dae <sys_link+0x180>

  begin_op();
80105c6c:	e8 9f d7 ff ff       	call   80103410 <begin_op>
  if((ip = namei(old)) == 0){
80105c71:	8b 45 d8             	mov    -0x28(%ebp),%eax
80105c74:	89 04 24             	mov    %eax,(%esp)
80105c77:	e8 8a c7 ff ff       	call   80102406 <namei>
80105c7c:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105c7f:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105c83:	75 0f                	jne    80105c94 <sys_link+0x66>
    end_op();
80105c85:	e8 0a d8 ff ff       	call   80103494 <end_op>
    return -1;
80105c8a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105c8f:	e9 1a 01 00 00       	jmp    80105dae <sys_link+0x180>
  }
...
80105caa:	75 1a                	jne    80105cc6 <sys_link+0x98>
    iunlockput(ip);
80105cac:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105caf:	89 04 24             	mov    %eax,(%esp)
80105cb2:	e8 28 be ff ff       	call   80101adf <iunlockput>
    end_op();
80105cb7:	e8 d8 d7 ff ff       	call   80103494 <end_op>
    return -1;
80105cbc:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105cc1:	e9 e8 00 00 00       	jmp    80105dae <sys_link+0x180>
  }

  ip->nlink++;
80105cc6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105cc9:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105ccd:	8d 50 01             	lea    0x1(%eax),%edx
80105cd0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105cd3:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
80105cd7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105cda:	89 04 24             	mov    %eax,(%esp)
80105cdd:	e8 bd b9 ff ff       	call   8010169f <iupdate>
  iunlock(ip);
80105ce2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ce5:	89 04 24             	mov    %eax,(%esp)
80105ce8:	e8 bc bc ff ff       	call   801019a9 <iunlock>

  if((dp = nameiparent(new, name)) == 0)
80105ced:	8b 45 dc             	mov    -0x24(%ebp),%eax
80105cf0:	8d 55 e2             	lea    -0x1e(%ebp),%edx
80105cf3:	89 54 24 04          	mov    %edx,0x4(%esp)
80105cf7:	89 04 24             	mov    %eax,(%esp)
80105cfa:	e8 29 c7 ff ff       	call   80102428 <nameiparent>
80105cff:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105d02:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105d06:	75 02                	jne    80105d0a <sys_link+0xdc>
    goto bad;
80105d08:	eb 68                	jmp    80105d72 <sys_link+0x144>
  ilock(dp);
80105d0a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d0d:	89 04 24             	mov    %eax,(%esp)
80105d10:	e8 46 bb ff ff       	call   8010185b <ilock>
...
80105d21:	75 20                	jne    80105d43 <sys_link+0x115>
...
80105d3a:	e8 07 c4 ff ff       	call   80102146 <dirlink>
80105d3f:	85 c0                	test   %eax,%eax
80105d41:	79 0d                	jns    80105d50 <sys_link+0x122>
    iunlockput(dp);
80105d43:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d46:	89 04 24             	mov    %eax,(%esp)
80105d49:	e8 91 bd ff ff       	call   80101adf <iunlockput>
    goto bad;
80105d4e:	eb 22                	jmp    80105d72 <sys_link+0x144>
  }
  iunlockput(dp);
...
80105d61:	e8 a8 bc ff ff       	call   80101a0e <iput>

  end_op();
80105d66:	e8 29 d7 ff ff       	call   80103494 <end_op>

  return 0;
80105d6b:	b8 00 00 00 00       	mov    $0x0,%eax
80105d70:	eb 3c                	jmp    80105dae <sys_link+0x180>

bad:
  ilock(ip);
80105d72:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d75:	89 04 24             	mov    %eax,(%esp)
80105d78:	e8 de ba ff ff       	call   8010185b <ilock>
  ip->nlink--;
80105d7d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d80:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105d84:	8d 50 ff             	lea    -0x1(%eax),%edx
...
80105d94:	e8 06 b9 ff ff       	call   8010169f <iupdate>
  iunlockput(ip);
80105d99:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d9c:	89 04 24             	mov    %eax,(%esp)
80105d9f:	e8 3b bd ff ff       	call   80101adf <iunlockput>
  end_op();
80105da4:	e8 eb d6 ff ff       	call   80103494 <end_op>
  return -1;
...
80105db6:	c7 45 f4 20 00 00 00 	movl   $0x20,-0xc(%ebp)
80105dbd:	eb 4b                	jmp    80105e0a <isdirempty+0x5a>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105dbf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105dc2:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105dc9:	00 
80105dca:	89 44 24 08          	mov    %eax,0x8(%esp)
80105dce:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105dd1:	89 44 24 04          	mov    %eax,0x4(%esp)
80105dd5:	8b 45 08             	mov    0x8(%ebp),%eax
80105dd8:	89 04 24             	mov    %eax,(%esp)
80105ddb:	e8 88 bf ff ff       	call   80101d68 <readi>
80105de0:	83 f8 10             	cmp    $0x10,%eax
80105de3:	74 0c                	je     80105df1 <isdirempty+0x41>
      panic("isdirempty: readi");
80105de5:	c7 04 24 2f 91 10 80 	movl   $0x8010912f,(%esp)
80105dec:	e8 49 a7 ff ff       	call   8010053a <panic>
    if(de.inum != 0)
80105df1:	0f b7 45 e4          	movzwl -0x1c(%ebp),%eax
80105df5:	66 85 c0             	test   %ax,%ax
80105df8:	74 07                	je     80105e01 <isdirempty+0x51>
      return 0;
80105dfa:	b8 00 00 00 00       	mov    $0x0,%eax
80105dff:	eb 1b                	jmp    80105e1c <isdirempty+0x6c>
isdirempty(struct inode *dp)
{
  int off;
  struct dirent de;
...
80105e04:	83 c0 10             	add    $0x10,%eax
80105e07:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105e0a:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105e0d:	8b 45 08             	mov    0x8(%ebp),%eax
80105e10:	8b 40 18             	mov    0x18(%eax),%eax
80105e13:	39 c2                	cmp    %eax,%edx
80105e15:	72 a8                	jb     80105dbf <isdirempty+0xf>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
    if(de.inum != 0)
      return 0;
...
80105e21:	83 ec 48             	sub    $0x48,%esp
  struct inode *ip, *dp;
  struct dirent de;
  ...
  if(argstr(0, &path) < 0)
80105e24:	8d 45 cc             	lea    -0x34(%ebp),%eax
80105e27:	89 44 24 04          	mov    %eax,0x4(%esp)
80105e2b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105e32:	e8 71 fa ff ff       	call   801058a8 <argstr>
80105e37:	85 c0                	test   %eax,%eax
80105e39:	79 0a                	jns    80105e45 <sys_unlink+0x27>
    return -1;
80105e3b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e40:	e9 af 01 00 00       	jmp    80105ff4 <sys_unlink+0x1d6>

  begin_op();
80105e45:	e8 c6 d5 ff ff       	call   80103410 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80105e4a:	8b 45 cc             	mov    -0x34(%ebp),%eax
80105e4d:	8d 55 d2             	lea    -0x2e(%ebp),%edx
80105e50:	89 54 24 04          	mov    %edx,0x4(%esp)
80105e54:	89 04 24             	mov    %eax,(%esp)
80105e57:	e8 cc c5 ff ff       	call   80102428 <nameiparent>
80105e5c:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105e5f:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105e63:	75 0f                	jne    80105e74 <sys_unlink+0x56>
    end_op();
80105e65:	e8 2a d6 ff ff       	call   80103494 <end_op>
    return -1;
80105e6a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e6f:	e9 80 01 00 00       	jmp    80105ff4 <sys_unlink+0x1d6>
  }

  ilock(dp);
80105e74:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e77:	89 04 24             	mov    %eax,(%esp)
80105e7a:	e8 dc b9 ff ff       	call   8010185b <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80105e7f:	c7 44 24 04 41 91 10 	movl   $0x80109141,0x4(%esp)
80105e86:	80 
80105e87:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105e8a:	89 04 24             	mov    %eax,(%esp)
80105e8d:	e8 c9 c1 ff ff       	call   8010205b <namecmp>
80105e92:	85 c0                	test   %eax,%eax
80105e94:	0f 84 45 01 00 00    	je     80105fdf <sys_unlink+0x1c1>
80105e9a:	c7 44 24 04 43 91 10 	movl   $0x80109143,0x4(%esp)
80105ea1:	80 
80105ea2:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105ea5:	89 04 24             	mov    %eax,(%esp)
80105ea8:	e8 ae c1 ff ff       	call   8010205b <namecmp>
80105ead:	85 c0                	test   %eax,%eax
80105eaf:	0f 84 2a 01 00 00    	je     80105fdf <sys_unlink+0x1c1>
    goto bad;

  if((ip = dirlookup(dp, name, &off)) == 0)
80105eb5:	8d 45 c8             	lea    -0x38(%ebp),%eax
...
80105ec9:	e8 af c1 ff ff       	call   8010207d <dirlookup>
80105ece:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105ed1:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105ed5:	75 05                	jne    80105edc <sys_unlink+0xbe>
    goto bad;
80105ed7:	e9 03 01 00 00       	jmp    80105fdf <sys_unlink+0x1c1>
  ilock(ip);
80105edc:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105edf:	89 04 24             	mov    %eax,(%esp)
80105ee2:	e8 74 b9 ff ff       	call   8010185b <ilock>

  if(ip->nlink < 1)
80105ee7:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105eea:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105eee:	66 85 c0             	test   %ax,%ax
80105ef1:	7f 0c                	jg     80105eff <sys_unlink+0xe1>
    panic("unlink: nlink < 1");
80105ef3:	c7 04 24 46 91 10 80 	movl   $0x80109146,(%esp)
...
80105f0a:	75 1f                	jne    80105f2b <sys_unlink+0x10d>
80105f0c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f0f:	89 04 24             	mov    %eax,(%esp)
80105f12:	e8 99 fe ff ff       	call   80105db0 <isdirempty>
80105f17:	85 c0                	test   %eax,%eax
80105f19:	75 10                	jne    80105f2b <sys_unlink+0x10d>
    iunlockput(ip);
80105f1b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f1e:	89 04 24             	mov    %eax,(%esp)
80105f21:	e8 b9 bb ff ff       	call   80101adf <iunlockput>
    goto bad;
80105f26:	e9 b4 00 00 00       	jmp    80105fdf <sys_unlink+0x1c1>
  }

  memset(&de, 0, sizeof(de));
80105f2b:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80105f32:	00 
80105f33:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105f3a:	00 
80105f3b:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105f3e:	89 04 24             	mov    %eax,(%esp)
80105f41:	e8 90 f5 ff ff       	call   801054d6 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105f46:	8b 45 c8             	mov    -0x38(%ebp),%eax
80105f49:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105f50:	00 
...
80105f62:	e8 65 bf ff ff       	call   80101ecc <writei>
80105f67:	83 f8 10             	cmp    $0x10,%eax
80105f6a:	74 0c                	je     80105f78 <sys_unlink+0x15a>
    panic("unlink: writei");
80105f6c:	c7 04 24 58 91 10 80 	movl   $0x80109158,(%esp)
80105f73:	e8 c2 a5 ff ff       	call   8010053a <panic>
  if(ip->type == T_DIR){
80105f78:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f7b:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105f7f:	66 83 f8 01          	cmp    $0x1,%ax
80105f83:	75 1c                	jne    80105fa1 <sys_unlink+0x183>
    dp->nlink--;
80105f85:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f88:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105f8c:	8d 50 ff             	lea    -0x1(%eax),%edx
80105f8f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f92:	66 89 50 16          	mov    %dx,0x16(%eax)
    iupdate(dp);
80105f96:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f99:	89 04 24             	mov    %eax,(%esp)
80105f9c:	e8 fe b6 ff ff       	call   8010169f <iupdate>
  }
  iunlockput(dp);
80105fa1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105fa4:	89 04 24             	mov    %eax,(%esp)
80105fa7:	e8 33 bb ff ff       	call   80101adf <iunlockput>

  ip->nlink--;
80105fac:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105faf:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105fb3:	8d 50 ff             	lea    -0x1(%eax),%edx
80105fb6:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105fb9:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
80105fbd:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105fc0:	89 04 24             	mov    %eax,(%esp)
80105fc3:	e8 d7 b6 ff ff       	call   8010169f <iupdate>
  iunlockput(ip);
80105fc8:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105fcb:	89 04 24             	mov    %eax,(%esp)
80105fce:	e8 0c bb ff ff       	call   80101adf <iunlockput>

  end_op();
80105fd3:	e8 bc d4 ff ff       	call   80103494 <end_op>

  return 0;
80105fd8:	b8 00 00 00 00       	mov    $0x0,%eax
80105fdd:	eb 15                	jmp    80105ff4 <sys_unlink+0x1d6>

bad:
  iunlockput(dp);
80105fdf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105fe2:	89 04 24             	mov    %eax,(%esp)
80105fe5:	e8 f5 ba ff ff       	call   80101adf <iunlockput>
  end_op();
80105fea:	e8 a5 d4 ff ff       	call   80103494 <end_op>
  return -1;
...
80105ff9:	83 ec 48             	sub    $0x48,%esp
80105ffc:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80105fff:	8b 55 10             	mov    0x10(%ebp),%edx
80106002:	8b 45 14             	mov    0x14(%ebp),%eax
80106005:	66 89 4d d4          	mov    %cx,-0x2c(%ebp)
80106009:	66 89 55 d0          	mov    %dx,-0x30(%ebp)
8010600d:	66 89 45 cc          	mov    %ax,-0x34(%ebp)
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];
...
8010601e:	e8 05 c4 ff ff       	call   80102428 <nameiparent>
80106023:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106026:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010602a:	75 0a                	jne    80106036 <create+0x40>
    return 0;
8010602c:	b8 00 00 00 00       	mov    $0x0,%eax
80106031:	e9 7e 01 00 00       	jmp    801061b4 <create+0x1be>
  ilock(dp);
80106036:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106039:	89 04 24             	mov    %eax,(%esp)
8010603c:	e8 1a b8 ff ff       	call   8010185b <ilock>

  if((ip = dirlookup(dp, name, &off)) != 0){
80106041:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106044:	89 44 24 08          	mov    %eax,0x8(%esp)
80106048:	8d 45 de             	lea    -0x22(%ebp),%eax
8010604b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010604f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106052:	89 04 24             	mov    %eax,(%esp)
80106055:	e8 23 c0 ff ff       	call   8010207d <dirlookup>
8010605a:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010605d:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106061:	74 47                	je     801060aa <create+0xb4>
    iunlockput(dp);
...
80106074:	e8 e2 b7 ff ff       	call   8010185b <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80106079:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
8010607e:	75 15                	jne    80106095 <create+0x9f>
80106080:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106083:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80106087:	66 83 f8 02          	cmp    $0x2,%ax
8010608b:	75 08                	jne    80106095 <create+0x9f>
      return ip;
8010608d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106090:	e9 1f 01 00 00       	jmp    801061b4 <create+0x1be>
    iunlockput(ip);
80106095:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106098:	89 04 24             	mov    %eax,(%esp)
8010609b:	e8 3f ba ff ff       	call   80101adf <iunlockput>
    return 0;
801060a0:	b8 00 00 00 00       	mov    $0x0,%eax
801060a5:	e9 0a 01 00 00       	jmp    801061b4 <create+0x1be>
  }

  if((ip = ialloc(dp->dev, type)) == 0)
801060aa:	0f bf 55 d4          	movswl -0x2c(%ebp),%edx
801060ae:	8b 45 f4             	mov    -0xc(%ebp),%eax
801060b1:	8b 00                	mov    (%eax),%eax
801060b3:	89 54 24 04          	mov    %edx,0x4(%esp)
801060b7:	89 04 24             	mov    %eax,(%esp)
801060ba:	e8 01 b5 ff ff       	call   801015c0 <ialloc>
801060bf:	89 45 f0             	mov    %eax,-0x10(%ebp)
801060c2:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801060c6:	75 0c                	jne    801060d4 <create+0xde>
    panic("create: ialloc");
801060c8:	c7 04 24 67 91 10 80 	movl   $0x80109167,(%esp)
801060cf:	e8 66 a4 ff ff       	call   8010053a <panic>

  ilock(ip);
801060d4:	8b 45 f0             	mov    -0x10(%ebp),%eax
801060d7:	89 04 24             	mov    %eax,(%esp)
801060da:	e8 7c b7 ff ff       	call   8010185b <ilock>
  ip->major = major;
...
80106104:	e8 96 b5 ff ff       	call   8010169f <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
80106109:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
8010610e:	75 6a                	jne    8010617a <create+0x184>
    dp->nlink++;  // for ".."
80106110:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106113:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80106117:	8d 50 01             	lea    0x1(%eax),%edx
8010611a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010611d:	66 89 50 16          	mov    %dx,0x16(%eax)
    iupdate(dp);
80106121:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106124:	89 04 24             	mov    %eax,(%esp)
80106127:	e8 73 b5 ff ff       	call   8010169f <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
8010612c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010612f:	8b 40 04             	mov    0x4(%eax),%eax
80106132:	89 44 24 08          	mov    %eax,0x8(%esp)
80106136:	c7 44 24 04 41 91 10 	movl   $0x80109141,0x4(%esp)
8010613d:	80 
8010613e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106141:	89 04 24             	mov    %eax,(%esp)
80106144:	e8 fd bf ff ff       	call   80102146 <dirlink>
80106149:	85 c0                	test   %eax,%eax
8010614b:	78 21                	js     8010616e <create+0x178>
8010614d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106150:	8b 40 04             	mov    0x4(%eax),%eax
80106153:	89 44 24 08          	mov    %eax,0x8(%esp)
80106157:	c7 44 24 04 43 91 10 	movl   $0x80109143,0x4(%esp)
8010615e:	80 
8010615f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106162:	89 04 24             	mov    %eax,(%esp)
80106165:	e8 dc bf ff ff       	call   80102146 <dirlink>
8010616a:	85 c0                	test   %eax,%eax
8010616c:	79 0c                	jns    8010617a <create+0x184>
      panic("create dots");
8010616e:	c7 04 24 76 91 10 80 	movl   $0x80109176,(%esp)
80106175:	e8 c0 a3 ff ff       	call   8010053a <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
8010617a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010617d:	8b 40 04             	mov    0x4(%eax),%eax
80106180:	89 44 24 08          	mov    %eax,0x8(%esp)
80106184:	8d 45 de             	lea    -0x22(%ebp),%eax
80106187:	89 44 24 04          	mov    %eax,0x4(%esp)
8010618b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010618e:	89 04 24             	mov    %eax,(%esp)
80106191:	e8 b0 bf ff ff       	call   80102146 <dirlink>
80106196:	85 c0                	test   %eax,%eax
80106198:	79 0c                	jns    801061a6 <create+0x1b0>
    panic("create: dirlink");
8010619a:	c7 04 24 82 91 10 80 	movl   $0x80109182,(%esp)
801061a1:	e8 94 a3 ff ff       	call   8010053a <panic>

  iunlockput(dp);
801061a6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801061a9:	89 04 24             	mov    %eax,(%esp)
801061ac:	e8 2e b9 ff ff       	call   80101adf <iunlockput>
...
801061ca:	e8 d9 f6 ff ff       	call   801058a8 <argstr>
...
80106223:	e8 ce fd ff ff       	call   80105ff6 <create>
80106228:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(ip == 0){
8010622b:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010622f:	75 6b                	jne    8010629c <sys_open+0xe6>
      end_op();
80106231:	e8 5e d2 ff ff       	call   80103494 <end_op>
      return -1;
80106236:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010623b:	e9 10 01 00 00       	jmp    80106350 <sys_open+0x19a>
    }
  } else {
    if((ip = namei(path)) == 0){
80106240:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106243:	89 04 24             	mov    %eax,(%esp)
80106246:	e8 bb c1 ff ff       	call   80102406 <namei>
8010624b:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010624e:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106252:	75 0f                	jne    80106263 <sys_open+0xad>
      end_op();
80106254:	e8 3b d2 ff ff       	call   80103494 <end_op>
      return -1;
80106259:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010625e:	e9 ed 00 00 00       	jmp    80106350 <sys_open+0x19a>
    }
    ilock(ip);
80106263:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106266:	89 04 24             	mov    %eax,(%esp)
80106269:	e8 ed b5 ff ff       	call   8010185b <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
8010626e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106271:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80106275:	66 83 f8 01          	cmp    $0x1,%ax
80106279:	75 21                	jne    8010629c <sys_open+0xe6>
8010627b:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010627e:	85 c0                	test   %eax,%eax
80106280:	74 1a                	je     8010629c <sys_open+0xe6>
      iunlockput(ip);
80106282:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106285:	89 04 24             	mov    %eax,(%esp)
80106288:	e8 52 b8 ff ff       	call   80101adf <iunlockput>
      end_op();
8010628d:	e8 02 d2 ff ff       	call   80103494 <end_op>
      return -1;
80106292:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106297:	e9 b4 00 00 00       	jmp    80106350 <sys_open+0x19a>
    }
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
8010629c:	e8 85 ac ff ff       	call   80100f26 <filealloc>
801062a1:	89 45 f0             	mov    %eax,-0x10(%ebp)
801062a4:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801062a8:	74 14                	je     801062be <sys_open+0x108>
801062aa:	8b 45 f0             	mov    -0x10(%ebp),%eax
801062ad:	89 04 24             	mov    %eax,(%esp)
801062b0:	e8 2e f7 ff ff       	call   801059e3 <fdalloc>
801062b5:	89 45 ec             	mov    %eax,-0x14(%ebp)
801062b8:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
801062bc:	79 28                	jns    801062e6 <sys_open+0x130>
    if(f)
801062be:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801062c2:	74 0b                	je     801062cf <sys_open+0x119>
      fileclose(f);
801062c4:	8b 45 f0             	mov    -0x10(%ebp),%eax
801062c7:	89 04 24             	mov    %eax,(%esp)
801062ca:	e8 ff ac ff ff       	call   80100fce <fileclose>
    iunlockput(ip);
801062cf:	8b 45 f4             	mov    -0xc(%ebp),%eax
801062d2:	89 04 24             	mov    %eax,(%esp)
801062d5:	e8 05 b8 ff ff       	call   80101adf <iunlockput>
    end_op();
801062da:	e8 b5 d1 ff ff       	call   80103494 <end_op>
    return -1;
801062df:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801062e4:	eb 6a                	jmp    80106350 <sys_open+0x19a>
  }
  iunlock(ip);
801062e6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801062e9:	89 04 24             	mov    %eax,(%esp)
801062ec:	e8 b8 b6 ff ff       	call   801019a9 <iunlock>
  end_op();
801062f1:	e8 9e d1 ff ff       	call   80103494 <end_op>

  f->type = FD_INODE;
801062f6:	8b 45 f0             	mov    -0x10(%ebp),%eax
801062f9:	c7 00 02 00 00 00    	movl   $0x2,(%eax)
  f->ip = ip;
801062ff:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106302:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106305:	89 50 10             	mov    %edx,0x10(%eax)
  f->off = 0;
80106308:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010630b:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
  f->readable = !(omode & O_WRONLY);
80106312:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106315:	83 e0 01             	and    $0x1,%eax
80106318:	85 c0                	test   %eax,%eax
8010631a:	0f 94 c0             	sete   %al
8010631d:	89 c2                	mov    %eax,%edx
8010631f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106322:	88 50 08             	mov    %dl,0x8(%eax)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80106325:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106328:	83 e0 01             	and    $0x1,%eax
8010632b:	85 c0                	test   %eax,%eax
8010632d:	75 0a                	jne    80106339 <sys_open+0x183>
8010632f:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106332:	83 e0 02             	and    $0x2,%eax
80106335:	85 c0                	test   %eax,%eax
80106337:	74 07                	je     80106340 <sys_open+0x18a>
80106339:	b8 01 00 00 00       	mov    $0x1,%eax
8010633e:	eb 05                	jmp    80106345 <sys_open+0x18f>
80106340:	b8 00 00 00 00       	mov    $0x0,%eax
80106345:	89 c2                	mov    %eax,%edx
80106347:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010634a:	88 50 09             	mov    %dl,0x9(%eax)
  return fd;
8010634d:	8b 45 ec             	mov    -0x14(%ebp),%eax
}
80106350:	c9                   	leave  
80106351:	c3                   	ret    
...
80106355:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
80106358:	e8 b3 d0 ff ff       	call   80103410 <begin_op>
  if(argstr(0, &path) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
8010635d:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106360:	89 44 24 04          	mov    %eax,0x4(%esp)
80106364:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010636b:	e8 38 f5 ff ff       	call   801058a8 <argstr>
80106370:	85 c0                	test   %eax,%eax
80106372:	78 2c                	js     801063a0 <sys_mkdir+0x4e>
80106374:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106377:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
8010637e:	00 
8010637f:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80106386:	00 
80106387:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
8010638e:	00 
8010638f:	89 04 24             	mov    %eax,(%esp)
80106392:	e8 5f fc ff ff       	call   80105ff6 <create>
80106397:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010639a:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010639e:	75 0c                	jne    801063ac <sys_mkdir+0x5a>
    end_op();
801063a0:	e8 ef d0 ff ff       	call   80103494 <end_op>
    return -1;
801063a5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801063aa:	eb 15                	jmp    801063c1 <sys_mkdir+0x6f>
  }
  iunlockput(ip);
801063ac:	8b 45 f4             	mov    -0xc(%ebp),%eax
801063af:	89 04 24             	mov    %eax,(%esp)
801063b2:	e8 28 b7 ff ff       	call   80101adf <iunlockput>
  end_op();
801063b7:	e8 d8 d0 ff ff       	call   80103494 <end_op>
  return 0;
...
801063c6:	83 ec 38             	sub    $0x38,%esp
  struct inode *ip;
  char *path;
  int len;
  int major, minor;
...
801063ff:	78 47                	js     80106448 <sys_mknod+0x85>
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
80106401:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80106404:	89 44 24 04          	mov    %eax,0x4(%esp)
80106408:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
8010640f:	e8 04 f4 ff ff       	call   80105818 <argint>
  int len;
  int major, minor;
...
80106416:	78 30                	js     80106448 <sys_mknod+0x85>
     argint(2, &minor) < 0 ||
     (ip = create(path, T_DEV, major, minor)) == 0){
80106418:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010641b:	0f bf c8             	movswl %ax,%ecx
8010641e:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106421:	0f bf d0             	movswl %ax,%edx
80106424:	8b 45 ec             	mov    -0x14(%ebp),%eax
  ...
  if((len=argstr(0, &path)) < 0 ||
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
80106427:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
8010642b:	89 54 24 08          	mov    %edx,0x8(%esp)
8010642f:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80106436:	00 
80106437:	89 04 24             	mov    %eax,(%esp)
8010643a:	e8 b7 fb ff ff       	call   80105ff6 <create>
8010643f:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106442:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106446:	75 0c                	jne    80106454 <sys_mknod+0x91>
     (ip = create(path, T_DEV, major, minor)) == 0){
    end_op();
80106448:	e8 47 d0 ff ff       	call   80103494 <end_op>
    return -1;
8010644d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106452:	eb 15                	jmp    80106469 <sys_mknod+0xa6>
  }
  iunlockput(ip);
80106454:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106457:	89 04 24             	mov    %eax,(%esp)
8010645a:	e8 80 b6 ff ff       	call   80101adf <iunlockput>
  end_op();
8010645f:	e8 30 d0 ff ff       	call   80103494 <end_op>
  return 0;
80106464:	b8 00 00 00 00       	mov    $0x0,%eax
}
80106469:	c9                   	leave  
8010646a:	c3                   	ret    
...
80106513:	81 ec a8 00 00 00    	sub    $0xa8,%esp
...
80106527:	e8 7c f3 ff ff       	call   801058a8 <argstr>
8010652c:	85 c0                	test   %eax,%eax
8010652e:	78 1a                	js     8010654a <sys_exec+0x3a>
80106530:	8d 85 6c ff ff ff    	lea    -0x94(%ebp),%eax
80106536:	89 44 24 04          	mov    %eax,0x4(%esp)
8010653a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106541:	e8 d2 f2 ff ff       	call   80105818 <argint>
80106546:	85 c0                	test   %eax,%eax
80106548:	79 0a                	jns    80106554 <sys_exec+0x44>
    return -1;
8010654a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010654f:	e9 c8 00 00 00       	jmp    8010661c <sys_exec+0x10c>
  }
  memset(argv, 0, sizeof(argv));
80106554:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
8010655b:	00 
8010655c:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106563:	00 
80106564:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
8010656a:	89 04 24             	mov    %eax,(%esp)
8010656d:	e8 64 ef ff ff       	call   801054d6 <memset>
  for(i=0;; i++){
80106572:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(i >= NELEM(argv))
80106579:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010657c:	83 f8 1f             	cmp    $0x1f,%eax
8010657f:	76 0a                	jbe    8010658b <sys_exec+0x7b>
      return -1;
80106581:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106586:	e9 91 00 00 00       	jmp    8010661c <sys_exec+0x10c>
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
8010658b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010658e:	c1 e0 02             	shl    $0x2,%eax
80106591:	89 c2                	mov    %eax,%edx
80106593:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
80106599:	01 c2                	add    %eax,%edx
8010659b:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
801065a1:	89 44 24 04          	mov    %eax,0x4(%esp)
801065a5:	89 14 24             	mov    %edx,(%esp)
801065a8:	e8 cf f1 ff ff       	call   8010577c <fetchint>
801065ad:	85 c0                	test   %eax,%eax
801065af:	79 07                	jns    801065b8 <sys_exec+0xa8>
      return -1;
801065b1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801065b6:	eb 64                	jmp    8010661c <sys_exec+0x10c>
    if(uarg == 0){
801065b8:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
801065be:	85 c0                	test   %eax,%eax
801065c0:	75 26                	jne    801065e8 <sys_exec+0xd8>
      argv[i] = 0;
801065c2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065c5:	c7 84 85 70 ff ff ff 	movl   $0x0,-0x90(%ebp,%eax,4)
801065cc:	00 00 00 00 
      break;
801065d0:	90                   	nop
    }
...
801065d4:	8d 95 70 ff ff ff    	lea    -0x90(%ebp),%edx
801065da:	89 54 24 04          	mov    %edx,0x4(%esp)
801065de:	89 04 24             	mov    %eax,(%esp)
801065e1:	e8 09 a5 ff ff       	call   80100aef <exec>
801065e6:	eb 34                	jmp    8010661c <sys_exec+0x10c>
      return -1;
    if(uarg == 0){
      argv[i] = 0;
      break;
    ...
    if(fetchstr(uarg, &argv[i]) < 0)
801065e8:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
801065ee:	8b 55 f4             	mov    -0xc(%ebp),%edx
801065f1:	c1 e2 02             	shl    $0x2,%edx
801065f4:	01 c2                	add    %eax,%edx
801065f6:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
801065fc:	89 54 24 04          	mov    %edx,0x4(%esp)
80106600:	89 04 24             	mov    %eax,(%esp)
80106603:	e8 ae f1 ff ff       	call   801057b6 <fetchstr>
80106608:	85 c0                	test   %eax,%eax
8010660a:	79 07                	jns    80106613 <sys_exec+0x103>
      return -1;
8010660c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106611:	eb 09                	jmp    8010661c <sys_exec+0x10c>
  ...
  memset(argv, 0, sizeof(argv));
  for(i=0;; i++){
80106613:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      argv[i] = 0;
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
...
80106617:	e9 5d ff ff ff       	jmp    80106579 <sys_exec+0x69>
  return exec(path, argv);
}
8010661c:	c9                   	leave  
8010661d:	c3                   	ret    
...
80106621:	83 ec 38             	sub    $0x38,%esp
  int *fd;
  struct file *rf, *wf;
  int fd0, fd1;

  if(argptr(0, (void*)&fd, 2*sizeof(fd[0])) < 0)
80106624:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
8010662b:	00 
8010662c:	8d 45 ec             	lea    -0x14(%ebp),%eax
8010662f:	89 44 24 04          	mov    %eax,0x4(%esp)
80106633:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010663a:	e8 07 f2 ff ff       	call   80105846 <argptr>
8010663f:	85 c0                	test   %eax,%eax
80106641:	79 0a                	jns    8010664d <sys_pipe+0x2f>
    return -1;
80106643:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106648:	e9 9b 00 00 00       	jmp    801066e8 <sys_pipe+0xca>
  if(pipealloc(&rf, &wf) < 0)
8010664d:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80106650:	89 44 24 04          	mov    %eax,0x4(%esp)
80106654:	8d 45 e8             	lea    -0x18(%ebp),%eax
80106657:	89 04 24             	mov    %eax,(%esp)
8010665a:	e8 c2 d8 ff ff       	call   80103f21 <pipealloc>
8010665f:	85 c0                	test   %eax,%eax
80106661:	79 07                	jns    8010666a <sys_pipe+0x4c>
    return -1;
80106663:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106668:	eb 7e                	jmp    801066e8 <sys_pipe+0xca>
  fd0 = -1;
8010666a:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80106671:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106674:	89 04 24             	mov    %eax,(%esp)
80106677:	e8 67 f3 ff ff       	call   801059e3 <fdalloc>
8010667c:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010667f:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106683:	78 14                	js     80106699 <sys_pipe+0x7b>
80106685:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106688:	89 04 24             	mov    %eax,(%esp)
8010668b:	e8 53 f3 ff ff       	call   801059e3 <fdalloc>
80106690:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106693:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106697:	79 37                	jns    801066d0 <sys_pipe+0xb2>
    if(fd0 >= 0)
80106699:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010669d:	78 14                	js     801066b3 <sys_pipe+0x95>
      proc->ofile[fd0] = 0;
8010669f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801066a5:	8b 55 f4             	mov    -0xc(%ebp),%edx
801066a8:	83 c2 08             	add    $0x8,%edx
801066ab:	c7 44 90 0c 00 00 00 	movl   $0x0,0xc(%eax,%edx,4)
801066b2:	00 
    fileclose(rf);
801066b3:	8b 45 e8             	mov    -0x18(%ebp),%eax
801066b6:	89 04 24             	mov    %eax,(%esp)
801066b9:	e8 10 a9 ff ff       	call   80100fce <fileclose>
    fileclose(wf);
801066be:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801066c1:	89 04 24             	mov    %eax,(%esp)
801066c4:	e8 05 a9 ff ff       	call   80100fce <fileclose>
    return -1;
801066c9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801066ce:	eb 18                	jmp    801066e8 <sys_pipe+0xca>
  }
  fd[0] = fd0;
...
801066ed:	83 ec 08             	sub    $0x8,%esp
  return fork();
801066f0:	e8 96 df ff ff       	call   8010468b <fork>
}
801066f5:	c9                   	leave  
801066f6:	c3                   	ret    
...
801066fa:	83 ec 08             	sub    $0x8,%esp
  exit();
801066fd:	e8 5f e1 ff ff       	call   80104861 <exit>
...
8010670c:	83 ec 08             	sub    $0x8,%esp
  return wait();
8010670f:	e8 b7 e2 ff ff       	call   801049cb <wait>
}
80106714:	c9                   	leave  
80106715:	c3                   	ret    
...
80106719:	83 ec 28             	sub    $0x28,%esp
  int pid;

  if(argint(0, &pid) < 0)
8010671c:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010671f:	89 44 24 04          	mov    %eax,0x4(%esp)
80106723:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010672a:	e8 e9 f0 ff ff       	call   80105818 <argint>
8010672f:	85 c0                	test   %eax,%eax
80106731:	79 07                	jns    8010673a <sys_kill+0x24>
    return -1;
80106733:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106738:	eb 0b                	jmp    80106745 <sys_kill+0x2f>
  return kill(pid);
8010673a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010673d:	89 04 24             	mov    %eax,(%esp)
80106740:	e8 98 e6 ff ff       	call   80104ddd <kill>
}
80106745:	c9                   	leave  
80106746:	c3                   	ret    
...
80106748:	89 e5                	mov    %esp,%ebp
  return proc->pid;
8010674a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106750:	8b 40 10             	mov    0x10(%eax),%eax
}
80106753:	5d                   	pop    %ebp
80106754:	c3                   	ret    
...
80106758:	83 ec 28             	sub    $0x28,%esp
  ...
  if(argint(0, &n) < 0)
8010675b:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010675e:	89 44 24 04          	mov    %eax,0x4(%esp)
80106762:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106769:	e8 aa f0 ff ff       	call   80105818 <argint>
8010676e:	85 c0                	test   %eax,%eax
80106770:	79 07                	jns    80106779 <sys_sbrk+0x24>
    return -1;
80106772:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106777:	eb 24                	jmp    8010679d <sys_sbrk+0x48>
  addr = proc->sz;
...
8010678a:	e8 57 de ff ff       	call   801045e6 <growproc>
8010678f:	85 c0                	test   %eax,%eax
80106791:	79 07                	jns    8010679a <sys_sbrk+0x45>
    return -1;
80106793:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106798:	eb 03                	jmp    8010679d <sys_sbrk+0x48>
  return addr;
...
801067b3:	e8 60 f0 ff ff       	call   80105818 <argint>
801067b8:	85 c0                	test   %eax,%eax
801067ba:	79 07                	jns    801067c3 <sys_sleep+0x24>
    return -1;
801067bc:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801067c1:	eb 6c                	jmp    8010682f <sys_sleep+0x90>
  acquire(&tickslock);
801067c3:	c7 04 24 c0 82 11 80 	movl   $0x801182c0,(%esp)
801067ca:	e8 b3 ea ff ff       	call   80105282 <acquire>
  ticks0 = ticks;
801067cf:	a1 00 8b 11 80       	mov    0x80118b00,%eax
801067d4:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(ticks - ticks0 < n){
801067d7:	eb 34                	jmp    8010680d <sys_sleep+0x6e>
    if(proc->killed){
801067d9:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801067df:	8b 40 28             	mov    0x28(%eax),%eax
801067e2:	85 c0                	test   %eax,%eax
801067e4:	74 13                	je     801067f9 <sys_sleep+0x5a>
      release(&tickslock);
801067e6:	c7 04 24 c0 82 11 80 	movl   $0x801182c0,(%esp)
801067ed:	e8 f2 ea ff ff       	call   801052e4 <release>
      return -1;
801067f2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801067f7:	eb 36                	jmp    8010682f <sys_sleep+0x90>
    }
    sleep(&ticks, &tickslock);
801067f9:	c7 44 24 04 c0 82 11 	movl   $0x801182c0,0x4(%esp)
80106800:	80 
80106801:	c7 04 24 00 8b 11 80 	movl   $0x80118b00,(%esp)
80106808:	e8 99 e4 ff ff       	call   80104ca6 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010680d:	a1 00 8b 11 80       	mov    0x80118b00,%eax
80106812:	2b 45 f4             	sub    -0xc(%ebp),%eax
80106815:	89 c2                	mov    %eax,%edx
80106817:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010681a:	39 c2                	cmp    %eax,%edx
8010681c:	72 bb                	jb     801067d9 <sys_sleep+0x3a>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
  ...
  release(&tickslock);
8010681e:	c7 04 24 c0 82 11 80 	movl   $0x801182c0,(%esp)
80106825:	e8 ba ea ff ff       	call   801052e4 <release>
  return 0;
...
80106834:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&tickslock);
80106837:	c7 04 24 c0 82 11 80 	movl   $0x801182c0,(%esp)
8010683e:	e8 3f ea ff ff       	call   80105282 <acquire>
  xticks = ticks;
80106843:	a1 00 8b 11 80       	mov    0x80118b00,%eax
80106848:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
8010684b:	c7 04 24 c0 82 11 80 	movl   $0x801182c0,(%esp)
...
80106860:	83 ec 24             	sub    $0x24,%esp
	int signum;
	int handler;

	if ( (argint(0, &signum) < 0) | (argint(1, &handler) < 0) )
80106863:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106866:	89 44 24 04          	mov    %eax,0x4(%esp)
8010686a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106871:	e8 a2 ef ff ff       	call   80105818 <argint>
80106876:	c1 e8 1f             	shr    $0x1f,%eax
80106879:	89 c3                	mov    %eax,%ebx
8010687b:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010687e:	89 44 24 04          	mov    %eax,0x4(%esp)
80106882:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106889:	e8 8a ef ff ff       	call   80105818 <argint>
8010688e:	c1 e8 1f             	shr    $0x1f,%eax
80106891:	09 d8                	or     %ebx,%eax
80106893:	84 c0                	test   %al,%al
80106895:	74 07                	je     8010689e <sys_signal+0x42>
		return -1;
80106897:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010689c:	eb 14                	jmp    801068b2 <sys_signal+0x56>
...
801068ad:	e8 a0 e6 ff ff       	call   80104f52 <signal>
}
801068b2:	83 c4 24             	add    $0x24,%esp
801068b5:	5b                   	pop    %ebx
801068b6:	5d                   	pop    %ebp
801068b7:	c3                   	ret    

801068b8 <sys_sigsend>:
...
801068bc:	83 ec 24             	sub    $0x24,%esp
	int pid;
	int signum;
...
801068cd:	e8 46 ef ff ff       	call   80105818 <argint>
801068d2:	c1 e8 1f             	shr    $0x1f,%eax
801068d5:	89 c3                	mov    %eax,%ebx
801068d7:	8d 45 f0             	lea    -0x10(%ebp),%eax
801068da:	89 44 24 04          	mov    %eax,0x4(%esp)
801068de:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801068e5:	e8 2e ef ff ff       	call   80105818 <argint>
801068ea:	c1 e8 1f             	shr    $0x1f,%eax
801068ed:	09 d8                	or     %ebx,%eax
801068ef:	84 c0                	test   %al,%al
801068f1:	74 07                	je     801068fa <sys_sigsend+0x42>
		return -1;
801068f3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801068f8:	eb 12                	jmp    8010690c <sys_sigsend+0x54>
	return sigsend(pid, signum);
801068fa:	8b 55 f0             	mov    -0x10(%ebp),%edx
801068fd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106900:	89 54 24 04          	mov    %edx,0x4(%esp)
80106904:	89 04 24             	mov    %eax,(%esp)
80106907:	e8 8a e6 ff ff       	call   80104f96 <sigsend>
}
8010690c:	83 c4 24             	add    $0x24,%esp
8010690f:	5b                   	pop    %ebx
80106910:	5d                   	pop    %ebp
80106911:	c3                   	ret    

80106912 <sys_sigreturn>:
...
8010691e:	8b 50 18             	mov    0x18(%eax),%edx
80106921:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106927:	8b 40 1c             	mov    0x1c(%eax),%eax
8010692a:	89 54 24 04          	mov    %edx,0x4(%esp)
8010692e:	89 04 24             	mov    %eax,(%esp)
80106931:	e8 ff 02 00 00       	call   80106c35 <copytf>
	return 0;
...
80106940:	83 ec 08             	sub    $0x8,%esp
       advanceprocstats();
80106943:	e8 fd e6 ff ff       	call   80105045 <advanceprocstats>
       return 0;
...
8010695c:	c7 04 24 92 91 10 80 	movl   $0x80109192,(%esp)
80106963:	e8 38 9a ff ff       	call   801003a0 <cprintf>
       //if(argptr(0, (char**)&perfP, 32) < 0)
       if(argint(0,&perfP) < 0)
80106968:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010696b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010696f:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106976:	e8 9d ee ff ff       	call   80105818 <argint>
8010697b:	85 c0                	test   %eax,%eax
8010697d:	79 07                	jns    80106986 <sys_wait_stat+0x37>
               return -1;
8010697f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106984:	eb 0b                	jmp    80106991 <sys_wait_stat+0x42>
       return  wait_stat((struct perf *)perfP);
80106986:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106989:	89 04 24             	mov    %eax,(%esp)
8010698c:	e8 3a e7 ff ff       	call   801050cb <wait_stat>
       //return  wait_stat((struct perf *)perfP);
}
80106991:	c9                   	leave  
80106992:	c3                   	ret    
...
80106999:	8b 55 08             	mov    0x8(%ebp),%edx
8010699c:	8b 45 0c             	mov    0xc(%ebp),%eax
8010699f:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
801069a3:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
801069a6:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
801069aa:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
...
801069b7:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
801069be:	00 
801069bf:	c7 04 24 43 00 00 00 	movl   $0x43,(%esp)
801069c6:	e8 c8 ff ff ff       	call   80106993 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) % 256);
801069cb:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
801069d2:	00 
801069d3:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
801069da:	e8 b4 ff ff ff       	call   80106993 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) / 256);
801069df:	c7 44 24 04 2e 00 00 	movl   $0x2e,0x4(%esp)
801069e6:	00 
801069e7:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
801069ee:	e8 a0 ff ff ff       	call   80106993 <outb>
  picenable(IRQ_TIMER);
801069f3:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801069fa:	e8 b5 d3 ff ff       	call   80103db4 <picenable>
}
801069ff:	c9                   	leave  
80106a00:	c3                   	ret    
...
80106a02:	06                   	push   %es
  pushl %fs
80106a03:	0f a0                	push   %fs
  pushl %gs
80106a05:	0f a8                	push   %gs
  pushal
80106a07:	60                   	pusha  
  
  # Set up data and per-cpu segments.
  movw $(SEG_KDATA<<3), %ax
80106a08:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80106a0c:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80106a0e:	8e c0                	mov    %eax,%es
  movw $(SEG_KCPU<<3), %ax
80106a10:	66 b8 18 00          	mov    $0x18,%ax
  movw %ax, %fs
80106a14:	8e e0                	mov    %eax,%fs
  movw %ax, %gs
80106a16:	8e e8                	mov    %eax,%gs

  # Call trap(tf), where tf=%esp
  pushl %esp
80106a18:	54                   	push   %esp
  call trap
80106a19:	e8 2b 05 00 00       	call   80106f49 <trap>
  call handleSignals
80106a1e:	e8 d1 03 00 00       	call   80106df4 <handleSignals>
  addl $4, %esp
80106a23:	83 c4 04             	add    $0x4,%esp
...
80106a26:	61                   	popa   
  popl %gs
80106a27:	0f a9                	pop    %gs
  popl %fs
80106a29:	0f a1                	pop    %fs
  popl %es
80106a2b:	07                   	pop    %es
  popl %ds
80106a2c:	1f                   	pop    %ds
...
80106a32:	b8 1a 00 00 00       	mov    $0x1a,%eax
  int $T_SYSCALL
80106a37:	cd 40                	int    $0x40
...
80106a3c:	83 ec 10             	sub    $0x10,%esp
  volatile ushort pd[3];

  pd[0] = size-1;
80106a3f:	8b 45 0c             	mov    0xc(%ebp),%eax
80106a42:	83 e8 01             	sub    $0x1,%eax
80106a45:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80106a49:	8b 45 08             	mov    0x8(%ebp),%eax
80106a4c:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80106a50:	8b 45 08             	mov    0x8(%ebp),%eax
80106a53:	c1 e8 10             	shr    $0x10,%eax
80106a56:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lidt (%0)" : : "r" (pd));
80106a5a:	8d 45 fa             	lea    -0x6(%ebp),%eax
80106a5d:	0f 01 18             	lidtl  (%eax)
}
80106a60:	c9                   	leave  
80106a61:	c3                   	ret    
...
80106a68:	0f 20 d0             	mov    %cr2,%eax
80106a6b:	89 45 fc             	mov    %eax,-0x4(%ebp)
  return val;
80106a6e:	8b 45 fc             	mov    -0x4(%ebp),%eax
}
80106a71:	c9                   	leave  
80106a72:	c3                   	ret    
...
80106a76:	83 ec 28             	sub    $0x28,%esp
  ...
  for(i = 0; i < 256; i++)
80106a79:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106a80:	e9 c3 00 00 00       	jmp    80106b48 <tvinit+0xd5>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
80106a85:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106a88:	8b 04 85 ac c0 10 80 	mov    -0x7fef3f54(,%eax,4),%eax
80106a8f:	89 c2                	mov    %eax,%edx
80106a91:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106a94:	66 89 14 c5 00 83 11 	mov    %dx,-0x7fee7d00(,%eax,8)
80106a9b:	80 
80106a9c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106a9f:	66 c7 04 c5 02 83 11 	movw   $0x8,-0x7fee7cfe(,%eax,8)
80106aa6:	80 08 00 
80106aa9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106aac:	0f b6 14 c5 04 83 11 	movzbl -0x7fee7cfc(,%eax,8),%edx
80106ab3:	80 
80106ab4:	83 e2 e0             	and    $0xffffffe0,%edx
80106ab7:	88 14 c5 04 83 11 80 	mov    %dl,-0x7fee7cfc(,%eax,8)
80106abe:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106ac1:	0f b6 14 c5 04 83 11 	movzbl -0x7fee7cfc(,%eax,8),%edx
80106ac8:	80 
80106ac9:	83 e2 1f             	and    $0x1f,%edx
80106acc:	88 14 c5 04 83 11 80 	mov    %dl,-0x7fee7cfc(,%eax,8)
80106ad3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106ad6:	0f b6 14 c5 05 83 11 	movzbl -0x7fee7cfb(,%eax,8),%edx
80106add:	80 
80106ade:	83 e2 f0             	and    $0xfffffff0,%edx
80106ae1:	83 ca 0e             	or     $0xe,%edx
80106ae4:	88 14 c5 05 83 11 80 	mov    %dl,-0x7fee7cfb(,%eax,8)
80106aeb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106aee:	0f b6 14 c5 05 83 11 	movzbl -0x7fee7cfb(,%eax,8),%edx
80106af5:	80 
80106af6:	83 e2 ef             	and    $0xffffffef,%edx
80106af9:	88 14 c5 05 83 11 80 	mov    %dl,-0x7fee7cfb(,%eax,8)
80106b00:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b03:	0f b6 14 c5 05 83 11 	movzbl -0x7fee7cfb(,%eax,8),%edx
80106b0a:	80 
80106b0b:	83 e2 9f             	and    $0xffffff9f,%edx
80106b0e:	88 14 c5 05 83 11 80 	mov    %dl,-0x7fee7cfb(,%eax,8)
80106b15:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b18:	0f b6 14 c5 05 83 11 	movzbl -0x7fee7cfb(,%eax,8),%edx
80106b1f:	80 
80106b20:	83 ca 80             	or     $0xffffff80,%edx
80106b23:	88 14 c5 05 83 11 80 	mov    %dl,-0x7fee7cfb(,%eax,8)
80106b2a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b2d:	8b 04 85 ac c0 10 80 	mov    -0x7fef3f54(,%eax,4),%eax
80106b34:	c1 e8 10             	shr    $0x10,%eax
80106b37:	89 c2                	mov    %eax,%edx
80106b39:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b3c:	66 89 14 c5 06 83 11 	mov    %dx,-0x7fee7cfa(,%eax,8)
80106b43:	80 
void
tvinit(void)
{
  ...
  for(i = 0; i < 256; i++)
80106b44:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106b48:	81 7d f4 ff 00 00 00 	cmpl   $0xff,-0xc(%ebp)
80106b4f:	0f 8e 30 ff ff ff    	jle    80106a85 <tvinit+0x12>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80106b55:	a1 ac c1 10 80       	mov    0x8010c1ac,%eax
80106b5a:	66 a3 00 85 11 80    	mov    %ax,0x80118500
80106b60:	66 c7 05 02 85 11 80 	movw   $0x8,0x80118502
80106b67:	08 00 
80106b69:	0f b6 05 04 85 11 80 	movzbl 0x80118504,%eax
80106b70:	83 e0 e0             	and    $0xffffffe0,%eax
80106b73:	a2 04 85 11 80       	mov    %al,0x80118504
80106b78:	0f b6 05 04 85 11 80 	movzbl 0x80118504,%eax
80106b7f:	83 e0 1f             	and    $0x1f,%eax
80106b82:	a2 04 85 11 80       	mov    %al,0x80118504
80106b87:	0f b6 05 05 85 11 80 	movzbl 0x80118505,%eax
80106b8e:	83 c8 0f             	or     $0xf,%eax
80106b91:	a2 05 85 11 80       	mov    %al,0x80118505
80106b96:	0f b6 05 05 85 11 80 	movzbl 0x80118505,%eax
80106b9d:	83 e0 ef             	and    $0xffffffef,%eax
80106ba0:	a2 05 85 11 80       	mov    %al,0x80118505
80106ba5:	0f b6 05 05 85 11 80 	movzbl 0x80118505,%eax
80106bac:	83 c8 60             	or     $0x60,%eax
80106baf:	a2 05 85 11 80       	mov    %al,0x80118505
80106bb4:	0f b6 05 05 85 11 80 	movzbl 0x80118505,%eax
80106bbb:	83 c8 80             	or     $0xffffff80,%eax
80106bbe:	a2 05 85 11 80       	mov    %al,0x80118505
80106bc3:	a1 ac c1 10 80       	mov    0x8010c1ac,%eax
80106bc8:	c1 e8 10             	shr    $0x10,%eax
80106bcb:	66 a3 06 85 11 80    	mov    %ax,0x80118506
  
  initlock(&tickslock, "time");
80106bd1:	c7 44 24 04 a4 91 10 	movl   $0x801091a4,0x4(%esp)
80106bd8:	80 
80106bd9:	c7 04 24 c0 82 11 80 	movl   $0x801182c0,(%esp)
80106be0:	e8 7c e6 ff ff       	call   80105261 <initlock>
}
80106be5:	c9                   	leave  
80106be6:	c3                   	ret    
...
80106bea:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
80106bed:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
80106bf4:	00 
80106bf5:	c7 04 24 00 83 11 80 	movl   $0x80118300,(%esp)
80106bfc:	e8 38 fe ff ff       	call   80106a39 <lidt>
}
80106c01:	c9                   	leave  
80106c02:	c3                   	ret    

80106c03 <getLowestSetBit>:
...
80106c06:	83 ec 10             	sub    $0x10,%esp
    if (num == 0)
80106c09:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80106c0d:	75 07                	jne    80106c16 <getLowestSetBit+0x13>
	return -1;
80106c0f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106c14:	eb 1d                	jmp    80106c33 <getLowestSetBit+0x30>
    
    int bitNum = 0;
80106c16:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
    while ((num & 1) == 0) {
80106c1d:	eb 07                	jmp    80106c26 <getLowestSetBit+0x23>
	num = num >> 1;
80106c1f:	d1 7d 08             	sarl   0x8(%ebp)
	bitNum++;
80106c22:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
getLowestSetBit(int num) {
    if (num == 0)
	return -1;
...
80106c2e:	74 ef                	je     80106c1f <getLowestSetBit+0x1c>
	num = num >> 1;
	bitNum++;
    }
    return bitNum;
...
80106c3b:	8b 10                	mov    (%eax),%edx
80106c3d:	8b 45 0c             	mov    0xc(%ebp),%eax
80106c40:	89 10                	mov    %edx,(%eax)
    copyaddr->esi = tf->esi;
80106c42:	8b 45 08             	mov    0x8(%ebp),%eax
80106c45:	8b 50 04             	mov    0x4(%eax),%edx
80106c48:	8b 45 0c             	mov    0xc(%ebp),%eax
80106c4b:	89 50 04             	mov    %edx,0x4(%eax)
    copyaddr->ebp = tf->ebp;
80106c4e:	8b 45 08             	mov    0x8(%ebp),%eax
80106c51:	8b 50 08             	mov    0x8(%eax),%edx
80106c54:	8b 45 0c             	mov    0xc(%ebp),%eax
80106c57:	89 50 08             	mov    %edx,0x8(%eax)
    copyaddr->oesp = tf->oesp;
80106c5a:	8b 45 08             	mov    0x8(%ebp),%eax
80106c5d:	8b 50 0c             	mov    0xc(%eax),%edx
80106c60:	8b 45 0c             	mov    0xc(%ebp),%eax
80106c63:	89 50 0c             	mov    %edx,0xc(%eax)
    copyaddr->ebx = tf->ebx;
80106c66:	8b 45 08             	mov    0x8(%ebp),%eax
80106c69:	8b 50 10             	mov    0x10(%eax),%edx
80106c6c:	8b 45 0c             	mov    0xc(%ebp),%eax
80106c6f:	89 50 10             	mov    %edx,0x10(%eax)
    copyaddr->edx = tf->edx;
80106c72:	8b 45 08             	mov    0x8(%ebp),%eax
80106c75:	8b 50 14             	mov    0x14(%eax),%edx
80106c78:	8b 45 0c             	mov    0xc(%ebp),%eax
80106c7b:	89 50 14             	mov    %edx,0x14(%eax)
    copyaddr->ecx = tf->ecx;
80106c7e:	8b 45 08             	mov    0x8(%ebp),%eax
80106c81:	8b 50 18             	mov    0x18(%eax),%edx
80106c84:	8b 45 0c             	mov    0xc(%ebp),%eax
80106c87:	89 50 18             	mov    %edx,0x18(%eax)
    copyaddr->eax = tf->eax;
80106c8a:	8b 45 08             	mov    0x8(%ebp),%eax
80106c8d:	8b 50 1c             	mov    0x1c(%eax),%edx
80106c90:	8b 45 0c             	mov    0xc(%ebp),%eax
80106c93:	89 50 1c             	mov    %edx,0x1c(%eax)
    copyaddr->gs = tf->gs;
80106c96:	8b 45 08             	mov    0x8(%ebp),%eax
80106c99:	0f b7 50 20          	movzwl 0x20(%eax),%edx
80106c9d:	8b 45 0c             	mov    0xc(%ebp),%eax
80106ca0:	66 89 50 20          	mov    %dx,0x20(%eax)
    copyaddr->padding1 = tf->padding1;
80106ca4:	8b 45 08             	mov    0x8(%ebp),%eax
80106ca7:	0f b7 50 22          	movzwl 0x22(%eax),%edx
80106cab:	8b 45 0c             	mov    0xc(%ebp),%eax
80106cae:	66 89 50 22          	mov    %dx,0x22(%eax)
    copyaddr->fs = tf->fs;
80106cb2:	8b 45 08             	mov    0x8(%ebp),%eax
80106cb5:	0f b7 50 24          	movzwl 0x24(%eax),%edx
80106cb9:	8b 45 0c             	mov    0xc(%ebp),%eax
80106cbc:	66 89 50 24          	mov    %dx,0x24(%eax)
    copyaddr->padding2 = tf->padding2;
80106cc0:	8b 45 08             	mov    0x8(%ebp),%eax
80106cc3:	0f b7 50 26          	movzwl 0x26(%eax),%edx
80106cc7:	8b 45 0c             	mov    0xc(%ebp),%eax
80106cca:	66 89 50 26          	mov    %dx,0x26(%eax)
    copyaddr->es = tf->es;
80106cce:	8b 45 08             	mov    0x8(%ebp),%eax
80106cd1:	0f b7 50 28          	movzwl 0x28(%eax),%edx
80106cd5:	8b 45 0c             	mov    0xc(%ebp),%eax
80106cd8:	66 89 50 28          	mov    %dx,0x28(%eax)
    copyaddr->padding3 = tf->padding3;
80106cdc:	8b 45 08             	mov    0x8(%ebp),%eax
80106cdf:	0f b7 50 2a          	movzwl 0x2a(%eax),%edx
80106ce3:	8b 45 0c             	mov    0xc(%ebp),%eax
80106ce6:	66 89 50 2a          	mov    %dx,0x2a(%eax)
    copyaddr->ds = tf->ds;
80106cea:	8b 45 08             	mov    0x8(%ebp),%eax
80106ced:	0f b7 50 2c          	movzwl 0x2c(%eax),%edx
80106cf1:	8b 45 0c             	mov    0xc(%ebp),%eax
80106cf4:	66 89 50 2c          	mov    %dx,0x2c(%eax)
    copyaddr->padding4 = tf->padding4;
80106cf8:	8b 45 08             	mov    0x8(%ebp),%eax
80106cfb:	0f b7 50 2e          	movzwl 0x2e(%eax),%edx
80106cff:	8b 45 0c             	mov    0xc(%ebp),%eax
80106d02:	66 89 50 2e          	mov    %dx,0x2e(%eax)
    copyaddr->trapno = tf->trapno;
80106d06:	8b 45 08             	mov    0x8(%ebp),%eax
80106d09:	8b 50 30             	mov    0x30(%eax),%edx
80106d0c:	8b 45 0c             	mov    0xc(%ebp),%eax
80106d0f:	89 50 30             	mov    %edx,0x30(%eax)
    copyaddr->err = tf->err;
80106d12:	8b 45 08             	mov    0x8(%ebp),%eax
80106d15:	8b 50 34             	mov    0x34(%eax),%edx
80106d18:	8b 45 0c             	mov    0xc(%ebp),%eax
80106d1b:	89 50 34             	mov    %edx,0x34(%eax)
    copyaddr->eip = tf->eip;
80106d1e:	8b 45 08             	mov    0x8(%ebp),%eax
80106d21:	8b 50 38             	mov    0x38(%eax),%edx
80106d24:	8b 45 0c             	mov    0xc(%ebp),%eax
80106d27:	89 50 38             	mov    %edx,0x38(%eax)
    copyaddr->cs = tf->cs;
80106d2a:	8b 45 08             	mov    0x8(%ebp),%eax
80106d2d:	0f b7 50 3c          	movzwl 0x3c(%eax),%edx
80106d31:	8b 45 0c             	mov    0xc(%ebp),%eax
80106d34:	66 89 50 3c          	mov    %dx,0x3c(%eax)
    copyaddr->padding5 = tf->padding5;
80106d38:	8b 45 08             	mov    0x8(%ebp),%eax
80106d3b:	0f b7 50 3e          	movzwl 0x3e(%eax),%edx
80106d3f:	8b 45 0c             	mov    0xc(%ebp),%eax
80106d42:	66 89 50 3e          	mov    %dx,0x3e(%eax)
    copyaddr->eflags = tf->eflags;
80106d46:	8b 45 08             	mov    0x8(%ebp),%eax
80106d49:	8b 50 40             	mov    0x40(%eax),%edx
80106d4c:	8b 45 0c             	mov    0xc(%ebp),%eax
80106d4f:	89 50 40             	mov    %edx,0x40(%eax)
    copyaddr->esp = tf->esp;
80106d52:	8b 45 08             	mov    0x8(%ebp),%eax
80106d55:	8b 50 44             	mov    0x44(%eax),%edx
80106d58:	8b 45 0c             	mov    0xc(%ebp),%eax
80106d5b:	89 50 44             	mov    %edx,0x44(%eax)
    copyaddr->ss = tf->ss;
80106d5e:	8b 45 08             	mov    0x8(%ebp),%eax
80106d61:	0f b7 50 48          	movzwl 0x48(%eax),%edx
80106d65:	8b 45 0c             	mov    0xc(%ebp),%eax
80106d68:	66 89 50 48          	mov    %dx,0x48(%eax)
    copyaddr->padding6 = tf->padding6;
80106d6c:	8b 45 08             	mov    0x8(%ebp),%eax
80106d6f:	0f b7 50 4a          	movzwl 0x4a(%eax),%edx
80106d73:	8b 45 0c             	mov    0xc(%ebp),%eax
80106d76:	66 89 50 4a          	mov    %dx,0x4a(%eax)
    return;
80106d7a:	90                   	nop
}
80106d7b:	5d                   	pop    %ebp
...
80106d80:	83 ec 18             	sub    $0x18,%esp
 char *str,*tmp;
 int cnt = 31;
80106d83:	c7 45 f4 1f 00 00 00 	movl   $0x1f,-0xc(%ebp)
 str = (char *) kalloc(); /*32 + 1 , because its a 32 bit bin number*/
80106d8a:	e8 53 bd ff ff       	call   80102ae2 <kalloc>
80106d8f:	89 45 f0             	mov    %eax,-0x10(%ebp)
 tmp = str;
80106d92:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106d95:	89 45 ec             	mov    %eax,-0x14(%ebp)
 while ( cnt > -1 ){
80106d98:	eb 0f                	jmp    80106da9 <int2bin+0x2c>
      str[cnt]= '0';
80106d9a:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106d9d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106da0:	01 d0                	add    %edx,%eax
80106da2:	c6 00 30             	movb   $0x30,(%eax)
      cnt --;
80106da5:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
{
 char *str,*tmp;
 int cnt = 31;
 str = (char *) kalloc(); /*32 + 1 , because its a 32 bit bin number*/
 tmp = str;
 while ( cnt > -1 ){
80106da9:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106dad:	79 eb                	jns    80106d9a <int2bin+0x1d>
      str[cnt]= '0';
      cnt --;
 }
 cnt = 31;
80106daf:	c7 45 f4 1f 00 00 00 	movl   $0x1f,-0xc(%ebp)
 while (a > 0){
80106db6:	eb 31                	jmp    80106de9 <int2bin+0x6c>
       if (a%2==1){
80106db8:	8b 45 08             	mov    0x8(%ebp),%eax
80106dbb:	99                   	cltd   
80106dbc:	c1 ea 1f             	shr    $0x1f,%edx
80106dbf:	01 d0                	add    %edx,%eax
80106dc1:	83 e0 01             	and    $0x1,%eax
80106dc4:	29 d0                	sub    %edx,%eax
80106dc6:	83 f8 01             	cmp    $0x1,%eax
80106dc9:	75 0b                	jne    80106dd6 <int2bin+0x59>
           str[cnt] = '1';
80106dcb:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106dce:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106dd1:	01 d0                	add    %edx,%eax
80106dd3:	c6 00 31             	movb   $0x31,(%eax)
        }
      cnt--;
80106dd6:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
        a = a/2 ;
80106dda:	8b 45 08             	mov    0x8(%ebp),%eax
80106ddd:	89 c2                	mov    %eax,%edx
80106ddf:	c1 ea 1f             	shr    $0x1f,%edx
80106de2:	01 d0                	add    %edx,%eax
80106de4:	d1 f8                	sar    %eax
80106de6:	89 45 08             	mov    %eax,0x8(%ebp)
 while ( cnt > -1 ){
      str[cnt]= '0';
      cnt --;
 }
 cnt = 31;
 while (a > 0){
80106de9:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80106ded:	7f c9                	jg     80106db8 <int2bin+0x3b>
           str[cnt] = '1';
        }
      cnt--;
        a = a/2 ;
 ...
 return tmp;
80106def:	8b 45 ec             	mov    -0x14(%ebp),%eax

}
80106df2:	c9                   	leave  
80106df3:	c3                   	ret    

80106df4 <handleSignals>:

void
handleSignals(struct trapframe *tf) {      
80106df4:	55                   	push   %ebp
80106df5:	89 e5                	mov    %esp,%ebp
80106df7:	56                   	push   %esi
80106df8:	53                   	push   %ebx
80106df9:	83 ec 30             	sub    $0x30,%esp
    if(tf->trapno == T_SYSCALL && proc->pending > 0) {
80106dfc:	8b 45 08             	mov    0x8(%ebp),%eax
80106dff:	8b 40 30             	mov    0x30(%eax),%eax
80106e02:	83 f8 40             	cmp    $0x40,%eax
80106e05:	0f 85 36 01 00 00    	jne    80106f41 <handleSignals+0x14d>
80106e0b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106e11:	8b 80 80 00 00 00    	mov    0x80(%eax),%eax
80106e17:	85 c0                	test   %eax,%eax
80106e19:	0f 8e 22 01 00 00    	jle    80106f41 <handleSignals+0x14d>
      int signum = getLowestSetBit(proc->pending);
80106e1f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106e25:	8b 80 80 00 00 00    	mov    0x80(%eax),%eax
80106e2b:	89 04 24             	mov    %eax,(%esp)
80106e2e:	e8 d0 fd ff ff       	call   80106c03 <getLowestSetBit>
80106e33:	89 45 f4             	mov    %eax,-0xc(%ebp)
      proc->pending &= ~(1 << signum);
80106e36:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106e3c:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80106e43:	8b 9a 80 00 00 00    	mov    0x80(%edx),%ebx
80106e49:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106e4c:	be 01 00 00 00       	mov    $0x1,%esi
80106e51:	89 d1                	mov    %edx,%ecx
80106e53:	d3 e6                	shl    %cl,%esi
80106e55:	89 f2                	mov    %esi,%edx
80106e57:	f7 d2                	not    %edx
80106e59:	21 da                	and    %ebx,%edx
80106e5b:	89 90 80 00 00 00    	mov    %edx,0x80(%eax)
      
      sighandler_t handler = proc->signal_handlers[signum];
80106e61:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106e67:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106e6a:	83 c2 20             	add    $0x20,%edx
80106e6d:	8b 44 90 04          	mov    0x4(%eax,%edx,4),%eax
80106e71:	89 45 f0             	mov    %eax,-0x10(%ebp)
      if (!proc->backuptf) {
80106e74:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106e7a:	8b 40 1c             	mov    0x1c(%eax),%eax
80106e7d:	85 c0                	test   %eax,%eax
80106e7f:	75 0f                	jne    80106e90 <handleSignals+0x9c>
          proc->backuptf = (struct trapframe*)kalloc();
80106e81:	65 8b 1d 04 00 00 00 	mov    %gs:0x4,%ebx
80106e88:	e8 55 bc ff ff       	call   80102ae2 <kalloc>
80106e8d:	89 43 1c             	mov    %eax,0x1c(%ebx)
      }
      copytf(proc->tf, proc->backuptf);          // Copy trap frame, to be reconstruced later
80106e90:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106e96:	8b 50 1c             	mov    0x1c(%eax),%edx
80106e99:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106e9f:	8b 40 18             	mov    0x18(%eax),%eax
80106ea2:	89 54 24 04          	mov    %edx,0x4(%esp)
80106ea6:	89 04 24             	mov    %eax,(%esp)
80106ea9:	e8 87 fd ff ff       	call   80106c35 <copytf>
      
      int* sp = (int*)proc->tf->esp;
80106eae:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106eb4:	8b 40 18             	mov    0x18(%eax),%eax
80106eb7:	8b 40 44             	mov    0x44(%eax),%eax
80106eba:	89 45 ec             	mov    %eax,-0x14(%ebp)
      int funcAddr = (int)(sp - 5); // We put the sigret function 5*4 bytes under the stack pointer. (its size is approx. 8 bytes)
80106ebd:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106ec0:	83 e8 14             	sub    $0x14,%eax
80106ec3:	89 45 e8             	mov    %eax,-0x18(%ebp)
      int funcSize = (int)&end_of_sigret - (int)&implicit_sigret;		
80106ec6:	ba 39 6a 10 80       	mov    $0x80106a39,%edx
80106ecb:	b8 31 6a 10 80       	mov    $0x80106a31,%eax
80106ed0:	29 c2                	sub    %eax,%edx
80106ed2:	89 d0                	mov    %edx,%eax
...
80106ed7:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80106eda:	8b 55 e8             	mov    -0x18(%ebp),%edx
80106edd:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106ee3:	8b 40 04             	mov    0x4(%eax),%eax
80106ee6:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106eea:	c7 44 24 08 31 6a 10 	movl   $0x80106a31,0x8(%esp)
80106ef1:	80 
80106ef2:	89 54 24 04          	mov    %edx,0x4(%esp)
80106ef6:	89 04 24             	mov    %eax,(%esp)
80106ef9:	e8 8f 1d 00 00       	call   80108c8d <copyout>
      
      // We put the arguent 4 bytes under the stack pointer, and the ret address 8 bytes under.
      sp--;
80106efe:	83 6d ec 04          	subl   $0x4,-0x14(%ebp)
      *sp = signum;
80106f02:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106f05:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106f08:	89 10                	mov    %edx,(%eax)
      sp--;  
80106f0a:	83 6d ec 04          	subl   $0x4,-0x14(%ebp)
      *sp = funcAddr;    
80106f0e:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106f11:	8b 55 e8             	mov    -0x18(%ebp),%edx
80106f14:	89 10                	mov    %edx,(%eax)
...
80106f1c:	8b 40 18             	mov    0x18(%eax),%eax
80106f1f:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80106f26:	8b 52 18             	mov    0x18(%edx),%edx
80106f29:	8b 52 44             	mov    0x44(%edx),%edx
80106f2c:	83 ea 08             	sub    $0x8,%edx
80106f2f:	89 50 44             	mov    %edx,0x44(%eax)
      proc->tf->eip = (uint)handler;
80106f32:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106f38:	8b 40 18             	mov    0x18(%eax),%eax
80106f3b:	8b 55 f0             	mov    -0x10(%ebp),%edx
80106f3e:	89 50 38             	mov    %edx,0x38(%eax)
    }
    return;
80106f41:	90                   	nop
}
80106f42:	83 c4 30             	add    $0x30,%esp
80106f45:	5b                   	pop    %ebx
80106f46:	5e                   	pop    %esi
80106f47:	5d                   	pop    %ebp
80106f48:	c3                   	ret    
...
80106f4c:	57                   	push   %edi
80106f4d:	56                   	push   %esi
80106f4e:	53                   	push   %ebx
80106f4f:	83 ec 3c             	sub    $0x3c,%esp
  if(tf->trapno == T_SYSCALL){
80106f52:	8b 45 08             	mov    0x8(%ebp),%eax
80106f55:	8b 40 30             	mov    0x30(%eax),%eax
80106f58:	83 f8 40             	cmp    $0x40,%eax
80106f5b:	75 3f                	jne    80106f9c <trap+0x53>
    if(proc->killed)
80106f5d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106f63:	8b 40 28             	mov    0x28(%eax),%eax
80106f66:	85 c0                	test   %eax,%eax
80106f68:	74 05                	je     80106f6f <trap+0x26>
      exit();
80106f6a:	e8 f2 d8 ff ff       	call   80104861 <exit>
    proc->tf = tf;
80106f6f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106f75:	8b 55 08             	mov    0x8(%ebp),%edx
80106f78:	89 50 18             	mov    %edx,0x18(%eax)
    syscall();
80106f7b:	e8 5f e9 ff ff       	call   801058df <syscall>
    if(proc->killed)
80106f80:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106f86:	8b 40 28             	mov    0x28(%eax),%eax
80106f89:	85 c0                	test   %eax,%eax
80106f8b:	74 0a                	je     80106f97 <trap+0x4e>
      exit();
80106f8d:	e8 cf d8 ff ff       	call   80104861 <exit>
    return;
80106f92:	e9 8f 02 00 00       	jmp    80107226 <trap+0x2dd>
80106f97:	e9 8a 02 00 00       	jmp    80107226 <trap+0x2dd>
  }

  switch(tf->trapno){
80106f9c:	8b 45 08             	mov    0x8(%ebp),%eax
80106f9f:	8b 40 30             	mov    0x30(%eax),%eax
80106fa2:	83 e8 20             	sub    $0x20,%eax
80106fa5:	83 f8 1f             	cmp    $0x1f,%eax
80106fa8:	0f 87 c1 00 00 00    	ja     8010706f <trap+0x126>
80106fae:	8b 04 85 4c 92 10 80 	mov    -0x7fef6db4(,%eax,4),%eax
80106fb5:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpu->id == 0){
80106fb7:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106fbd:	0f b6 00             	movzbl (%eax),%eax
80106fc0:	84 c0                	test   %al,%al
80106fc2:	75 36                	jne    80106ffa <trap+0xb1>
      acquire(&tickslock);
80106fc4:	c7 04 24 c0 82 11 80 	movl   $0x801182c0,(%esp)
80106fcb:	e8 b2 e2 ff ff       	call   80105282 <acquire>
      ticks++;
80106fd0:	a1 00 8b 11 80       	mov    0x80118b00,%eax
80106fd5:	83 c0 01             	add    $0x1,%eax
80106fd8:	a3 00 8b 11 80       	mov    %eax,0x80118b00
      wakeup(&ticks);
80106fdd:	c7 04 24 00 8b 11 80 	movl   $0x80118b00,(%esp)
80106fe4:	e8 c9 dd ff ff       	call   80104db2 <wakeup>
      advanceprocstats();
80106fe9:	e8 57 e0 ff ff       	call   80105045 <advanceprocstats>
      release(&tickslock);
80106fee:	c7 04 24 c0 82 11 80 	movl   $0x801182c0,(%esp)
80106ff5:	e8 ea e2 ff ff       	call   801052e4 <release>
    }
    lapiceoi();
80106ffa:	e8 d1 be ff ff       	call   80102ed0 <lapiceoi>
    break;
80106fff:	e9 41 01 00 00       	jmp    80107145 <trap+0x1fc>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80107004:	e8 d5 b6 ff ff       	call   801026de <ideintr>
    lapiceoi();
80107009:	e8 c2 be ff ff       	call   80102ed0 <lapiceoi>
    break;
8010700e:	e9 32 01 00 00       	jmp    80107145 <trap+0x1fc>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80107013:	e8 87 bc ff ff       	call   80102c9f <kbdintr>
    lapiceoi();
80107018:	e8 b3 be ff ff       	call   80102ed0 <lapiceoi>
    break;
8010701d:	e9 23 01 00 00       	jmp    80107145 <trap+0x1fc>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
80107022:	e8 f4 03 00 00       	call   8010741b <uartintr>
    lapiceoi();
80107027:	e8 a4 be ff ff       	call   80102ed0 <lapiceoi>
    break;
8010702c:	e9 14 01 00 00       	jmp    80107145 <trap+0x1fc>
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80107031:	8b 45 08             	mov    0x8(%ebp),%eax
80107034:	8b 48 38             	mov    0x38(%eax),%ecx
            cpu->id, tf->cs, tf->eip);
...
8010703a:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
  ...
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
8010703e:	0f b7 d0             	movzwl %ax,%edx
            cpu->id, tf->cs, tf->eip);
80107041:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107047:	0f b6 00             	movzbl (%eax),%eax
  ...
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
8010704a:	0f b6 c0             	movzbl %al,%eax
8010704d:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80107051:	89 54 24 08          	mov    %edx,0x8(%esp)
80107055:	89 44 24 04          	mov    %eax,0x4(%esp)
80107059:	c7 04 24 ac 91 10 80 	movl   $0x801091ac,(%esp)
80107060:	e8 3b 93 ff ff       	call   801003a0 <cprintf>
            cpu->id, tf->cs, tf->eip);
    lapiceoi();
80107065:	e8 66 be ff ff       	call   80102ed0 <lapiceoi>
    break;
8010706a:	e9 d6 00 00 00       	jmp    80107145 <trap+0x1fc>
...
80107077:	74 11                	je     8010708a <trap+0x141>
80107079:	8b 45 08             	mov    0x8(%ebp),%eax
8010707c:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80107080:	0f b7 c0             	movzwl %ax,%eax
80107083:	83 e0 03             	and    $0x3,%eax
80107086:	85 c0                	test   %eax,%eax
80107088:	75 46                	jne    801070d0 <trap+0x187>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
8010708a:	e8 d3 f9 ff ff       	call   80106a62 <rcr2>
8010708f:	8b 55 08             	mov    0x8(%ebp),%edx
80107092:	8b 5a 38             	mov    0x38(%edx),%ebx
              tf->trapno, cpu->id, tf->eip, rcr2());
80107095:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
8010709c:	0f b6 12             	movzbl (%edx),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
8010709f:	0f b6 ca             	movzbl %dl,%ecx
801070a2:	8b 55 08             	mov    0x8(%ebp),%edx
801070a5:	8b 52 30             	mov    0x30(%edx),%edx
801070a8:	89 44 24 10          	mov    %eax,0x10(%esp)
801070ac:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
801070b0:	89 4c 24 08          	mov    %ecx,0x8(%esp)
801070b4:	89 54 24 04          	mov    %edx,0x4(%esp)
801070b8:	c7 04 24 d0 91 10 80 	movl   $0x801091d0,(%esp)
801070bf:	e8 dc 92 ff ff       	call   801003a0 <cprintf>
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
801070c4:	c7 04 24 02 92 10 80 	movl   $0x80109202,(%esp)
801070cb:	e8 6a 94 ff ff       	call   8010053a <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801070d0:	e8 8d f9 ff ff       	call   80106a62 <rcr2>
801070d5:	89 c2                	mov    %eax,%edx
801070d7:	8b 45 08             	mov    0x8(%ebp),%eax
801070da:	8b 78 38             	mov    0x38(%eax),%edi
...
801070e3:	0f b6 00             	movzbl (%eax),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801070e6:	0f b6 f0             	movzbl %al,%esi
801070e9:	8b 45 08             	mov    0x8(%ebp),%eax
801070ec:	8b 58 34             	mov    0x34(%eax),%ebx
801070ef:	8b 45 08             	mov    0x8(%ebp),%eax
801070f2:	8b 48 30             	mov    0x30(%eax),%ecx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
801070f5:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801070fb:	83 c0 70             	add    $0x70,%eax
...
80107101:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80107107:	8b 40 10             	mov    0x10(%eax),%eax
8010710a:	89 54 24 1c          	mov    %edx,0x1c(%esp)
8010710e:	89 7c 24 18          	mov    %edi,0x18(%esp)
80107112:	89 74 24 14          	mov    %esi,0x14(%esp)
80107116:	89 5c 24 10          	mov    %ebx,0x10(%esp)
8010711a:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
8010711e:	8b 75 e4             	mov    -0x1c(%ebp),%esi
80107121:	89 74 24 08          	mov    %esi,0x8(%esp)
80107125:	89 44 24 04          	mov    %eax,0x4(%esp)
80107129:	c7 04 24 08 92 10 80 	movl   $0x80109208,(%esp)
80107130:	e8 6b 92 ff ff       	call   801003a0 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
            rcr2());
    proc->killed = 1;
80107135:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010713b:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
80107142:	eb 01                	jmp    80107145 <trap+0x1fc>
    ideintr();
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE+1:
...
8010716c:	75 05                	jne    80107173 <trap+0x22a>
    exit();
8010716e:	e8 ee d6 ff ff       	call   80104861 <exit>
...
8010717b:	74 7b                	je     801071f8 <trap+0x2af>
8010717d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107183:	8b 40 0c             	mov    0xc(%eax),%eax
80107186:	83 f8 04             	cmp    $0x4,%eax
80107189:	75 6d                	jne    801071f8 <trap+0x2af>
8010718b:	8b 45 08             	mov    0x8(%ebp),%eax
8010718e:	8b 40 30             	mov    0x30(%eax),%eax
80107191:	83 f8 20             	cmp    $0x20,%eax
80107194:	75 62                	jne    801071f8 <trap+0x2af>
	  if( proc->runQuanta % QUANTA == 0 ){
80107196:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010719c:	8b 88 18 01 00 00    	mov    0x118(%eax),%ecx
801071a2:	ba 67 66 66 66       	mov    $0x66666667,%edx
801071a7:	89 c8                	mov    %ecx,%eax
801071a9:	f7 ea                	imul   %edx
801071ab:	d1 fa                	sar    %edx
801071ad:	89 c8                	mov    %ecx,%eax
801071af:	c1 f8 1f             	sar    $0x1f,%eax
801071b2:	29 c2                	sub    %eax,%edx
801071b4:	89 d0                	mov    %edx,%eax
801071b6:	c1 e0 02             	shl    $0x2,%eax
801071b9:	01 d0                	add    %edx,%eax
801071bb:	29 c1                	sub    %eax,%ecx
801071bd:	89 ca                	mov    %ecx,%edx
801071bf:	85 d2                	test   %edx,%edx
801071c1:	75 20                	jne    801071e3 <trap+0x29a>
...
801071c9:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
801071d0:	8b 92 14 01 00 00    	mov    0x114(%edx),%edx
801071d6:	89 90 18 01 00 00    	mov    %edx,0x118(%eax)
		  yield();
801071dc:	e8 67 da ff ff       	call   80104c48 <yield>
801071e1:	eb 15                	jmp    801071f8 <trap+0x2af>
	  }
	  else
		  proc->runQuanta++;
801071e3:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801071e9:	8b 90 18 01 00 00    	mov    0x118(%eax),%edx
801071ef:	83 c2 01             	add    $0x1,%edx
801071f2:	89 90 18 01 00 00    	mov    %edx,0x118(%eax)
  }

  // Check if the process has been killed since we yielded
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
801071f8:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801071fe:	85 c0                	test   %eax,%eax
80107200:	74 24                	je     80107226 <trap+0x2dd>
80107202:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107208:	8b 40 28             	mov    0x28(%eax),%eax
8010720b:	85 c0                	test   %eax,%eax
8010720d:	74 17                	je     80107226 <trap+0x2dd>
8010720f:	8b 45 08             	mov    0x8(%ebp),%eax
80107212:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80107216:	0f b7 c0             	movzwl %ax,%eax
80107219:	83 e0 03             	and    $0x3,%eax
8010721c:	83 f8 03             	cmp    $0x3,%eax
8010721f:	75 05                	jne    80107226 <trap+0x2dd>
    exit();
80107221:	e8 3b d6 ff ff       	call   80104861 <exit>
}
80107226:	83 c4 3c             	add    $0x3c,%esp
80107229:	5b                   	pop    %ebx
8010722a:	5e                   	pop    %esi
8010722b:	5f                   	pop    %edi
8010722c:	5d                   	pop    %ebp
...
80107231:	83 ec 14             	sub    $0x14,%esp
80107234:	8b 45 08             	mov    0x8(%ebp),%eax
80107237:	66 89 45 ec          	mov    %ax,-0x14(%ebp)
  uchar data;

  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
8010723b:	0f b7 45 ec          	movzwl -0x14(%ebp),%eax
8010723f:	89 c2                	mov    %eax,%edx
80107241:	ec                   	in     (%dx),%al
80107242:	88 45 ff             	mov    %al,-0x1(%ebp)
  return data;
80107245:	0f b6 45 ff          	movzbl -0x1(%ebp),%eax
}
80107249:	c9                   	leave  
8010724a:	c3                   	ret    
...
80107251:	8b 55 08             	mov    0x8(%ebp),%edx
80107254:	8b 45 0c             	mov    0xc(%ebp),%eax
80107257:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
8010725b:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
8010725e:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
80107262:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
80107266:	ee                   	out    %al,(%dx)
}
80107267:	c9                   	leave  
80107268:	c3                   	ret    
...
8010726c:	83 ec 28             	sub    $0x28,%esp
  char *p;

  // Turn off the FIFO
  outb(COM1+2, 0);
8010726f:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107276:	00 
80107277:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
8010727e:	e8 c8 ff ff ff       	call   8010724b <outb>
  
  // 9600 baud, 8 data bits, 1 stop bit, parity off.
  outb(COM1+3, 0x80);    // Unlock divisor
80107283:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
8010728a:	00 
8010728b:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80107292:	e8 b4 ff ff ff       	call   8010724b <outb>
  outb(COM1+0, 115200/9600);
80107297:	c7 44 24 04 0c 00 00 	movl   $0xc,0x4(%esp)
8010729e:	00 
8010729f:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
801072a6:	e8 a0 ff ff ff       	call   8010724b <outb>
  outb(COM1+1, 0);
801072ab:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801072b2:	00 
801072b3:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
801072ba:	e8 8c ff ff ff       	call   8010724b <outb>
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
801072bf:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
801072c6:	00 
801072c7:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
801072ce:	e8 78 ff ff ff       	call   8010724b <outb>
  outb(COM1+4, 0);
801072d3:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801072da:	00 
801072db:	c7 04 24 fc 03 00 00 	movl   $0x3fc,(%esp)
801072e2:	e8 64 ff ff ff       	call   8010724b <outb>
  outb(COM1+1, 0x01);    // Enable receive interrupts.
801072e7:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
801072ee:	00 
801072ef:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
801072f6:	e8 50 ff ff ff       	call   8010724b <outb>

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
801072fb:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80107302:	e8 27 ff ff ff       	call   8010722e <inb>
80107307:	3c ff                	cmp    $0xff,%al
80107309:	75 02                	jne    8010730d <uartinit+0xa4>
    return;
8010730b:	eb 6a                	jmp    80107377 <uartinit+0x10e>
  uart = 1;
8010730d:	c7 05 70 c6 10 80 01 	movl   $0x1,0x8010c670
80107314:	00 00 00 

  // Acknowledge pre-existing interrupt conditions;
  // enable interrupts.
  inb(COM1+2);
80107317:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
8010731e:	e8 0b ff ff ff       	call   8010722e <inb>
  inb(COM1+0);
80107323:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
8010732a:	e8 ff fe ff ff       	call   8010722e <inb>
  picenable(IRQ_COM1);
8010732f:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80107336:	e8 79 ca ff ff       	call   80103db4 <picenable>
  ioapicenable(IRQ_COM1, 0);
8010733b:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107342:	00 
80107343:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
8010734a:	e8 0e b6 ff ff       	call   8010295d <ioapicenable>
  
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
8010734f:	c7 45 f4 cc 92 10 80 	movl   $0x801092cc,-0xc(%ebp)
80107356:	eb 15                	jmp    8010736d <uartinit+0x104>
    uartputc(*p);
80107358:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010735b:	0f b6 00             	movzbl (%eax),%eax
8010735e:	0f be c0             	movsbl %al,%eax
80107361:	89 04 24             	mov    %eax,(%esp)
80107364:	e8 10 00 00 00       	call   80107379 <uartputc>
  inb(COM1+0);
  picenable(IRQ_COM1);
  ioapicenable(IRQ_COM1, 0);
...
80107373:	84 c0                	test   %al,%al
80107375:	75 e1                	jne    80107358 <uartinit+0xef>
    uartputc(*p);
}
80107377:	c9                   	leave  
80107378:	c3                   	ret    
...
8010737c:	83 ec 28             	sub    $0x28,%esp
  ...
  if(!uart)
8010737f:	a1 70 c6 10 80       	mov    0x8010c670,%eax
80107384:	85 c0                	test   %eax,%eax
80107386:	75 02                	jne    8010738a <uartputc+0x11>
    return;
80107388:	eb 4b                	jmp    801073d5 <uartputc+0x5c>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
8010738a:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80107391:	eb 10                	jmp    801073a3 <uartputc+0x2a>
    microdelay(10);
80107393:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
8010739a:	e8 56 bb ff ff       	call   80102ef5 <microdelay>
{
  int i;
  ...
  if(!uart)
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
8010739f:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
801073a3:	83 7d f4 7f          	cmpl   $0x7f,-0xc(%ebp)
801073a7:	7f 16                	jg     801073bf <uartputc+0x46>
801073a9:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
801073b0:	e8 79 fe ff ff       	call   8010722e <inb>
801073b5:	0f b6 c0             	movzbl %al,%eax
801073b8:	83 e0 20             	and    $0x20,%eax
801073bb:	85 c0                	test   %eax,%eax
801073bd:	74 d4                	je     80107393 <uartputc+0x1a>
    microdelay(10);
  outb(COM1+0, c);
801073bf:	8b 45 08             	mov    0x8(%ebp),%eax
801073c2:	0f b6 c0             	movzbl %al,%eax
801073c5:	89 44 24 04          	mov    %eax,0x4(%esp)
801073c9:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
801073d0:	e8 76 fe ff ff       	call   8010724b <outb>
}
801073d5:	c9                   	leave  
801073d6:	c3                   	ret    
...
801073da:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
801073dd:	a1 70 c6 10 80       	mov    0x8010c670,%eax
801073e2:	85 c0                	test   %eax,%eax
801073e4:	75 07                	jne    801073ed <uartgetc+0x16>
    return -1;
801073e6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801073eb:	eb 2c                	jmp    80107419 <uartgetc+0x42>
  if(!(inb(COM1+5) & 0x01))
801073ed:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
801073f4:	e8 35 fe ff ff       	call   8010722e <inb>
801073f9:	0f b6 c0             	movzbl %al,%eax
801073fc:	83 e0 01             	and    $0x1,%eax
801073ff:	85 c0                	test   %eax,%eax
80107401:	75 07                	jne    8010740a <uartgetc+0x33>
    return -1;
80107403:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107408:	eb 0f                	jmp    80107419 <uartgetc+0x42>
  return inb(COM1+0);
8010740a:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80107411:	e8 18 fe ff ff       	call   8010722e <inb>
...
8010741e:	83 ec 18             	sub    $0x18,%esp
  consoleintr(uartgetc);
80107421:	c7 04 24 d7 73 10 80 	movl   $0x801073d7,(%esp)
80107428:	e8 80 93 ff ff       	call   801007ad <consoleintr>
}
8010742d:	c9                   	leave  
8010742e:	c3                   	ret    
...
80107431:	6a 00                	push   $0x0
  jmp alltraps
80107433:	e9 c9 f5 ff ff       	jmp    80106a01 <alltraps>
...
80107438:	6a 00                	push   $0x0
  pushl $1
8010743a:	6a 01                	push   $0x1
  jmp alltraps
8010743c:	e9 c0 f5 ff ff       	jmp    80106a01 <alltraps>
...
80107441:	6a 00                	push   $0x0
  pushl $2
80107443:	6a 02                	push   $0x2
  jmp alltraps
80107445:	e9 b7 f5 ff ff       	jmp    80106a01 <alltraps>
...
8010744a:	6a 00                	push   $0x0
  pushl $3
8010744c:	6a 03                	push   $0x3
  jmp alltraps
8010744e:	e9 ae f5 ff ff       	jmp    80106a01 <alltraps>
...
80107453:	6a 00                	push   $0x0
  pushl $4
80107455:	6a 04                	push   $0x4
  jmp alltraps
80107457:	e9 a5 f5 ff ff       	jmp    80106a01 <alltraps>
...
8010745c:	6a 00                	push   $0x0
  pushl $5
8010745e:	6a 05                	push   $0x5
  jmp alltraps
80107460:	e9 9c f5 ff ff       	jmp    80106a01 <alltraps>
...
80107465:	6a 00                	push   $0x0
  pushl $6
80107467:	6a 06                	push   $0x6
  jmp alltraps
80107469:	e9 93 f5 ff ff       	jmp    80106a01 <alltraps>
...
8010746e:	6a 00                	push   $0x0
  pushl $7
80107470:	6a 07                	push   $0x7
  jmp alltraps
80107472:	e9 8a f5 ff ff       	jmp    80106a01 <alltraps>

80107477 <vector8>:
.globl vector8
vector8:
  pushl $8
80107477:	6a 08                	push   $0x8
  jmp alltraps
80107479:	e9 83 f5 ff ff       	jmp    80106a01 <alltraps>
...
8010747e:	6a 00                	push   $0x0
  pushl $9
80107480:	6a 09                	push   $0x9
  jmp alltraps
80107482:	e9 7a f5 ff ff       	jmp    80106a01 <alltraps>

80107487 <vector10>:
.globl vector10
vector10:
  pushl $10
80107487:	6a 0a                	push   $0xa
  jmp alltraps
80107489:	e9 73 f5 ff ff       	jmp    80106a01 <alltraps>

8010748e <vector11>:
.globl vector11
vector11:
  pushl $11
8010748e:	6a 0b                	push   $0xb
  jmp alltraps
80107490:	e9 6c f5 ff ff       	jmp    80106a01 <alltraps>

80107495 <vector12>:
.globl vector12
vector12:
  pushl $12
80107495:	6a 0c                	push   $0xc
  jmp alltraps
80107497:	e9 65 f5 ff ff       	jmp    80106a01 <alltraps>

8010749c <vector13>:
.globl vector13
vector13:
  pushl $13
8010749c:	6a 0d                	push   $0xd
  jmp alltraps
8010749e:	e9 5e f5 ff ff       	jmp    80106a01 <alltraps>

801074a3 <vector14>:
.globl vector14
vector14:
  pushl $14
801074a3:	6a 0e                	push   $0xe
  jmp alltraps
801074a5:	e9 57 f5 ff ff       	jmp    80106a01 <alltraps>
...
801074aa:	6a 00                	push   $0x0
  pushl $15
801074ac:	6a 0f                	push   $0xf
  jmp alltraps
801074ae:	e9 4e f5 ff ff       	jmp    80106a01 <alltraps>
...
801074b3:	6a 00                	push   $0x0
  pushl $16
801074b5:	6a 10                	push   $0x10
  jmp alltraps
801074b7:	e9 45 f5 ff ff       	jmp    80106a01 <alltraps>

801074bc <vector17>:
.globl vector17
vector17:
  pushl $17
801074bc:	6a 11                	push   $0x11
  jmp alltraps
801074be:	e9 3e f5 ff ff       	jmp    80106a01 <alltraps>
...
801074c3:	6a 00                	push   $0x0
  pushl $18
801074c5:	6a 12                	push   $0x12
  jmp alltraps
801074c7:	e9 35 f5 ff ff       	jmp    80106a01 <alltraps>
...
801074cc:	6a 00                	push   $0x0
  pushl $19
801074ce:	6a 13                	push   $0x13
  jmp alltraps
801074d0:	e9 2c f5 ff ff       	jmp    80106a01 <alltraps>
...
801074d5:	6a 00                	push   $0x0
  pushl $20
801074d7:	6a 14                	push   $0x14
  jmp alltraps
801074d9:	e9 23 f5 ff ff       	jmp    80106a01 <alltraps>
...
801074de:	6a 00                	push   $0x0
  pushl $21
801074e0:	6a 15                	push   $0x15
  jmp alltraps
801074e2:	e9 1a f5 ff ff       	jmp    80106a01 <alltraps>
...
801074e7:	6a 00                	push   $0x0
  pushl $22
801074e9:	6a 16                	push   $0x16
  jmp alltraps
801074eb:	e9 11 f5 ff ff       	jmp    80106a01 <alltraps>
...
801074f0:	6a 00                	push   $0x0
  pushl $23
801074f2:	6a 17                	push   $0x17
  jmp alltraps
801074f4:	e9 08 f5 ff ff       	jmp    80106a01 <alltraps>
...
801074f9:	6a 00                	push   $0x0
  pushl $24
801074fb:	6a 18                	push   $0x18
  jmp alltraps
801074fd:	e9 ff f4 ff ff       	jmp    80106a01 <alltraps>
...
80107502:	6a 00                	push   $0x0
  pushl $25
80107504:	6a 19                	push   $0x19
  jmp alltraps
80107506:	e9 f6 f4 ff ff       	jmp    80106a01 <alltraps>
...
8010750b:	6a 00                	push   $0x0
  pushl $26
8010750d:	6a 1a                	push   $0x1a
  jmp alltraps
8010750f:	e9 ed f4 ff ff       	jmp    80106a01 <alltraps>
...
80107514:	6a 00                	push   $0x0
  pushl $27
80107516:	6a 1b                	push   $0x1b
  jmp alltraps
80107518:	e9 e4 f4 ff ff       	jmp    80106a01 <alltraps>
...
8010751d:	6a 00                	push   $0x0
  pushl $28
8010751f:	6a 1c                	push   $0x1c
  jmp alltraps
80107521:	e9 db f4 ff ff       	jmp    80106a01 <alltraps>
...
80107526:	6a 00                	push   $0x0
  pushl $29
80107528:	6a 1d                	push   $0x1d
  jmp alltraps
8010752a:	e9 d2 f4 ff ff       	jmp    80106a01 <alltraps>
...
8010752f:	6a 00                	push   $0x0
  pushl $30
80107531:	6a 1e                	push   $0x1e
  jmp alltraps
80107533:	e9 c9 f4 ff ff       	jmp    80106a01 <alltraps>
...
80107538:	6a 00                	push   $0x0
  pushl $31
8010753a:	6a 1f                	push   $0x1f
  jmp alltraps
8010753c:	e9 c0 f4 ff ff       	jmp    80106a01 <alltraps>
...
80107541:	6a 00                	push   $0x0
  pushl $32
80107543:	6a 20                	push   $0x20
  jmp alltraps
80107545:	e9 b7 f4 ff ff       	jmp    80106a01 <alltraps>
...
8010754a:	6a 00                	push   $0x0
  pushl $33
8010754c:	6a 21                	push   $0x21
  jmp alltraps
8010754e:	e9 ae f4 ff ff       	jmp    80106a01 <alltraps>
...
80107553:	6a 00                	push   $0x0
  pushl $34
80107555:	6a 22                	push   $0x22
  jmp alltraps
80107557:	e9 a5 f4 ff ff       	jmp    80106a01 <alltraps>
...
8010755c:	6a 00                	push   $0x0
  pushl $35
8010755e:	6a 23                	push   $0x23
  jmp alltraps
80107560:	e9 9c f4 ff ff       	jmp    80106a01 <alltraps>
...
80107565:	6a 00                	push   $0x0
  pushl $36
80107567:	6a 24                	push   $0x24
  jmp alltraps
80107569:	e9 93 f4 ff ff       	jmp    80106a01 <alltraps>
...
8010756e:	6a 00                	push   $0x0
  pushl $37
80107570:	6a 25                	push   $0x25
  jmp alltraps
80107572:	e9 8a f4 ff ff       	jmp    80106a01 <alltraps>
...
80107577:	6a 00                	push   $0x0
  pushl $38
80107579:	6a 26                	push   $0x26
  jmp alltraps
8010757b:	e9 81 f4 ff ff       	jmp    80106a01 <alltraps>
...
80107580:	6a 00                	push   $0x0
  pushl $39
80107582:	6a 27                	push   $0x27
  jmp alltraps
80107584:	e9 78 f4 ff ff       	jmp    80106a01 <alltraps>
...
80107589:	6a 00                	push   $0x0
  pushl $40
8010758b:	6a 28                	push   $0x28
  jmp alltraps
8010758d:	e9 6f f4 ff ff       	jmp    80106a01 <alltraps>
...
80107592:	6a 00                	push   $0x0
  pushl $41
80107594:	6a 29                	push   $0x29
  jmp alltraps
80107596:	e9 66 f4 ff ff       	jmp    80106a01 <alltraps>
...
8010759b:	6a 00                	push   $0x0
  pushl $42
8010759d:	6a 2a                	push   $0x2a
  jmp alltraps
8010759f:	e9 5d f4 ff ff       	jmp    80106a01 <alltraps>
...
801075a4:	6a 00                	push   $0x0
  pushl $43
801075a6:	6a 2b                	push   $0x2b
  jmp alltraps
801075a8:	e9 54 f4 ff ff       	jmp    80106a01 <alltraps>
...
801075ad:	6a 00                	push   $0x0
  pushl $44
801075af:	6a 2c                	push   $0x2c
  jmp alltraps
801075b1:	e9 4b f4 ff ff       	jmp    80106a01 <alltraps>
...
801075b6:	6a 00                	push   $0x0
  pushl $45
801075b8:	6a 2d                	push   $0x2d
  jmp alltraps
801075ba:	e9 42 f4 ff ff       	jmp    80106a01 <alltraps>
...
801075bf:	6a 00                	push   $0x0
  pushl $46
801075c1:	6a 2e                	push   $0x2e
  jmp alltraps
801075c3:	e9 39 f4 ff ff       	jmp    80106a01 <alltraps>
...
801075c8:	6a 00                	push   $0x0
  pushl $47
801075ca:	6a 2f                	push   $0x2f
  jmp alltraps
801075cc:	e9 30 f4 ff ff       	jmp    80106a01 <alltraps>
...
801075d1:	6a 00                	push   $0x0
  pushl $48
801075d3:	6a 30                	push   $0x30
  jmp alltraps
801075d5:	e9 27 f4 ff ff       	jmp    80106a01 <alltraps>
...
801075da:	6a 00                	push   $0x0
  pushl $49
801075dc:	6a 31                	push   $0x31
  jmp alltraps
801075de:	e9 1e f4 ff ff       	jmp    80106a01 <alltraps>
...
801075e3:	6a 00                	push   $0x0
  pushl $50
801075e5:	6a 32                	push   $0x32
  jmp alltraps
801075e7:	e9 15 f4 ff ff       	jmp    80106a01 <alltraps>
...
801075ec:	6a 00                	push   $0x0
  pushl $51
801075ee:	6a 33                	push   $0x33
  jmp alltraps
801075f0:	e9 0c f4 ff ff       	jmp    80106a01 <alltraps>
...
801075f5:	6a 00                	push   $0x0
  pushl $52
801075f7:	6a 34                	push   $0x34
  jmp alltraps
801075f9:	e9 03 f4 ff ff       	jmp    80106a01 <alltraps>
...
801075fe:	6a 00                	push   $0x0
  pushl $53
80107600:	6a 35                	push   $0x35
  jmp alltraps
80107602:	e9 fa f3 ff ff       	jmp    80106a01 <alltraps>
...
80107607:	6a 00                	push   $0x0
  pushl $54
80107609:	6a 36                	push   $0x36
  jmp alltraps
8010760b:	e9 f1 f3 ff ff       	jmp    80106a01 <alltraps>
...
80107610:	6a 00                	push   $0x0
  pushl $55
80107612:	6a 37                	push   $0x37
  jmp alltraps
80107614:	e9 e8 f3 ff ff       	jmp    80106a01 <alltraps>
...
80107619:	6a 00                	push   $0x0
  pushl $56
8010761b:	6a 38                	push   $0x38
  jmp alltraps
8010761d:	e9 df f3 ff ff       	jmp    80106a01 <alltraps>
...
80107622:	6a 00                	push   $0x0
  pushl $57
80107624:	6a 39                	push   $0x39
  jmp alltraps
80107626:	e9 d6 f3 ff ff       	jmp    80106a01 <alltraps>
...
8010762b:	6a 00                	push   $0x0
  pushl $58
8010762d:	6a 3a                	push   $0x3a
  jmp alltraps
8010762f:	e9 cd f3 ff ff       	jmp    80106a01 <alltraps>
...
80107634:	6a 00                	push   $0x0
  pushl $59
80107636:	6a 3b                	push   $0x3b
  jmp alltraps
80107638:	e9 c4 f3 ff ff       	jmp    80106a01 <alltraps>
...
8010763d:	6a 00                	push   $0x0
  pushl $60
8010763f:	6a 3c                	push   $0x3c
  jmp alltraps
80107641:	e9 bb f3 ff ff       	jmp    80106a01 <alltraps>
...
80107646:	6a 00                	push   $0x0
  pushl $61
80107648:	6a 3d                	push   $0x3d
  jmp alltraps
8010764a:	e9 b2 f3 ff ff       	jmp    80106a01 <alltraps>
...
8010764f:	6a 00                	push   $0x0
  pushl $62
80107651:	6a 3e                	push   $0x3e
  jmp alltraps
80107653:	e9 a9 f3 ff ff       	jmp    80106a01 <alltraps>
...
80107658:	6a 00                	push   $0x0
  pushl $63
8010765a:	6a 3f                	push   $0x3f
  jmp alltraps
8010765c:	e9 a0 f3 ff ff       	jmp    80106a01 <alltraps>
...
80107663:	6a 40                	push   $0x40
  jmp alltraps
80107665:	e9 97 f3 ff ff       	jmp    80106a01 <alltraps>
...
8010766a:	6a 00                	push   $0x0
  pushl $65
8010766c:	6a 41                	push   $0x41
  jmp alltraps
8010766e:	e9 8e f3 ff ff       	jmp    80106a01 <alltraps>
...
80107673:	6a 00                	push   $0x0
  pushl $66
80107675:	6a 42                	push   $0x42
  jmp alltraps
80107677:	e9 85 f3 ff ff       	jmp    80106a01 <alltraps>
...
8010767c:	6a 00                	push   $0x0
  pushl $67
8010767e:	6a 43                	push   $0x43
  jmp alltraps
80107680:	e9 7c f3 ff ff       	jmp    80106a01 <alltraps>
...
80107685:	6a 00                	push   $0x0
  pushl $68
80107687:	6a 44                	push   $0x44
  jmp alltraps
80107689:	e9 73 f3 ff ff       	jmp    80106a01 <alltraps>
...
8010768e:	6a 00                	push   $0x0
  pushl $69
80107690:	6a 45                	push   $0x45
  jmp alltraps
80107692:	e9 6a f3 ff ff       	jmp    80106a01 <alltraps>
...
80107697:	6a 00                	push   $0x0
  pushl $70
80107699:	6a 46                	push   $0x46
  jmp alltraps
8010769b:	e9 61 f3 ff ff       	jmp    80106a01 <alltraps>
...
801076a0:	6a 00                	push   $0x0
  pushl $71
801076a2:	6a 47                	push   $0x47
  jmp alltraps
801076a4:	e9 58 f3 ff ff       	jmp    80106a01 <alltraps>
...
801076a9:	6a 00                	push   $0x0
  pushl $72
801076ab:	6a 48                	push   $0x48
  jmp alltraps
801076ad:	e9 4f f3 ff ff       	jmp    80106a01 <alltraps>
...
801076b2:	6a 00                	push   $0x0
  pushl $73
801076b4:	6a 49                	push   $0x49
  jmp alltraps
801076b6:	e9 46 f3 ff ff       	jmp    80106a01 <alltraps>
...
801076bb:	6a 00                	push   $0x0
  pushl $74
801076bd:	6a 4a                	push   $0x4a
  jmp alltraps
801076bf:	e9 3d f3 ff ff       	jmp    80106a01 <alltraps>
...
801076c4:	6a 00                	push   $0x0
  pushl $75
801076c6:	6a 4b                	push   $0x4b
  jmp alltraps
801076c8:	e9 34 f3 ff ff       	jmp    80106a01 <alltraps>
...
801076cd:	6a 00                	push   $0x0
  pushl $76
801076cf:	6a 4c                	push   $0x4c
  jmp alltraps
801076d1:	e9 2b f3 ff ff       	jmp    80106a01 <alltraps>
...
801076d6:	6a 00                	push   $0x0
  pushl $77
801076d8:	6a 4d                	push   $0x4d
  jmp alltraps
801076da:	e9 22 f3 ff ff       	jmp    80106a01 <alltraps>
...
801076df:	6a 00                	push   $0x0
  pushl $78
801076e1:	6a 4e                	push   $0x4e
  jmp alltraps
801076e3:	e9 19 f3 ff ff       	jmp    80106a01 <alltraps>
...
801076e8:	6a 00                	push   $0x0
  pushl $79
801076ea:	6a 4f                	push   $0x4f
  jmp alltraps
801076ec:	e9 10 f3 ff ff       	jmp    80106a01 <alltraps>
...
801076f1:	6a 00                	push   $0x0
  pushl $80
801076f3:	6a 50                	push   $0x50
  jmp alltraps
801076f5:	e9 07 f3 ff ff       	jmp    80106a01 <alltraps>
...
801076fa:	6a 00                	push   $0x0
  pushl $81
801076fc:	6a 51                	push   $0x51
  jmp alltraps
801076fe:	e9 fe f2 ff ff       	jmp    80106a01 <alltraps>
...
80107703:	6a 00                	push   $0x0
  pushl $82
80107705:	6a 52                	push   $0x52
  jmp alltraps
80107707:	e9 f5 f2 ff ff       	jmp    80106a01 <alltraps>
...
8010770c:	6a 00                	push   $0x0
  pushl $83
8010770e:	6a 53                	push   $0x53
  jmp alltraps
80107710:	e9 ec f2 ff ff       	jmp    80106a01 <alltraps>
...
80107715:	6a 00                	push   $0x0
  pushl $84
80107717:	6a 54                	push   $0x54
  jmp alltraps
80107719:	e9 e3 f2 ff ff       	jmp    80106a01 <alltraps>
...
8010771e:	6a 00                	push   $0x0
  pushl $85
80107720:	6a 55                	push   $0x55
  jmp alltraps
80107722:	e9 da f2 ff ff       	jmp    80106a01 <alltraps>
...
80107727:	6a 00                	push   $0x0
  pushl $86
80107729:	6a 56                	push   $0x56
  jmp alltraps
8010772b:	e9 d1 f2 ff ff       	jmp    80106a01 <alltraps>
...
80107730:	6a 00                	push   $0x0
  pushl $87
80107732:	6a 57                	push   $0x57
  jmp alltraps
80107734:	e9 c8 f2 ff ff       	jmp    80106a01 <alltraps>
...
80107739:	6a 00                	push   $0x0
  pushl $88
8010773b:	6a 58                	push   $0x58
  jmp alltraps
8010773d:	e9 bf f2 ff ff       	jmp    80106a01 <alltraps>
...
80107742:	6a 00                	push   $0x0
  pushl $89
80107744:	6a 59                	push   $0x59
  jmp alltraps
80107746:	e9 b6 f2 ff ff       	jmp    80106a01 <alltraps>
...
8010774b:	6a 00                	push   $0x0
  pushl $90
8010774d:	6a 5a                	push   $0x5a
  jmp alltraps
8010774f:	e9 ad f2 ff ff       	jmp    80106a01 <alltraps>
...
80107754:	6a 00                	push   $0x0
  pushl $91
80107756:	6a 5b                	push   $0x5b
  jmp alltraps
80107758:	e9 a4 f2 ff ff       	jmp    80106a01 <alltraps>
...
8010775d:	6a 00                	push   $0x0
  pushl $92
8010775f:	6a 5c                	push   $0x5c
  jmp alltraps
80107761:	e9 9b f2 ff ff       	jmp    80106a01 <alltraps>
...
80107766:	6a 00                	push   $0x0
  pushl $93
80107768:	6a 5d                	push   $0x5d
  jmp alltraps
8010776a:	e9 92 f2 ff ff       	jmp    80106a01 <alltraps>
...
8010776f:	6a 00                	push   $0x0
  pushl $94
80107771:	6a 5e                	push   $0x5e
  jmp alltraps
80107773:	e9 89 f2 ff ff       	jmp    80106a01 <alltraps>
...
80107778:	6a 00                	push   $0x0
  pushl $95
8010777a:	6a 5f                	push   $0x5f
  jmp alltraps
8010777c:	e9 80 f2 ff ff       	jmp    80106a01 <alltraps>
...
80107781:	6a 00                	push   $0x0
  pushl $96
80107783:	6a 60                	push   $0x60
  jmp alltraps
80107785:	e9 77 f2 ff ff       	jmp    80106a01 <alltraps>
...
8010778a:	6a 00                	push   $0x0
  pushl $97
8010778c:	6a 61                	push   $0x61
  jmp alltraps
8010778e:	e9 6e f2 ff ff       	jmp    80106a01 <alltraps>
...
80107793:	6a 00                	push   $0x0
  pushl $98
80107795:	6a 62                	push   $0x62
  jmp alltraps
80107797:	e9 65 f2 ff ff       	jmp    80106a01 <alltraps>
...
8010779c:	6a 00                	push   $0x0
  pushl $99
8010779e:	6a 63                	push   $0x63
  jmp alltraps
801077a0:	e9 5c f2 ff ff       	jmp    80106a01 <alltraps>
...
801077a5:	6a 00                	push   $0x0
  pushl $100
801077a7:	6a 64                	push   $0x64
  jmp alltraps
801077a9:	e9 53 f2 ff ff       	jmp    80106a01 <alltraps>
...
801077ae:	6a 00                	push   $0x0
  pushl $101
801077b0:	6a 65                	push   $0x65
  jmp alltraps
801077b2:	e9 4a f2 ff ff       	jmp    80106a01 <alltraps>
...
801077b7:	6a 00                	push   $0x0
  pushl $102
801077b9:	6a 66                	push   $0x66
  jmp alltraps
801077bb:	e9 41 f2 ff ff       	jmp    80106a01 <alltraps>
...
801077c0:	6a 00                	push   $0x0
  pushl $103
801077c2:	6a 67                	push   $0x67
  jmp alltraps
801077c4:	e9 38 f2 ff ff       	jmp    80106a01 <alltraps>
...
801077c9:	6a 00                	push   $0x0
  pushl $104
801077cb:	6a 68                	push   $0x68
  jmp alltraps
801077cd:	e9 2f f2 ff ff       	jmp    80106a01 <alltraps>
...
801077d2:	6a 00                	push   $0x0
  pushl $105
801077d4:	6a 69                	push   $0x69
  jmp alltraps
801077d6:	e9 26 f2 ff ff       	jmp    80106a01 <alltraps>
...
801077db:	6a 00                	push   $0x0
  pushl $106
801077dd:	6a 6a                	push   $0x6a
  jmp alltraps
801077df:	e9 1d f2 ff ff       	jmp    80106a01 <alltraps>
...
801077e4:	6a 00                	push   $0x0
  pushl $107
801077e6:	6a 6b                	push   $0x6b
  jmp alltraps
801077e8:	e9 14 f2 ff ff       	jmp    80106a01 <alltraps>
...
801077ed:	6a 00                	push   $0x0
  pushl $108
801077ef:	6a 6c                	push   $0x6c
  jmp alltraps
801077f1:	e9 0b f2 ff ff       	jmp    80106a01 <alltraps>
...
801077f6:	6a 00                	push   $0x0
  pushl $109
801077f8:	6a 6d                	push   $0x6d
  jmp alltraps
801077fa:	e9 02 f2 ff ff       	jmp    80106a01 <alltraps>
...
801077ff:	6a 00                	push   $0x0
  pushl $110
80107801:	6a 6e                	push   $0x6e
  jmp alltraps
80107803:	e9 f9 f1 ff ff       	jmp    80106a01 <alltraps>
...
80107808:	6a 00                	push   $0x0
  pushl $111
8010780a:	6a 6f                	push   $0x6f
  jmp alltraps
8010780c:	e9 f0 f1 ff ff       	jmp    80106a01 <alltraps>
...
80107811:	6a 00                	push   $0x0
  pushl $112
80107813:	6a 70                	push   $0x70
  jmp alltraps
80107815:	e9 e7 f1 ff ff       	jmp    80106a01 <alltraps>
...
8010781a:	6a 00                	push   $0x0
  pushl $113
8010781c:	6a 71                	push   $0x71
  jmp alltraps
8010781e:	e9 de f1 ff ff       	jmp    80106a01 <alltraps>
...
80107823:	6a 00                	push   $0x0
  pushl $114
80107825:	6a 72                	push   $0x72
  jmp alltraps
80107827:	e9 d5 f1 ff ff       	jmp    80106a01 <alltraps>
...
8010782c:	6a 00                	push   $0x0
  pushl $115
8010782e:	6a 73                	push   $0x73
  jmp alltraps
80107830:	e9 cc f1 ff ff       	jmp    80106a01 <alltraps>
...
80107835:	6a 00                	push   $0x0
  pushl $116
80107837:	6a 74                	push   $0x74
  jmp alltraps
80107839:	e9 c3 f1 ff ff       	jmp    80106a01 <alltraps>
...
8010783e:	6a 00                	push   $0x0
  pushl $117
80107840:	6a 75                	push   $0x75
  jmp alltraps
80107842:	e9 ba f1 ff ff       	jmp    80106a01 <alltraps>
...
80107847:	6a 00                	push   $0x0
  pushl $118
80107849:	6a 76                	push   $0x76
  jmp alltraps
8010784b:	e9 b1 f1 ff ff       	jmp    80106a01 <alltraps>
...
80107850:	6a 00                	push   $0x0
  pushl $119
80107852:	6a 77                	push   $0x77
  jmp alltraps
80107854:	e9 a8 f1 ff ff       	jmp    80106a01 <alltraps>
...
80107859:	6a 00                	push   $0x0
  pushl $120
8010785b:	6a 78                	push   $0x78
  jmp alltraps
8010785d:	e9 9f f1 ff ff       	jmp    80106a01 <alltraps>
...
80107862:	6a 00                	push   $0x0
  pushl $121
80107864:	6a 79                	push   $0x79
  jmp alltraps
80107866:	e9 96 f1 ff ff       	jmp    80106a01 <alltraps>
...
8010786b:	6a 00                	push   $0x0
  pushl $122
8010786d:	6a 7a                	push   $0x7a
  jmp alltraps
8010786f:	e9 8d f1 ff ff       	jmp    80106a01 <alltraps>
...
80107874:	6a 00                	push   $0x0
  pushl $123
80107876:	6a 7b                	push   $0x7b
  jmp alltraps
80107878:	e9 84 f1 ff ff       	jmp    80106a01 <alltraps>
...
8010787d:	6a 00                	push   $0x0
  pushl $124
8010787f:	6a 7c                	push   $0x7c
  jmp alltraps
80107881:	e9 7b f1 ff ff       	jmp    80106a01 <alltraps>
...
80107886:	6a 00                	push   $0x0
  pushl $125
80107888:	6a 7d                	push   $0x7d
  jmp alltraps
8010788a:	e9 72 f1 ff ff       	jmp    80106a01 <alltraps>
...
8010788f:	6a 00                	push   $0x0
  pushl $126
80107891:	6a 7e                	push   $0x7e
  jmp alltraps
80107893:	e9 69 f1 ff ff       	jmp    80106a01 <alltraps>
...
80107898:	6a 00                	push   $0x0
  pushl $127
8010789a:	6a 7f                	push   $0x7f
  jmp alltraps
8010789c:	e9 60 f1 ff ff       	jmp    80106a01 <alltraps>
...
801078a1:	6a 00                	push   $0x0
  pushl $128
801078a3:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801078a8:	e9 54 f1 ff ff       	jmp    80106a01 <alltraps>
...
801078ad:	6a 00                	push   $0x0
  pushl $129
801078af:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801078b4:	e9 48 f1 ff ff       	jmp    80106a01 <alltraps>
...
801078b9:	6a 00                	push   $0x0
  pushl $130
801078bb:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801078c0:	e9 3c f1 ff ff       	jmp    80106a01 <alltraps>
...
801078c5:	6a 00                	push   $0x0
  pushl $131
801078c7:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801078cc:	e9 30 f1 ff ff       	jmp    80106a01 <alltraps>
...
801078d1:	6a 00                	push   $0x0
  pushl $132
801078d3:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801078d8:	e9 24 f1 ff ff       	jmp    80106a01 <alltraps>
...
801078dd:	6a 00                	push   $0x0
  pushl $133
801078df:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801078e4:	e9 18 f1 ff ff       	jmp    80106a01 <alltraps>
...
801078e9:	6a 00                	push   $0x0
  pushl $134
801078eb:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801078f0:	e9 0c f1 ff ff       	jmp    80106a01 <alltraps>
...
801078f5:	6a 00                	push   $0x0
  pushl $135
801078f7:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801078fc:	e9 00 f1 ff ff       	jmp    80106a01 <alltraps>
...
80107901:	6a 00                	push   $0x0
  pushl $136
80107903:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80107908:	e9 f4 f0 ff ff       	jmp    80106a01 <alltraps>
...
8010790d:	6a 00                	push   $0x0
  pushl $137
8010790f:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80107914:	e9 e8 f0 ff ff       	jmp    80106a01 <alltraps>
...
80107919:	6a 00                	push   $0x0
  pushl $138
8010791b:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80107920:	e9 dc f0 ff ff       	jmp    80106a01 <alltraps>
...
80107925:	6a 00                	push   $0x0
  pushl $139
80107927:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
8010792c:	e9 d0 f0 ff ff       	jmp    80106a01 <alltraps>
...
80107931:	6a 00                	push   $0x0
  pushl $140
80107933:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80107938:	e9 c4 f0 ff ff       	jmp    80106a01 <alltraps>
...
8010793d:	6a 00                	push   $0x0
  pushl $141
8010793f:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80107944:	e9 b8 f0 ff ff       	jmp    80106a01 <alltraps>
...
80107949:	6a 00                	push   $0x0
  pushl $142
8010794b:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80107950:	e9 ac f0 ff ff       	jmp    80106a01 <alltraps>
...
80107955:	6a 00                	push   $0x0
  pushl $143
80107957:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
8010795c:	e9 a0 f0 ff ff       	jmp    80106a01 <alltraps>
...
80107961:	6a 00                	push   $0x0
  pushl $144
80107963:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80107968:	e9 94 f0 ff ff       	jmp    80106a01 <alltraps>
...
8010796d:	6a 00                	push   $0x0
  pushl $145
8010796f:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80107974:	e9 88 f0 ff ff       	jmp    80106a01 <alltraps>
...
80107979:	6a 00                	push   $0x0
  pushl $146
8010797b:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80107980:	e9 7c f0 ff ff       	jmp    80106a01 <alltraps>
...
80107985:	6a 00                	push   $0x0
  pushl $147
80107987:	68 93 00 00 00       	push   $0x93
  jmp alltraps
8010798c:	e9 70 f0 ff ff       	jmp    80106a01 <alltraps>
...
80107991:	6a 00                	push   $0x0
  pushl $148
80107993:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80107998:	e9 64 f0 ff ff       	jmp    80106a01 <alltraps>
...
8010799d:	6a 00                	push   $0x0
  pushl $149
8010799f:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801079a4:	e9 58 f0 ff ff       	jmp    80106a01 <alltraps>
...
801079a9:	6a 00                	push   $0x0
  pushl $150
801079ab:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801079b0:	e9 4c f0 ff ff       	jmp    80106a01 <alltraps>
...
801079b5:	6a 00                	push   $0x0
  pushl $151
801079b7:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801079bc:	e9 40 f0 ff ff       	jmp    80106a01 <alltraps>
...
801079c1:	6a 00                	push   $0x0
  pushl $152
801079c3:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801079c8:	e9 34 f0 ff ff       	jmp    80106a01 <alltraps>
...
801079cd:	6a 00                	push   $0x0
  pushl $153
801079cf:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801079d4:	e9 28 f0 ff ff       	jmp    80106a01 <alltraps>
...
801079d9:	6a 00                	push   $0x0
  pushl $154
801079db:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801079e0:	e9 1c f0 ff ff       	jmp    80106a01 <alltraps>
...
801079e5:	6a 00                	push   $0x0
  pushl $155
801079e7:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801079ec:	e9 10 f0 ff ff       	jmp    80106a01 <alltraps>
...
801079f1:	6a 00                	push   $0x0
  pushl $156
801079f3:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801079f8:	e9 04 f0 ff ff       	jmp    80106a01 <alltraps>
...
801079fd:	6a 00                	push   $0x0
  pushl $157
801079ff:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80107a04:	e9 f8 ef ff ff       	jmp    80106a01 <alltraps>
...
80107a09:	6a 00                	push   $0x0
  pushl $158
80107a0b:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80107a10:	e9 ec ef ff ff       	jmp    80106a01 <alltraps>
...
80107a15:	6a 00                	push   $0x0
  pushl $159
80107a17:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80107a1c:	e9 e0 ef ff ff       	jmp    80106a01 <alltraps>
...
80107a21:	6a 00                	push   $0x0
  pushl $160
80107a23:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80107a28:	e9 d4 ef ff ff       	jmp    80106a01 <alltraps>
...
80107a2d:	6a 00                	push   $0x0
  pushl $161
80107a2f:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80107a34:	e9 c8 ef ff ff       	jmp    80106a01 <alltraps>
...
80107a39:	6a 00                	push   $0x0
  pushl $162
80107a3b:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80107a40:	e9 bc ef ff ff       	jmp    80106a01 <alltraps>
...
80107a45:	6a 00                	push   $0x0
  pushl $163
80107a47:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80107a4c:	e9 b0 ef ff ff       	jmp    80106a01 <alltraps>
...
80107a51:	6a 00                	push   $0x0
  pushl $164
80107a53:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80107a58:	e9 a4 ef ff ff       	jmp    80106a01 <alltraps>
...
80107a5d:	6a 00                	push   $0x0
  pushl $165
80107a5f:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80107a64:	e9 98 ef ff ff       	jmp    80106a01 <alltraps>
...
80107a69:	6a 00                	push   $0x0
  pushl $166
80107a6b:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80107a70:	e9 8c ef ff ff       	jmp    80106a01 <alltraps>
...
80107a75:	6a 00                	push   $0x0
  pushl $167
80107a77:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80107a7c:	e9 80 ef ff ff       	jmp    80106a01 <alltraps>
...
80107a81:	6a 00                	push   $0x0
  pushl $168
80107a83:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80107a88:	e9 74 ef ff ff       	jmp    80106a01 <alltraps>
...
80107a8d:	6a 00                	push   $0x0
  pushl $169
80107a8f:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80107a94:	e9 68 ef ff ff       	jmp    80106a01 <alltraps>
...
80107a99:	6a 00                	push   $0x0
  pushl $170
80107a9b:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80107aa0:	e9 5c ef ff ff       	jmp    80106a01 <alltraps>
...
80107aa5:	6a 00                	push   $0x0
  pushl $171
80107aa7:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80107aac:	e9 50 ef ff ff       	jmp    80106a01 <alltraps>
...
80107ab1:	6a 00                	push   $0x0
  pushl $172
80107ab3:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80107ab8:	e9 44 ef ff ff       	jmp    80106a01 <alltraps>
...
80107abd:	6a 00                	push   $0x0
  pushl $173
80107abf:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80107ac4:	e9 38 ef ff ff       	jmp    80106a01 <alltraps>
...
80107ac9:	6a 00                	push   $0x0
  pushl $174
80107acb:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80107ad0:	e9 2c ef ff ff       	jmp    80106a01 <alltraps>
...
80107ad5:	6a 00                	push   $0x0
  pushl $175
80107ad7:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80107adc:	e9 20 ef ff ff       	jmp    80106a01 <alltraps>
...
80107ae1:	6a 00                	push   $0x0
  pushl $176
80107ae3:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80107ae8:	e9 14 ef ff ff       	jmp    80106a01 <alltraps>
...
80107aed:	6a 00                	push   $0x0
  pushl $177
80107aef:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80107af4:	e9 08 ef ff ff       	jmp    80106a01 <alltraps>
...
80107af9:	6a 00                	push   $0x0
  pushl $178
80107afb:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80107b00:	e9 fc ee ff ff       	jmp    80106a01 <alltraps>
...
80107b05:	6a 00                	push   $0x0
  pushl $179
80107b07:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80107b0c:	e9 f0 ee ff ff       	jmp    80106a01 <alltraps>
...
80107b11:	6a 00                	push   $0x0
  pushl $180
80107b13:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80107b18:	e9 e4 ee ff ff       	jmp    80106a01 <alltraps>
...
80107b1d:	6a 00                	push   $0x0
  pushl $181
80107b1f:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80107b24:	e9 d8 ee ff ff       	jmp    80106a01 <alltraps>
...
80107b29:	6a 00                	push   $0x0
  pushl $182
80107b2b:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80107b30:	e9 cc ee ff ff       	jmp    80106a01 <alltraps>
...
80107b35:	6a 00                	push   $0x0
  pushl $183
80107b37:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80107b3c:	e9 c0 ee ff ff       	jmp    80106a01 <alltraps>
...
80107b41:	6a 00                	push   $0x0
  pushl $184
80107b43:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80107b48:	e9 b4 ee ff ff       	jmp    80106a01 <alltraps>
...
80107b4d:	6a 00                	push   $0x0
  pushl $185
80107b4f:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80107b54:	e9 a8 ee ff ff       	jmp    80106a01 <alltraps>
...
80107b59:	6a 00                	push   $0x0
  pushl $186
80107b5b:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80107b60:	e9 9c ee ff ff       	jmp    80106a01 <alltraps>
...
80107b65:	6a 00                	push   $0x0
  pushl $187
80107b67:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80107b6c:	e9 90 ee ff ff       	jmp    80106a01 <alltraps>
...
80107b71:	6a 00                	push   $0x0
  pushl $188
80107b73:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80107b78:	e9 84 ee ff ff       	jmp    80106a01 <alltraps>
...
80107b7d:	6a 00                	push   $0x0
  pushl $189
80107b7f:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80107b84:	e9 78 ee ff ff       	jmp    80106a01 <alltraps>
...
80107b89:	6a 00                	push   $0x0
  pushl $190
80107b8b:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80107b90:	e9 6c ee ff ff       	jmp    80106a01 <alltraps>
...
80107b95:	6a 00                	push   $0x0
  pushl $191
80107b97:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80107b9c:	e9 60 ee ff ff       	jmp    80106a01 <alltraps>
...
80107ba1:	6a 00                	push   $0x0
  pushl $192
80107ba3:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80107ba8:	e9 54 ee ff ff       	jmp    80106a01 <alltraps>
...
80107bad:	6a 00                	push   $0x0
  pushl $193
80107baf:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80107bb4:	e9 48 ee ff ff       	jmp    80106a01 <alltraps>
...
80107bb9:	6a 00                	push   $0x0
  pushl $194
80107bbb:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80107bc0:	e9 3c ee ff ff       	jmp    80106a01 <alltraps>
...
80107bc5:	6a 00                	push   $0x0
  pushl $195
80107bc7:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80107bcc:	e9 30 ee ff ff       	jmp    80106a01 <alltraps>
...
80107bd1:	6a 00                	push   $0x0
  pushl $196
80107bd3:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80107bd8:	e9 24 ee ff ff       	jmp    80106a01 <alltraps>
...
80107bdd:	6a 00                	push   $0x0
  pushl $197
80107bdf:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80107be4:	e9 18 ee ff ff       	jmp    80106a01 <alltraps>
...
80107be9:	6a 00                	push   $0x0
  pushl $198
80107beb:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80107bf0:	e9 0c ee ff ff       	jmp    80106a01 <alltraps>
...
80107bf5:	6a 00                	push   $0x0
  pushl $199
80107bf7:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80107bfc:	e9 00 ee ff ff       	jmp    80106a01 <alltraps>
...
80107c01:	6a 00                	push   $0x0
  pushl $200
80107c03:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80107c08:	e9 f4 ed ff ff       	jmp    80106a01 <alltraps>
...
80107c0d:	6a 00                	push   $0x0
  pushl $201
80107c0f:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80107c14:	e9 e8 ed ff ff       	jmp    80106a01 <alltraps>
...
80107c19:	6a 00                	push   $0x0
  pushl $202
80107c1b:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80107c20:	e9 dc ed ff ff       	jmp    80106a01 <alltraps>
...
80107c25:	6a 00                	push   $0x0
  pushl $203
80107c27:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80107c2c:	e9 d0 ed ff ff       	jmp    80106a01 <alltraps>
...
80107c31:	6a 00                	push   $0x0
  pushl $204
80107c33:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80107c38:	e9 c4 ed ff ff       	jmp    80106a01 <alltraps>
...
80107c3d:	6a 00                	push   $0x0
  pushl $205
80107c3f:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80107c44:	e9 b8 ed ff ff       	jmp    80106a01 <alltraps>
...
80107c49:	6a 00                	push   $0x0
  pushl $206
80107c4b:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80107c50:	e9 ac ed ff ff       	jmp    80106a01 <alltraps>
...
80107c55:	6a 00                	push   $0x0
  pushl $207
80107c57:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80107c5c:	e9 a0 ed ff ff       	jmp    80106a01 <alltraps>
...
80107c61:	6a 00                	push   $0x0
  pushl $208
80107c63:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80107c68:	e9 94 ed ff ff       	jmp    80106a01 <alltraps>
...
80107c6d:	6a 00                	push   $0x0
  pushl $209
80107c6f:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80107c74:	e9 88 ed ff ff       	jmp    80106a01 <alltraps>
...
80107c79:	6a 00                	push   $0x0
  pushl $210
80107c7b:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80107c80:	e9 7c ed ff ff       	jmp    80106a01 <alltraps>
...
80107c85:	6a 00                	push   $0x0
  pushl $211
80107c87:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80107c8c:	e9 70 ed ff ff       	jmp    80106a01 <alltraps>
...
80107c91:	6a 00                	push   $0x0
  pushl $212
80107c93:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80107c98:	e9 64 ed ff ff       	jmp    80106a01 <alltraps>
...
80107c9d:	6a 00                	push   $0x0
  pushl $213
80107c9f:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80107ca4:	e9 58 ed ff ff       	jmp    80106a01 <alltraps>
...
80107ca9:	6a 00                	push   $0x0
  pushl $214
80107cab:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80107cb0:	e9 4c ed ff ff       	jmp    80106a01 <alltraps>
...
80107cb5:	6a 00                	push   $0x0
  pushl $215
80107cb7:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80107cbc:	e9 40 ed ff ff       	jmp    80106a01 <alltraps>
...
80107cc1:	6a 00                	push   $0x0
  pushl $216
80107cc3:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80107cc8:	e9 34 ed ff ff       	jmp    80106a01 <alltraps>
...
80107ccd:	6a 00                	push   $0x0
  pushl $217
80107ccf:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80107cd4:	e9 28 ed ff ff       	jmp    80106a01 <alltraps>
...
80107cd9:	6a 00                	push   $0x0
  pushl $218
80107cdb:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80107ce0:	e9 1c ed ff ff       	jmp    80106a01 <alltraps>
...
80107ce5:	6a 00                	push   $0x0
  pushl $219
80107ce7:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80107cec:	e9 10 ed ff ff       	jmp    80106a01 <alltraps>
...
80107cf1:	6a 00                	push   $0x0
  pushl $220
80107cf3:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80107cf8:	e9 04 ed ff ff       	jmp    80106a01 <alltraps>
...
80107cfd:	6a 00                	push   $0x0
  pushl $221
80107cff:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80107d04:	e9 f8 ec ff ff       	jmp    80106a01 <alltraps>
...
80107d09:	6a 00                	push   $0x0
  pushl $222
80107d0b:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80107d10:	e9 ec ec ff ff       	jmp    80106a01 <alltraps>
...
80107d15:	6a 00                	push   $0x0
  pushl $223
80107d17:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80107d1c:	e9 e0 ec ff ff       	jmp    80106a01 <alltraps>
...
80107d21:	6a 00                	push   $0x0
  pushl $224
80107d23:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80107d28:	e9 d4 ec ff ff       	jmp    80106a01 <alltraps>
...
80107d2d:	6a 00                	push   $0x0
  pushl $225
80107d2f:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80107d34:	e9 c8 ec ff ff       	jmp    80106a01 <alltraps>
...
80107d39:	6a 00                	push   $0x0
  pushl $226
80107d3b:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80107d40:	e9 bc ec ff ff       	jmp    80106a01 <alltraps>
...
80107d45:	6a 00                	push   $0x0
  pushl $227
80107d47:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80107d4c:	e9 b0 ec ff ff       	jmp    80106a01 <alltraps>
...
80107d51:	6a 00                	push   $0x0
  pushl $228
80107d53:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80107d58:	e9 a4 ec ff ff       	jmp    80106a01 <alltraps>
...
80107d5d:	6a 00                	push   $0x0
  pushl $229
80107d5f:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80107d64:	e9 98 ec ff ff       	jmp    80106a01 <alltraps>
...
80107d69:	6a 00                	push   $0x0
  pushl $230
80107d6b:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80107d70:	e9 8c ec ff ff       	jmp    80106a01 <alltraps>
...
80107d75:	6a 00                	push   $0x0
  pushl $231
80107d77:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80107d7c:	e9 80 ec ff ff       	jmp    80106a01 <alltraps>
...
80107d81:	6a 00                	push   $0x0
  pushl $232
80107d83:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80107d88:	e9 74 ec ff ff       	jmp    80106a01 <alltraps>
...
80107d8d:	6a 00                	push   $0x0
  pushl $233
80107d8f:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80107d94:	e9 68 ec ff ff       	jmp    80106a01 <alltraps>
...
80107d99:	6a 00                	push   $0x0
  pushl $234
80107d9b:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80107da0:	e9 5c ec ff ff       	jmp    80106a01 <alltraps>
...
80107da5:	6a 00                	push   $0x0
  pushl $235
80107da7:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80107dac:	e9 50 ec ff ff       	jmp    80106a01 <alltraps>
...
80107db1:	6a 00                	push   $0x0
  pushl $236
80107db3:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80107db8:	e9 44 ec ff ff       	jmp    80106a01 <alltraps>
...
80107dbd:	6a 00                	push   $0x0
  pushl $237
80107dbf:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80107dc4:	e9 38 ec ff ff       	jmp    80106a01 <alltraps>
...
80107dc9:	6a 00                	push   $0x0
  pushl $238
80107dcb:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80107dd0:	e9 2c ec ff ff       	jmp    80106a01 <alltraps>
...
80107dd5:	6a 00                	push   $0x0
  pushl $239
80107dd7:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80107ddc:	e9 20 ec ff ff       	jmp    80106a01 <alltraps>
...
80107de1:	6a 00                	push   $0x0
  pushl $240
80107de3:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80107de8:	e9 14 ec ff ff       	jmp    80106a01 <alltraps>
...
80107ded:	6a 00                	push   $0x0
  pushl $241
80107def:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80107df4:	e9 08 ec ff ff       	jmp    80106a01 <alltraps>
...
80107df9:	6a 00                	push   $0x0
  pushl $242
80107dfb:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80107e00:	e9 fc eb ff ff       	jmp    80106a01 <alltraps>
...
80107e05:	6a 00                	push   $0x0
  pushl $243
80107e07:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80107e0c:	e9 f0 eb ff ff       	jmp    80106a01 <alltraps>
...
80107e11:	6a 00                	push   $0x0
  pushl $244
80107e13:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80107e18:	e9 e4 eb ff ff       	jmp    80106a01 <alltraps>
...
80107e1d:	6a 00                	push   $0x0
  pushl $245
80107e1f:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80107e24:	e9 d8 eb ff ff       	jmp    80106a01 <alltraps>
...
80107e29:	6a 00                	push   $0x0
  pushl $246
80107e2b:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80107e30:	e9 cc eb ff ff       	jmp    80106a01 <alltraps>
...
80107e35:	6a 00                	push   $0x0
  pushl $247
80107e37:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80107e3c:	e9 c0 eb ff ff       	jmp    80106a01 <alltraps>
...
80107e41:	6a 00                	push   $0x0
  pushl $248
80107e43:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80107e48:	e9 b4 eb ff ff       	jmp    80106a01 <alltraps>
...
80107e4d:	6a 00                	push   $0x0
  pushl $249
80107e4f:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80107e54:	e9 a8 eb ff ff       	jmp    80106a01 <alltraps>
...
80107e59:	6a 00                	push   $0x0
  pushl $250
80107e5b:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80107e60:	e9 9c eb ff ff       	jmp    80106a01 <alltraps>
...
80107e65:	6a 00                	push   $0x0
  pushl $251
80107e67:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80107e6c:	e9 90 eb ff ff       	jmp    80106a01 <alltraps>
...
80107e71:	6a 00                	push   $0x0
  pushl $252
80107e73:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80107e78:	e9 84 eb ff ff       	jmp    80106a01 <alltraps>
...
80107e7d:	6a 00                	push   $0x0
  pushl $253
80107e7f:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80107e84:	e9 78 eb ff ff       	jmp    80106a01 <alltraps>
...
80107e89:	6a 00                	push   $0x0
  pushl $254
80107e8b:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80107e90:	e9 6c eb ff ff       	jmp    80106a01 <alltraps>
...
80107e95:	6a 00                	push   $0x0
  pushl $255
80107e97:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80107e9c:	e9 60 eb ff ff       	jmp    80106a01 <alltraps>
...
80107ed3:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("ltr %0" : : "r" (sel));
80107ed7:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
...
80107ee9:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("movw %0, %%gs" : : "r" (v));
80107eed:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
80107ef1:	8e e8                	mov    %eax,%gs
}
80107ef3:	c9                   	leave  
80107ef4:	c3                   	ret    
...
80107f06:	05 00 00 00 80       	add    $0x80000000,%eax
80107f0b:	5d                   	pop    %ebp
80107f0c:	c3                   	ret    
...
80107f1e:	83 ec 24             	sub    $0x24,%esp
  ...
  c = &cpus[cpunum()];
80107f21:	e8 52 af ff ff       	call   80102e78 <cpunum>
80107f26:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
80107f2c:	05 80 33 11 80       	add    $0x80113380,%eax
80107f31:	89 45 f4             	mov    %eax,-0xc(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80107f34:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f37:	66 c7 40 78 ff ff    	movw   $0xffff,0x78(%eax)
80107f3d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f40:	66 c7 40 7a 00 00    	movw   $0x0,0x7a(%eax)
80107f46:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f49:	c6 40 7c 00          	movb   $0x0,0x7c(%eax)
80107f4d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f50:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107f54:	83 e2 f0             	and    $0xfffffff0,%edx
80107f57:	83 ca 0a             	or     $0xa,%edx
80107f5a:	88 50 7d             	mov    %dl,0x7d(%eax)
80107f5d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f60:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107f64:	83 ca 10             	or     $0x10,%edx
80107f67:	88 50 7d             	mov    %dl,0x7d(%eax)
80107f6a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f6d:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107f71:	83 e2 9f             	and    $0xffffff9f,%edx
80107f74:	88 50 7d             	mov    %dl,0x7d(%eax)
80107f77:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f7a:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107f7e:	83 ca 80             	or     $0xffffff80,%edx
80107f81:	88 50 7d             	mov    %dl,0x7d(%eax)
80107f84:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f87:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80107f8b:	83 ca 0f             	or     $0xf,%edx
80107f8e:	88 50 7e             	mov    %dl,0x7e(%eax)
80107f91:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f94:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80107f98:	83 e2 ef             	and    $0xffffffef,%edx
80107f9b:	88 50 7e             	mov    %dl,0x7e(%eax)
80107f9e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fa1:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80107fa5:	83 e2 df             	and    $0xffffffdf,%edx
80107fa8:	88 50 7e             	mov    %dl,0x7e(%eax)
80107fab:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fae:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80107fb2:	83 ca 40             	or     $0x40,%edx
...
80107ff8:	83 e2 f0             	and    $0xfffffff0,%edx
80107ffb:	83 ca 02             	or     $0x2,%edx
80107ffe:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80108004:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108007:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
8010800e:	83 ca 10             	or     $0x10,%edx
...
80108021:	83 e2 9f             	and    $0xffffff9f,%edx
...
80108034:	83 ca 80             	or     $0xffffff80,%edx
80108037:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
8010803d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108040:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80108047:	83 ca 0f             	or     $0xf,%edx
8010804a:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80108050:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108053:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
8010805a:	83 e2 ef             	and    $0xffffffef,%edx
...
8010806d:	83 e2 df             	and    $0xffffffdf,%edx
...
8010809f:	c6 80 87 00 00 00 00 	movb   $0x0,0x87(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801080a6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080a9:	66 c7 80 90 00 00 00 	movw   $0xffff,0x90(%eax)
801080b0:	ff ff 
801080b2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080b5:	66 c7 80 92 00 00 00 	movw   $0x0,0x92(%eax)
801080bc:	00 00 
801080be:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080c1:	c6 80 94 00 00 00 00 	movb   $0x0,0x94(%eax)
801080c8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080cb:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
801080d2:	83 e2 f0             	and    $0xfffffff0,%edx
801080d5:	83 ca 0a             	or     $0xa,%edx
801080d8:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
801080de:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080e1:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
...
8010811a:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80108121:	83 ca 0f             	or     $0xf,%edx
80108124:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
...
80108179:	c6 80 97 00 00 00 00 	movb   $0x0,0x97(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80108180:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108183:	66 c7 80 98 00 00 00 	movw   $0xffff,0x98(%eax)
8010818a:	ff ff 
8010818c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010818f:	66 c7 80 9a 00 00 00 	movw   $0x0,0x9a(%eax)
80108196:	00 00 
80108198:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010819b:	c6 80 9c 00 00 00 00 	movb   $0x0,0x9c(%eax)
801081a2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081a5:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
801081ac:	83 e2 f0             	and    $0xfffffff0,%edx
801081af:	83 ca 02             	or     $0x2,%edx
801081b2:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
801081b8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081bb:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
...
801081f4:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
801081fb:	83 ca 0f             	or     $0xf,%edx
801081fe:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
...
80108253:	c6 80 9f 00 00 00 00 	movb   $0x0,0x9f(%eax)

  // Map cpu, and curproc
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
8010825a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010825d:	05 b4 00 00 00       	add    $0xb4,%eax
80108262:	89 c3                	mov    %eax,%ebx
80108264:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108267:	05 b4 00 00 00       	add    $0xb4,%eax
8010826c:	c1 e8 10             	shr    $0x10,%eax
8010826f:	89 c1                	mov    %eax,%ecx
80108271:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108274:	05 b4 00 00 00       	add    $0xb4,%eax
80108279:	c1 e8 18             	shr    $0x18,%eax
8010827c:	89 c2                	mov    %eax,%edx
8010827e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108281:	66 c7 80 88 00 00 00 	movw   $0x0,0x88(%eax)
80108288:	00 00 
8010828a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010828d:	66 89 98 8a 00 00 00 	mov    %bx,0x8a(%eax)
80108294:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108297:	88 88 8c 00 00 00    	mov    %cl,0x8c(%eax)
8010829d:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082a0:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
801082a7:	83 e1 f0             	and    $0xfffffff0,%ecx
801082aa:	83 c9 02             	or     $0x2,%ecx
801082ad:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
801082b3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082b6:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
801082bd:	83 c9 10             	or     $0x10,%ecx
801082c0:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
801082c6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082c9:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
801082d0:	83 e1 9f             	and    $0xffffff9f,%ecx
801082d3:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
801082d9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082dc:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
801082e3:	83 c9 80             	or     $0xffffff80,%ecx
801082e6:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
801082ec:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082ef:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
801082f6:	83 e1 f0             	and    $0xfffffff0,%ecx
801082f9:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
801082ff:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108302:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80108309:	83 e1 ef             	and    $0xffffffef,%ecx
8010830c:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80108312:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108315:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
8010831c:	83 e1 df             	and    $0xffffffdf,%ecx
8010831f:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80108325:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108328:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
8010832f:	83 c9 40             	or     $0x40,%ecx
80108332:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80108338:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010833b:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80108342:	83 c9 80             	or     $0xffffff80,%ecx
80108345:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
8010834b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010834e:	88 90 8f 00 00 00    	mov    %dl,0x8f(%eax)

  lgdt(c->gdt, sizeof(c->gdt));
80108354:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108357:	83 c0 70             	add    $0x70,%eax
8010835a:	c7 44 24 04 38 00 00 	movl   $0x38,0x4(%esp)
80108361:	00 
80108362:	89 04 24             	mov    %eax,(%esp)
80108365:	e8 37 fb ff ff       	call   80107ea1 <lgdt>
  loadgs(SEG_KCPU << 3);
8010836a:	c7 04 24 18 00 00 00 	movl   $0x18,(%esp)
80108371:	e8 6a fb ff ff       	call   80107ee0 <loadgs>
  
  // Initialize cpu-local storage.
  cpu = c;
80108376:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108379:	65 a3 00 00 00 00    	mov    %eax,%gs:0x0
  proc = 0;
8010837f:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
80108386:	00 00 00 00 
}
8010838a:	83 c4 24             	add    $0x24,%esp
8010838d:	5b                   	pop    %ebx
8010838e:	5d                   	pop    %ebp
8010838f:	c3                   	ret    
...
80108399:	c1 e8 16             	shr    $0x16,%eax
8010839c:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
...
801083b0:	83 e0 01             	and    $0x1,%eax
801083b3:	85 c0                	test   %eax,%eax
801083b5:	74 17                	je     801083ce <walkpgdir+0x3e>
...
801083c4:	e8 44 fb ff ff       	call   80107f0d <p2v>
801083c9:	89 45 f4             	mov    %eax,-0xc(%ebp)
801083cc:	eb 4b                	jmp    80108419 <walkpgdir+0x89>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
801083ce:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801083d2:	74 0e                	je     801083e2 <walkpgdir+0x52>
801083d4:	e8 09 a7 ff ff       	call   80102ae2 <kalloc>
801083d9:	89 45 f4             	mov    %eax,-0xc(%ebp)
801083dc:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801083e0:	75 07                	jne    801083e9 <walkpgdir+0x59>
      return 0;
801083e2:	b8 00 00 00 00       	mov    $0x0,%eax
801083e7:	eb 47                	jmp    80108430 <walkpgdir+0xa0>
    // Make sure all those PTE_P bits are zero.
    memset(pgtab, 0, PGSIZE);
801083e9:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801083f0:	00 
801083f1:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801083f8:	00 
801083f9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801083fc:	89 04 24             	mov    %eax,(%esp)
801083ff:	e8 d2 d0 ff ff       	call   801054d6 <memset>
...
8010840a:	e8 f1 fa ff ff       	call   80107f00 <v2p>
8010840f:	83 c8 07             	or     $0x7,%eax
80108412:	89 c2                	mov    %eax,%edx
80108414:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108417:	89 10                	mov    %edx,(%eax)
  }
  return &pgtab[PTX(va)];
80108419:	8b 45 0c             	mov    0xc(%ebp),%eax
8010841c:	c1 e8 0c             	shr    $0xc,%eax
8010841f:	25 ff 03 00 00       	and    $0x3ff,%eax
80108424:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
8010842b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010842e:	01 d0                	add    %edx,%eax
}
80108430:	c9                   	leave  
80108431:	c3                   	ret    
...
80108435:	83 ec 28             	sub    $0x28,%esp
  char *a, *last;
  pte_t *pte;
...
80108446:	8b 45 10             	mov    0x10(%ebp),%eax
80108449:	01 d0                	add    %edx,%eax
8010844b:	83 e8 01             	sub    $0x1,%eax
8010844e:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108453:	89 45 f0             	mov    %eax,-0x10(%ebp)
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80108456:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
8010845d:	00 
...
8010846b:	e8 20 ff ff ff       	call   80108390 <walkpgdir>
80108470:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108473:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108477:	75 07                	jne    80108480 <mappages+0x4e>
      return -1;
80108479:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010847e:	eb 48                	jmp    801084c8 <mappages+0x96>
    if(*pte & PTE_P)
80108480:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108483:	8b 00                	mov    (%eax),%eax
80108485:	83 e0 01             	and    $0x1,%eax
80108488:	85 c0                	test   %eax,%eax
8010848a:	74 0c                	je     80108498 <mappages+0x66>
      panic("remap");
8010848c:	c7 04 24 d4 92 10 80 	movl   $0x801092d4,(%esp)
80108493:	e8 a2 80 ff ff       	call   8010053a <panic>
    *pte = pa | perm | PTE_P;
80108498:	8b 45 18             	mov    0x18(%ebp),%eax
8010849b:	0b 45 14             	or     0x14(%ebp),%eax
8010849e:	83 c8 01             	or     $0x1,%eax
801084a1:	89 c2                	mov    %eax,%edx
801084a3:	8b 45 ec             	mov    -0x14(%ebp),%eax
801084a6:	89 10                	mov    %edx,(%eax)
    if(a == last)
801084a8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801084ab:	3b 45 f0             	cmp    -0x10(%ebp),%eax
801084ae:	75 08                	jne    801084b8 <mappages+0x86>
      break;
801084b0:	90                   	nop
    a += PGSIZE;
    pa += PGSIZE;
...
801084b6:	eb 10                	jmp    801084c8 <mappages+0x96>
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
    if(a == last)
...
801084c6:	eb 8e                	jmp    80108456 <mappages+0x24>
  return 0;
}
801084c8:	c9                   	leave  
801084c9:	c3                   	ret    
...
801084ce:	83 ec 34             	sub    $0x34,%esp
  pde_t *pgdir;
  struct kmap *k;
...
801084dd:	75 0a                	jne    801084e9 <setupkvm+0x1f>
    return 0;
801084df:	b8 00 00 00 00       	mov    $0x0,%eax
801084e4:	e9 98 00 00 00       	jmp    80108581 <setupkvm+0xb7>
  memset(pgdir, 0, PGSIZE);
801084e9:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801084f0:	00 
801084f1:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801084f8:	00 
801084f9:	8b 45 f0             	mov    -0x10(%ebp),%eax
801084fc:	89 04 24             	mov    %eax,(%esp)
801084ff:	e8 d2 cf ff ff       	call   801054d6 <memset>
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
80108504:	c7 04 24 00 00 00 0e 	movl   $0xe000000,(%esp)
8010850b:	e8 fd f9 ff ff       	call   80107f0d <p2v>
80108510:	3d 00 00 00 fe       	cmp    $0xfe000000,%eax
80108515:	76 0c                	jbe    80108523 <setupkvm+0x59>
    panic("PHYSTOP too high");
80108517:	c7 04 24 da 92 10 80 	movl   $0x801092da,(%esp)
8010851e:	e8 17 80 ff ff       	call   8010053a <panic>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80108523:	c7 45 f4 c0 c4 10 80 	movl   $0x8010c4c0,-0xc(%ebp)
8010852a:	eb 49                	jmp    80108575 <setupkvm+0xab>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
8010852c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010852f:	8b 48 0c             	mov    0xc(%eax),%ecx
80108532:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108535:	8b 50 04             	mov    0x4(%eax),%edx
80108538:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010853b:	8b 58 08             	mov    0x8(%eax),%ebx
8010853e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108541:	8b 40 04             	mov    0x4(%eax),%eax
80108544:	29 c3                	sub    %eax,%ebx
80108546:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108549:	8b 00                	mov    (%eax),%eax
8010854b:	89 4c 24 10          	mov    %ecx,0x10(%esp)
8010854f:	89 54 24 0c          	mov    %edx,0xc(%esp)
80108553:	89 5c 24 08          	mov    %ebx,0x8(%esp)
80108557:	89 44 24 04          	mov    %eax,0x4(%esp)
8010855b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010855e:	89 04 24             	mov    %eax,(%esp)
80108561:	e8 cc fe ff ff       	call   80108432 <mappages>
80108566:	85 c0                	test   %eax,%eax
80108568:	79 07                	jns    80108571 <setupkvm+0xa7>
                (uint)k->phys_start, k->perm) < 0)
      return 0;
8010856a:	b8 00 00 00 00       	mov    $0x0,%eax
8010856f:	eb 10                	jmp    80108581 <setupkvm+0xb7>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80108571:	83 45 f4 10          	addl   $0x10,-0xc(%ebp)
80108575:	81 7d f4 00 c5 10 80 	cmpl   $0x8010c500,-0xc(%ebp)
8010857c:	72 ae                	jb     8010852c <setupkvm+0x62>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
                (uint)k->phys_start, k->perm) < 0)
      return 0;
  return pgdir;
...
80108581:	83 c4 34             	add    $0x34,%esp
80108584:	5b                   	pop    %ebx
80108585:	5d                   	pop    %ebp
80108586:	c3                   	ret    
...
kvmalloc(void)
{
80108587:	55                   	push   %ebp
80108588:	89 e5                	mov    %esp,%ebp
8010858a:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
8010858d:	e8 38 ff ff ff       	call   801084ca <setupkvm>
80108592:	a3 58 8b 11 80       	mov    %eax,0x80118b58
  switchkvm();
80108597:	e8 02 00 00 00       	call   8010859e <switchkvm>
}
8010859c:	c9                   	leave  
8010859d:	c3                   	ret    
...
801085a4:	a1 58 8b 11 80       	mov    0x80118b58,%eax
801085a9:	89 04 24             	mov    %eax,(%esp)
801085ac:	e8 4f f9 ff ff       	call   80107f00 <v2p>
801085b1:	89 04 24             	mov    %eax,(%esp)
801085b4:	e8 3c f9 ff ff       	call   80107ef5 <lcr3>
}
801085b9:	c9                   	leave  
801085ba:	c3                   	ret    
...
801085bf:	83 ec 14             	sub    $0x14,%esp
  pushcli();
801085c2:	e8 0f ce ff ff       	call   801053d6 <pushcli>
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
801085c7:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801085cd:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
801085d4:	83 c2 08             	add    $0x8,%edx
801085d7:	89 d3                	mov    %edx,%ebx
801085d9:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
801085e0:	83 c2 08             	add    $0x8,%edx
801085e3:	c1 ea 10             	shr    $0x10,%edx
801085e6:	89 d1                	mov    %edx,%ecx
801085e8:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
801085ef:	83 c2 08             	add    $0x8,%edx
801085f2:	c1 ea 18             	shr    $0x18,%edx
801085f5:	66 c7 80 a0 00 00 00 	movw   $0x67,0xa0(%eax)
801085fc:	67 00 
801085fe:	66 89 98 a2 00 00 00 	mov    %bx,0xa2(%eax)
80108605:	88 88 a4 00 00 00    	mov    %cl,0xa4(%eax)
8010860b:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80108612:	83 e1 f0             	and    $0xfffffff0,%ecx
80108615:	83 c9 09             	or     $0x9,%ecx
80108618:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
8010861e:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80108625:	83 c9 10             	or     $0x10,%ecx
80108628:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
8010862e:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80108635:	83 e1 9f             	and    $0xffffff9f,%ecx
80108638:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
8010863e:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80108645:	83 c9 80             	or     $0xffffff80,%ecx
80108648:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
8010864e:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80108655:	83 e1 f0             	and    $0xfffffff0,%ecx
80108658:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
8010865e:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80108665:	83 e1 ef             	and    $0xffffffef,%ecx
80108668:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
8010866e:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80108675:	83 e1 df             	and    $0xffffffdf,%ecx
80108678:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
8010867e:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80108685:	83 c9 40             	or     $0x40,%ecx
80108688:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
8010868e:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80108695:	83 e1 7f             	and    $0x7f,%ecx
80108698:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
8010869e:	88 90 a7 00 00 00    	mov    %dl,0xa7(%eax)
  cpu->gdt[SEG_TSS].s = 0;
801086a4:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801086aa:	0f b6 90 a5 00 00 00 	movzbl 0xa5(%eax),%edx
801086b1:	83 e2 ef             	and    $0xffffffef,%edx
801086b4:	88 90 a5 00 00 00    	mov    %dl,0xa5(%eax)
  cpu->ts.ss0 = SEG_KDATA << 3;
801086ba:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801086c0:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
801086c6:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801086cc:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
801086d3:	8b 52 08             	mov    0x8(%edx),%edx
801086d6:	81 c2 00 10 00 00    	add    $0x1000,%edx
801086dc:	89 50 0c             	mov    %edx,0xc(%eax)
  ltr(SEG_TSS << 3);
801086df:	c7 04 24 30 00 00 00 	movl   $0x30,(%esp)
801086e6:	e8 df f7 ff ff       	call   80107eca <ltr>
  if(p->pgdir == 0)
801086eb:	8b 45 08             	mov    0x8(%ebp),%eax
801086ee:	8b 40 04             	mov    0x4(%eax),%eax
801086f1:	85 c0                	test   %eax,%eax
801086f3:	75 0c                	jne    80108701 <switchuvm+0x146>
    panic("switchuvm: no pgdir");
801086f5:	c7 04 24 eb 92 10 80 	movl   $0x801092eb,(%esp)
801086fc:	e8 39 7e ff ff       	call   8010053a <panic>
  lcr3(v2p(p->pgdir));  // switch to new address space
80108701:	8b 45 08             	mov    0x8(%ebp),%eax
80108704:	8b 40 04             	mov    0x4(%eax),%eax
80108707:	89 04 24             	mov    %eax,(%esp)
8010870a:	e8 f1 f7 ff ff       	call   80107f00 <v2p>
8010870f:	89 04 24             	mov    %eax,(%esp)
80108712:	e8 de f7 ff ff       	call   80107ef5 <lcr3>
  popcli();
80108717:	e8 fe cc ff ff       	call   8010541a <popcli>
}
8010871c:	83 c4 14             	add    $0x14,%esp
8010871f:	5b                   	pop    %ebx
80108720:	5d                   	pop    %ebp
80108721:	c3                   	ret    
...
80108725:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  
  if(sz >= PGSIZE)
80108728:	81 7d 10 ff 0f 00 00 	cmpl   $0xfff,0x10(%ebp)
8010872f:	76 0c                	jbe    8010873d <inituvm+0x1b>
    panic("inituvm: more than a page");
80108731:	c7 04 24 ff 92 10 80 	movl   $0x801092ff,(%esp)
80108738:	e8 fd 7d ff ff       	call   8010053a <panic>
  mem = kalloc();
8010873d:	e8 a0 a3 ff ff       	call   80102ae2 <kalloc>
80108742:	89 45 f4             	mov    %eax,-0xc(%ebp)
  memset(mem, 0, PGSIZE);
80108745:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
8010874c:	00 
8010874d:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80108754:	00 
80108755:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108758:	89 04 24             	mov    %eax,(%esp)
8010875b:	e8 76 cd ff ff       	call   801054d6 <memset>
  mappages(pgdir, 0, PGSIZE, v2p(mem), PTE_W|PTE_U);
80108760:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108763:	89 04 24             	mov    %eax,(%esp)
80108766:	e8 95 f7 ff ff       	call   80107f00 <v2p>
8010876b:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80108772:	00 
80108773:	89 44 24 0c          	mov    %eax,0xc(%esp)
80108777:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
8010877e:	00 
8010877f:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80108786:	00 
80108787:	8b 45 08             	mov    0x8(%ebp),%eax
8010878a:	89 04 24             	mov    %eax,(%esp)
8010878d:	e8 a0 fc ff ff       	call   80108432 <mappages>
  memmove(mem, init, sz);
80108792:	8b 45 10             	mov    0x10(%ebp),%eax
80108795:	89 44 24 08          	mov    %eax,0x8(%esp)
80108799:	8b 45 0c             	mov    0xc(%ebp),%eax
8010879c:	89 44 24 04          	mov    %eax,0x4(%esp)
801087a0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801087a3:	89 04 24             	mov    %eax,(%esp)
801087a6:	e8 fa cd ff ff       	call   801055a5 <memmove>
}
801087ab:	c9                   	leave  
801087ac:	c3                   	ret    
...
801087b1:	83 ec 24             	sub    $0x24,%esp
  uint i, pa, n;
  pte_t *pte;
...
801087be:	74 0c                	je     801087cc <loaduvm+0x1f>
    panic("loaduvm: addr must be page aligned");
801087c0:	c7 04 24 1c 93 10 80 	movl   $0x8010931c,(%esp)
801087c7:	e8 6e 7d ff ff       	call   8010053a <panic>
  for(i = 0; i < sz; i += PGSIZE){
801087cc:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801087d3:	e9 a9 00 00 00       	jmp    80108881 <loaduvm+0xd4>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
801087d8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801087db:	8b 55 0c             	mov    0xc(%ebp),%edx
801087de:	01 d0                	add    %edx,%eax
801087e0:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801087e7:	00 
801087e8:	89 44 24 04          	mov    %eax,0x4(%esp)
801087ec:	8b 45 08             	mov    0x8(%ebp),%eax
801087ef:	89 04 24             	mov    %eax,(%esp)
801087f2:	e8 99 fb ff ff       	call   80108390 <walkpgdir>
801087f7:	89 45 ec             	mov    %eax,-0x14(%ebp)
801087fa:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
801087fe:	75 0c                	jne    8010880c <loaduvm+0x5f>
      panic("loaduvm: address should exist");
80108800:	c7 04 24 3f 93 10 80 	movl   $0x8010933f,(%esp)
80108807:	e8 2e 7d ff ff       	call   8010053a <panic>
    pa = PTE_ADDR(*pte);
8010880c:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010880f:	8b 00                	mov    (%eax),%eax
80108811:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108816:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(sz - i < PGSIZE)
80108819:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010881c:	8b 55 18             	mov    0x18(%ebp),%edx
8010881f:	29 c2                	sub    %eax,%edx
80108821:	89 d0                	mov    %edx,%eax
80108823:	3d ff 0f 00 00       	cmp    $0xfff,%eax
80108828:	77 0f                	ja     80108839 <loaduvm+0x8c>
      n = sz - i;
8010882a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010882d:	8b 55 18             	mov    0x18(%ebp),%edx
80108830:	29 c2                	sub    %eax,%edx
80108832:	89 d0                	mov    %edx,%eax
80108834:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108837:	eb 07                	jmp    80108840 <loaduvm+0x93>
    else
      n = PGSIZE;
80108839:	c7 45 f0 00 10 00 00 	movl   $0x1000,-0x10(%ebp)
    if(readi(ip, p2v(pa), offset+i, n) != n)
80108840:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108843:	8b 55 14             	mov    0x14(%ebp),%edx
80108846:	8d 1c 02             	lea    (%edx,%eax,1),%ebx
80108849:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010884c:	89 04 24             	mov    %eax,(%esp)
8010884f:	e8 b9 f6 ff ff       	call   80107f0d <p2v>
80108854:	8b 55 f0             	mov    -0x10(%ebp),%edx
80108857:	89 54 24 0c          	mov    %edx,0xc(%esp)
8010885b:	89 5c 24 08          	mov    %ebx,0x8(%esp)
8010885f:	89 44 24 04          	mov    %eax,0x4(%esp)
80108863:	8b 45 10             	mov    0x10(%ebp),%eax
80108866:	89 04 24             	mov    %eax,(%esp)
80108869:	e8 fa 94 ff ff       	call   80101d68 <readi>
8010886e:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80108871:	74 07                	je     8010887a <loaduvm+0xcd>
      return -1;
80108873:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80108878:	eb 18                	jmp    80108892 <loaduvm+0xe5>
  uint i, pa, n;
  pte_t *pte;
  ...
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
  for(i = 0; i < sz; i += PGSIZE){
8010887a:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108881:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108884:	3b 45 18             	cmp    0x18(%ebp),%eax
80108887:	0f 82 4b ff ff ff    	jb     801087d8 <loaduvm+0x2b>
    else
      n = PGSIZE;
    if(readi(ip, p2v(pa), offset+i, n) != n)
      return -1;
  ...
  return 0;
8010888d:	b8 00 00 00 00       	mov    $0x0,%eax
}
80108892:	83 c4 24             	add    $0x24,%esp
80108895:	5b                   	pop    %ebx
80108896:	5d                   	pop    %ebp
80108897:	c3                   	ret    
...
8010889b:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  uint a;
...
801088a3:	79 0a                	jns    801088af <allocuvm+0x17>
    return 0;
801088a5:	b8 00 00 00 00       	mov    $0x0,%eax
801088aa:	e9 c1 00 00 00       	jmp    80108970 <allocuvm+0xd8>
  if(newsz < oldsz)
801088af:	8b 45 10             	mov    0x10(%ebp),%eax
801088b2:	3b 45 0c             	cmp    0xc(%ebp),%eax
801088b5:	73 08                	jae    801088bf <allocuvm+0x27>
    return oldsz;
801088b7:	8b 45 0c             	mov    0xc(%ebp),%eax
801088ba:	e9 b1 00 00 00       	jmp    80108970 <allocuvm+0xd8>

  a = PGROUNDUP(oldsz);
801088bf:	8b 45 0c             	mov    0xc(%ebp),%eax
801088c2:	05 ff 0f 00 00       	add    $0xfff,%eax
801088c7:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801088cc:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a < newsz; a += PGSIZE){
801088cf:	e9 8d 00 00 00       	jmp    80108961 <allocuvm+0xc9>
    mem = kalloc();
801088d4:	e8 09 a2 ff ff       	call   80102ae2 <kalloc>
801088d9:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
801088dc:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801088e0:	75 2c                	jne    8010890e <allocuvm+0x76>
      cprintf("allocuvm out of memory\n");
801088e2:	c7 04 24 5d 93 10 80 	movl   $0x8010935d,(%esp)
801088e9:	e8 b2 7a ff ff       	call   801003a0 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
801088ee:	8b 45 0c             	mov    0xc(%ebp),%eax
801088f1:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80108902:	e8 6b 00 00 00       	call   80108972 <deallocuvm>
      return 0;
80108907:	b8 00 00 00 00       	mov    $0x0,%eax
8010890c:	eb 62                	jmp    80108970 <allocuvm+0xd8>
    }
    memset(mem, 0, PGSIZE);
8010890e:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108915:	00 
80108916:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010891d:	00 
8010891e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108921:	89 04 24             	mov    %eax,(%esp)
80108924:	e8 ad cb ff ff       	call   801054d6 <memset>
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
80108929:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010892c:	89 04 24             	mov    %eax,(%esp)
8010892f:	e8 cc f5 ff ff       	call   80107f00 <v2p>
80108934:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108937:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
8010893e:	00 
...
8010894f:	8b 45 08             	mov    0x8(%ebp),%eax
80108952:	89 04 24             	mov    %eax,(%esp)
80108955:	e8 d8 fa ff ff       	call   80108432 <mappages>
    return 0;
  if(newsz < oldsz)
    return oldsz;
...
80108964:	3b 45 10             	cmp    0x10(%ebp),%eax
80108967:	0f 82 67 ff ff ff    	jb     801088d4 <allocuvm+0x3c>
      return 0;
    }
    memset(mem, 0, PGSIZE);
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
  ...
  return newsz;
8010896d:	8b 45 10             	mov    0x10(%ebp),%eax
}
80108970:	c9                   	leave  
80108971:	c3                   	ret    
...
80108975:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;
  uint a, pa;

  if(newsz >= oldsz)
80108978:	8b 45 10             	mov    0x10(%ebp),%eax
8010897b:	3b 45 0c             	cmp    0xc(%ebp),%eax
8010897e:	72 08                	jb     80108988 <deallocuvm+0x16>
    return oldsz;
80108980:	8b 45 0c             	mov    0xc(%ebp),%eax
80108983:	e9 a4 00 00 00       	jmp    80108a2c <deallocuvm+0xba>

  a = PGROUNDUP(newsz);
80108988:	8b 45 10             	mov    0x10(%ebp),%eax
8010898b:	05 ff 0f 00 00       	add    $0xfff,%eax
80108990:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108995:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80108998:	e9 80 00 00 00       	jmp    80108a1d <deallocuvm+0xab>
    pte = walkpgdir(pgdir, (char*)a, 0);
8010899d:	8b 45 f4             	mov    -0xc(%ebp),%eax
801089a0:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801089a7:	00 
801089a8:	89 44 24 04          	mov    %eax,0x4(%esp)
801089ac:	8b 45 08             	mov    0x8(%ebp),%eax
801089af:	89 04 24             	mov    %eax,(%esp)
801089b2:	e8 d9 f9 ff ff       	call   80108390 <walkpgdir>
801089b7:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(!pte)
801089ba:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801089be:	75 09                	jne    801089c9 <deallocuvm+0x57>
      a += (NPTENTRIES - 1) * PGSIZE;
801089c0:	81 45 f4 00 f0 3f 00 	addl   $0x3ff000,-0xc(%ebp)
801089c7:	eb 4d                	jmp    80108a16 <deallocuvm+0xa4>
    else if((*pte & PTE_P) != 0){
801089c9:	8b 45 f0             	mov    -0x10(%ebp),%eax
801089cc:	8b 00                	mov    (%eax),%eax
801089ce:	83 e0 01             	and    $0x1,%eax
801089d1:	85 c0                	test   %eax,%eax
801089d3:	74 41                	je     80108a16 <deallocuvm+0xa4>
      pa = PTE_ADDR(*pte);
801089d5:	8b 45 f0             	mov    -0x10(%ebp),%eax
801089d8:	8b 00                	mov    (%eax),%eax
801089da:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801089df:	89 45 ec             	mov    %eax,-0x14(%ebp)
      if(pa == 0)
801089e2:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
801089e6:	75 0c                	jne    801089f4 <deallocuvm+0x82>
        panic("kfree");
801089e8:	c7 04 24 75 93 10 80 	movl   $0x80109375,(%esp)
801089ef:	e8 46 7b ff ff       	call   8010053a <panic>
      char *v = p2v(pa);
801089f4:	8b 45 ec             	mov    -0x14(%ebp),%eax
801089f7:	89 04 24             	mov    %eax,(%esp)
801089fa:	e8 0e f5 ff ff       	call   80107f0d <p2v>
801089ff:	89 45 e8             	mov    %eax,-0x18(%ebp)
      kfree(v);
80108a02:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108a05:	89 04 24             	mov    %eax,(%esp)
80108a08:	e8 3c a0 ff ff       	call   80102a49 <kfree>
      *pte = 0;
80108a0d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108a10:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
...
80108a23:	0f 82 74 ff ff ff    	jb     8010899d <deallocuvm+0x2b>
      char *v = p2v(pa);
      kfree(v);
      *pte = 0;
    }
...
freevm(pde_t *pgdir)
{
80108a2e:	55                   	push   %ebp
80108a2f:	89 e5                	mov    %esp,%ebp
80108a31:	83 ec 28             	sub    $0x28,%esp
  uint i;

  if(pgdir == 0)
80108a34:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80108a38:	75 0c                	jne    80108a46 <freevm+0x18>
    panic("freevm: no pgdir");
80108a3a:	c7 04 24 7b 93 10 80 	movl   $0x8010937b,(%esp)
80108a41:	e8 f4 7a ff ff       	call   8010053a <panic>
  deallocuvm(pgdir, KERNBASE, 0);
80108a46:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108a4d:	00 
80108a4e:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
80108a55:	80 
80108a56:	8b 45 08             	mov    0x8(%ebp),%eax
80108a59:	89 04 24             	mov    %eax,(%esp)
80108a5c:	e8 11 ff ff ff       	call   80108972 <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
80108a61:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108a68:	eb 48                	jmp    80108ab2 <freevm+0x84>
    if(pgdir[i] & PTE_P){
80108a6a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108a6d:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
...
80108a80:	74 2c                	je     80108aae <freevm+0x80>
      char * v = p2v(PTE_ADDR(pgdir[i]));
80108a82:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108a85:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80108a8c:	8b 45 08             	mov    0x8(%ebp),%eax
80108a8f:	01 d0                	add    %edx,%eax
80108a91:	8b 00                	mov    (%eax),%eax
80108a93:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108a98:	89 04 24             	mov    %eax,(%esp)
80108a9b:	e8 6d f4 ff ff       	call   80107f0d <p2v>
80108aa0:	89 45 f0             	mov    %eax,-0x10(%ebp)
      kfree(v);
80108aa3:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108aa6:	89 04 24             	mov    %eax,(%esp)
80108aa9:	e8 9b 9f ff ff       	call   80102a49 <kfree>
  uint i;
  ...
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
80108aae:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80108ab2:	81 7d f4 ff 03 00 00 	cmpl   $0x3ff,-0xc(%ebp)
80108ab9:	76 af                	jbe    80108a6a <freevm+0x3c>
    if(pgdir[i] & PTE_P){
      char * v = p2v(PTE_ADDR(pgdir[i]));
      kfree(v);
    }
...
80108ac1:	e8 83 9f ff ff       	call   80102a49 <kfree>
}
80108ac6:	c9                   	leave  
80108ac7:	c3                   	ret    
...
80108acb:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;

  pte = walkpgdir(pgdir, uva, 0);
80108ace:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108ad5:	00 
...
80108ae3:	e8 a8 f8 ff ff       	call   80108390 <walkpgdir>
80108ae8:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(pte == 0)
80108aeb:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80108aef:	75 0c                	jne    80108afd <clearpteu+0x35>
    panic("clearpteu");
80108af1:	c7 04 24 8c 93 10 80 	movl   $0x8010938c,(%esp)
80108af8:	e8 3d 7a ff ff       	call   8010053a <panic>
  *pte &= ~PTE_U;
80108afd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108b00:	8b 00                	mov    (%eax),%eax
80108b02:	83 e0 fb             	and    $0xfffffffb,%eax
...
80108b12:	83 ec 44             	sub    $0x44,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
80108b15:	e8 b0 f9 ff ff       	call   801084ca <setupkvm>
80108b1a:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108b1d:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108b21:	75 0a                	jne    80108b2d <copyuvm+0x1f>
    return 0;
80108b23:	b8 00 00 00 00       	mov    $0x0,%eax
80108b28:	e9 fd 00 00 00       	jmp    80108c2a <copyuvm+0x11c>
  for(i = 0; i < sz; i += PGSIZE){
80108b2d:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108b34:	e9 d0 00 00 00       	jmp    80108c09 <copyuvm+0xfb>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80108b39:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108b3c:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108b43:	00 
80108b44:	89 44 24 04          	mov    %eax,0x4(%esp)
80108b48:	8b 45 08             	mov    0x8(%ebp),%eax
80108b4b:	89 04 24             	mov    %eax,(%esp)
80108b4e:	e8 3d f8 ff ff       	call   80108390 <walkpgdir>
80108b53:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108b56:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108b5a:	75 0c                	jne    80108b68 <copyuvm+0x5a>
      panic("copyuvm: pte should exist");
80108b5c:	c7 04 24 96 93 10 80 	movl   $0x80109396,(%esp)
80108b63:	e8 d2 79 ff ff       	call   8010053a <panic>
    if(!(*pte & PTE_P))
80108b68:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108b6b:	8b 00                	mov    (%eax),%eax
80108b6d:	83 e0 01             	and    $0x1,%eax
80108b70:	85 c0                	test   %eax,%eax
80108b72:	75 0c                	jne    80108b80 <copyuvm+0x72>
      panic("copyuvm: page not present");
80108b74:	c7 04 24 b0 93 10 80 	movl   $0x801093b0,(%esp)
80108b7b:	e8 ba 79 ff ff       	call   8010053a <panic>
    pa = PTE_ADDR(*pte);
80108b80:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108b83:	8b 00                	mov    (%eax),%eax
80108b85:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108b8a:	89 45 e8             	mov    %eax,-0x18(%ebp)
    flags = PTE_FLAGS(*pte);
80108b8d:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108b90:	8b 00                	mov    (%eax),%eax
80108b92:	25 ff 0f 00 00       	and    $0xfff,%eax
80108b97:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
80108b9a:	e8 43 9f ff ff       	call   80102ae2 <kalloc>
80108b9f:	89 45 e0             	mov    %eax,-0x20(%ebp)
80108ba2:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
80108ba6:	75 02                	jne    80108baa <copyuvm+0x9c>
      goto bad;
80108ba8:	eb 70                	jmp    80108c1a <copyuvm+0x10c>
    memmove(mem, (char*)p2v(pa), PGSIZE);
80108baa:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108bad:	89 04 24             	mov    %eax,(%esp)
80108bb0:	e8 58 f3 ff ff       	call   80107f0d <p2v>
80108bb5:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108bbc:	00 
80108bbd:	89 44 24 04          	mov    %eax,0x4(%esp)
80108bc1:	8b 45 e0             	mov    -0x20(%ebp),%eax
80108bc4:	89 04 24             	mov    %eax,(%esp)
80108bc7:	e8 d9 c9 ff ff       	call   801055a5 <memmove>
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
80108bcc:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
80108bcf:	8b 45 e0             	mov    -0x20(%ebp),%eax
80108bd2:	89 04 24             	mov    %eax,(%esp)
80108bd5:	e8 26 f3 ff ff       	call   80107f00 <v2p>
80108bda:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108bdd:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80108be1:	89 44 24 0c          	mov    %eax,0xc(%esp)
80108be5:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108bec:	00 
80108bed:	89 54 24 04          	mov    %edx,0x4(%esp)
80108bf1:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108bf4:	89 04 24             	mov    %eax,(%esp)
80108bf7:	e8 36 f8 ff ff       	call   80108432 <mappages>
80108bfc:	85 c0                	test   %eax,%eax
80108bfe:	79 02                	jns    80108c02 <copyuvm+0xf4>
      goto bad;
80108c00:	eb 18                	jmp    80108c1a <copyuvm+0x10c>
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80108c02:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108c09:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108c0c:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108c0f:	0f 82 24 ff ff ff    	jb     80108b39 <copyuvm+0x2b>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
      goto bad;
...
80108c18:	eb 10                	jmp    80108c2a <copyuvm+0x11c>

bad:
  freevm(d);
80108c1a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108c1d:	89 04 24             	mov    %eax,(%esp)
80108c20:	e8 09 fe ff ff       	call   80108a2e <freevm>
  return 0;
80108c25:	b8 00 00 00 00       	mov    $0x0,%eax
}
80108c2a:	83 c4 44             	add    $0x44,%esp
80108c2d:	5b                   	pop    %ebx
80108c2e:	5d                   	pop    %ebp
80108c2f:	c3                   	ret    
...
80108c33:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;

  pte = walkpgdir(pgdir, uva, 0);
80108c36:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108c3d:	00 
80108c3e:	8b 45 0c             	mov    0xc(%ebp),%eax
80108c41:	89 44 24 04          	mov    %eax,0x4(%esp)
80108c45:	8b 45 08             	mov    0x8(%ebp),%eax
80108c48:	89 04 24             	mov    %eax,(%esp)
80108c4b:	e8 40 f7 ff ff       	call   80108390 <walkpgdir>
80108c50:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((*pte & PTE_P) == 0)
80108c53:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108c56:	8b 00                	mov    (%eax),%eax
80108c58:	83 e0 01             	and    $0x1,%eax
80108c5b:	85 c0                	test   %eax,%eax
80108c5d:	75 07                	jne    80108c66 <uva2ka+0x36>
    return 0;
80108c5f:	b8 00 00 00 00       	mov    $0x0,%eax
80108c64:	eb 25                	jmp    80108c8b <uva2ka+0x5b>
  if((*pte & PTE_U) == 0)
80108c66:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108c69:	8b 00                	mov    (%eax),%eax
80108c6b:	83 e0 04             	and    $0x4,%eax
80108c6e:	85 c0                	test   %eax,%eax
80108c70:	75 07                	jne    80108c79 <uva2ka+0x49>
    return 0;
80108c72:	b8 00 00 00 00       	mov    $0x0,%eax
80108c77:	eb 12                	jmp    80108c8b <uva2ka+0x5b>
  return (char*)p2v(PTE_ADDR(*pte));
80108c79:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108c7c:	8b 00                	mov    (%eax),%eax
80108c7e:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108c83:	89 04 24             	mov    %eax,(%esp)
80108c86:	e8 82 f2 ff ff       	call   80107f0d <p2v>
}
80108c8b:	c9                   	leave  
80108c8c:	c3                   	ret    
...
80108c96:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(len > 0){
80108c99:	e9 87 00 00 00       	jmp    80108d25 <copyout+0x98>
    va0 = (uint)PGROUNDDOWN(va);
80108c9e:	8b 45 0c             	mov    0xc(%ebp),%eax
80108ca1:	25 00 f0 ff ff       	and    $0xfffff000,%eax
...
80108cb6:	e8 75 ff ff ff       	call   80108c30 <uva2ka>
80108cbb:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(pa0 == 0)
80108cbe:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
80108cc2:	75 07                	jne    80108ccb <copyout+0x3e>
      return -1;
80108cc4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80108cc9:	eb 69                	jmp    80108d34 <copyout+0xa7>
    n = PGSIZE - (va - va0);
80108ccb:	8b 45 0c             	mov    0xc(%ebp),%eax
80108cce:	8b 55 ec             	mov    -0x14(%ebp),%edx
80108cd1:	29 c2                	sub    %eax,%edx
80108cd3:	89 d0                	mov    %edx,%eax
80108cd5:	05 00 10 00 00       	add    $0x1000,%eax
80108cda:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(n > len)
80108cdd:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108ce0:	3b 45 14             	cmp    0x14(%ebp),%eax
80108ce3:	76 06                	jbe    80108ceb <copyout+0x5e>
      n = len;
80108ce5:	8b 45 14             	mov    0x14(%ebp),%eax
80108ce8:	89 45 f0             	mov    %eax,-0x10(%ebp)
    memmove(pa0 + (va - va0), buf, n);
80108ceb:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108cee:	8b 55 0c             	mov    0xc(%ebp),%edx
80108cf1:	29 c2                	sub    %eax,%edx
80108cf3:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108cf6:	01 c2                	add    %eax,%edx
80108cf8:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108cfb:	89 44 24 08          	mov    %eax,0x8(%esp)
80108cff:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108d02:	89 44 24 04          	mov    %eax,0x4(%esp)
80108d06:	89 14 24             	mov    %edx,(%esp)
80108d09:	e8 97 c8 ff ff       	call   801055a5 <memmove>
    len -= n;
80108d0e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108d11:	29 45 14             	sub    %eax,0x14(%ebp)
    buf += n;
80108d14:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108d17:	01 45 f4             	add    %eax,-0xc(%ebp)
    va = va0 + PGSIZE;
80108d1a:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108d1d:	05 00 10 00 00       	add    $0x1000,%eax
80108d22:	89 45 0c             	mov    %eax,0xc(%ebp)
{
  char *buf, *pa0;
  uint n, va0;
  ...
  buf = (char*)p;
  while(len > 0){
80108d25:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
80108d29:	0f 85 6f ff ff ff    	jne    80108c9e <copyout+0x11>
    memmove(pa0 + (va - va0), buf, n);
    len -= n;
    buf += n;
    va = va0 + PGSIZE;
  ...
  return 0;
80108d2f:	b8 00 00 00 00       	mov    $0x0,%eax
}
80108d34:	c9                   	leave  
80108d35:	c3                   	ret    
